...
#SBATCH --mem 20g
#SBATCH --job-name=mafft_busco_all_CDS_seq.new
#SBATCH --error=mafft_busco_all_CDS_seq.%A.e
#SBATCH --output=mafft_busco_all_CDS_seq.%A.o
...
##mafft --thread 10 busco_all_CDS_seq.fa > busco_all_CDS_seq.output.msa

mafft --phylipout --thread 20 busco_all_CDS_seq.fa > busco_all_CDS_seq.output.new.phy
