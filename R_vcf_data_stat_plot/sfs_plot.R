...
for (i in 1:length(sfs_3X)){
    #print(sfs_3X[i])
    sfs_dt <- suppressWarnings(read.table(sfs_3X[i], header=F, sep =" "))
...
# Open PDF device
pdf("combined_sfs_plots.pdf", width = 12, height = 8)  # Adjust width and height as needed
