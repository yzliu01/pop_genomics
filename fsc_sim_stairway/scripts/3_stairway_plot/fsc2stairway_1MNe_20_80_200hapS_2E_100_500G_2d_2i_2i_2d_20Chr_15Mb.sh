...
#SBATCH --error=fsc2stairway_1MNe_no_singleton_20_80_200hapS_2E_100_500G_2d_2i_2i_2d_20Chr_15Mb.%A_%a.e
#SBATCH --output=fsc2stairway_1MNe_no_singleton_20_80_200hapS_2E_100_500G_2d_2i_2i_2d_20Chr_15Mb.%A_%a.o
#SBATCH --job-name=fsc2stairway_1MNe_no_singleton_20_80_200hapS_2E_100_500G_2d_2i_2i_2d
...
blueprint_plot_sh=$(ls $blueprint_dir/ft_sim_1000000Ne*2E_100_500G_*.blueprint.sh | grep -E '2d_2i|2i_2d' | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
...
cd /home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2
blueprint_dir=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2/stairway_plot_blueprint/1000000Ne_5rep
blueprint_file=`ls $blueprint_dir/ft_sim_1000000Ne*2E_100_500G_*.blueprint | grep -E '2d_2i|2i_2d'`
