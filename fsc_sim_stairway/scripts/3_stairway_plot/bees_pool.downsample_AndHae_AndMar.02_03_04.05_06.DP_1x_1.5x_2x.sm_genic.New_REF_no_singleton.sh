...
blueprint_file=`ls -t $blueprint_file_dir/*blueprint | head -12 | sort -V`
...
run_blueprint_plot_sh=$(ls -t $blueprint_file_dir/*blueprint.sh | head -12 | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
