...
#SBATCH --error=downsample_0_2_3_4_bees_pool_AndHae_AndMar.DP_1x_1.5x_2x.sm_genic.New_REF_no_singleton.%A_%a.e
#SBATCH --output=downsample_0_2_3_4_bees_pool_AndHae_AndMar.DP_1x_1.5x_2x.sm_genic.New_REF_no_singleton.%A_%a.o
#SBATCH --job-name=downsample_0_2_3_4_bees_pool_AndHae_AndMar.DP_1x_1.5x_2x.sm_genic.New_REF_no_singleton
...
blueprint_file=`ls -t $blueprint_file_dir/*blueprint | head -18 | sort -V`
...
run_blueprint_plot_sh=$(ls -t $blueprint_file_dir/*blueprint.sh | head -18 | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
