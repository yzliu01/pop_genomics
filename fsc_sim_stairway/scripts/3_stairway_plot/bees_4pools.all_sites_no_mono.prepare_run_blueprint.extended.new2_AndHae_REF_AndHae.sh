...
#SBATCH --error=bee_pools_all_site_no_mono_extended_sw_new2_AndHae_REF_AndHae.%A_%a.e.txt
#SBATCH --output=bee_pools_all_site_no_mono_extended_sw_new2_AndHae_REF_AndHae.%A_%a.o.txt
#SBATCH --job-name=new2_AndHae_REF_AndHae_bee_pools_all_site_no_mono_extended_sw
...
blueprint_file=`ls $blueprint_file_dir/AndHae_REF_AndHae.*.extended.new2.blueprint | sort -V`
...
run_blueprint_plot_sh=$(ls $blueprint_file_dir/AndHae_REF_AndHae.*.extended.new2.blueprint.sh | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
