...
p1_initial <- ggplot(data = data, aes(x = year)) +
    #xlim(1,150000)+
    #ylim(1,650000)+
    scale_x_continuous(limits= c(1,110000),labels = function(year) format(year, scientific = FALSE)) +
    ...
    axis.title = element_text(colour = "black",size = 13), axis.ticks = element_line(colour = "black", size = 1.2),
    plot.title = element_text(hjust = 0.5, size=13),panel.border = element_rect(linewidth = 1.5),
