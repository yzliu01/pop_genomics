...
##SBATCH --time=4:00:00
#SBATCH --error=bees_pool.3_test.DP_1x_1.5x_2x.sm_genic.REF_with_singleton.%A_%a.e
#SBATCH --output=bees_pool.3_test.DP_1x_1.5x_2x.sm_genic.REF_with_singleton.%A_%a.o
#SBATCH --job-name=bees_pool.3_test.DP_1x_1.5x_2x.sm_genic.REF_with_singleton
...
blueprint_file=`ls -t $blueprint_file_dir/*blueprint | head -5 | sort -V`
...
run_blueprint_plot_sh=$(ls -t $blueprint_file_dir/*blueprint.sh | head -5 | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
