...
#mixedsort(sort(fs::dir_ls(path=final_summary, recurse = 1, fail=TRUE, type = "file", glob = "*G_*e_*_cons*400hapS*15Mb_*.final.summary")))
## attention to refer to only one file name
#file_list0 <- fs::dir_ls(path=final_summary, recurse = 1, fail=TRUE, type = "file", glob = "*400hapS*15Mb_1.final.summary")
...
for (generation in c("50G","100G","500G","1000G")){
    ...
    for (event in c("2e_d_cons","10e_d_cons","2e_i_cons")){
        ...
        plot_name <- paste0("1000000Ne_400hapS_1E_",generation,"_",event,"_20Chr_15Mb")
        ## print names with newline 
        cat("\n",plot_name,"\n\n")
        
        if (plot_name %in% c("1000000Ne_400hapS_1E_50G_2e_d_cons_20Chr_15Mb", "1000000Ne_400hapS_1E_100G_2e_d_cons_20Chr_15Mb", "1000000Ne_400hapS_1E_500G_2e_d_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1000000Ne_400hapS_1E_1000G_2e_d_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1000000Ne_400hapS_1E_1000G_2e_i_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1000000Ne_400hapS_1E_50G_2e_i_cons_20Chr_15Mb","1000000Ne_400hapS_1E_100G_2e_i_cons_20Chr_15Mb","1000000Ne_400hapS_1E_500G_2e_i_cons_20Chr_15Mb")){
            plot(1,1, type="n", xlim=c(1,5e6), ylim=c(1,1.2e6),log="x", xlab="", ylab="",xaxt='n',yaxt='n')
            #xlab="Years ago", ylab="Effective population size"
            title(line=2)
            axis(side=2, at=c(150000,250000,500000,750000,1000000,1200000),label=c(format(c(150000,250000,500000,750000,1000000,1200000),scientific=FALSE)))

        } else if (plot_name %in% c("1000000Ne_400hapS_1E_50G_10e_i_cons_20Chr_15Mb","1000000Ne_400hapS_1E_100G_10e_i_cons_20Chr_15Mb","1000000Ne_400hapS_1E_500G_10e_i_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1000000Ne_400hapS_1E_1000G_10e_i_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1000000Ne_400hapS_1E_1000G_10e_d_cons_20Chr_15Mb")){
        ...
        ## distance to x axis
        if (plot_name %in% c("1000000Ne_400hapS_1E_50G_10e_i_cons_20Chr_15Mb","1000000Ne_400hapS_1E_100G_10e_i_cons_20Chr_15Mb","1000000Ne_400hapS_1E_500G_10e_i_cons_20Chr_15Mb","1000000Ne_400hapS_1E_1000G_10e_i_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1000000Ne_400hapS_1E_50G_2e_i_cons_20Chr_15Mb","1000000Ne_400hapS_1E_100G_2e_i_cons_20Chr_15Mb","1000000Ne_400hapS_1E_500G_2e_i_cons_20Chr_15Mb","1000000Ne_400hapS_1E_1000G_2e_i_cons_20Chr_15Mb")) {
        ...
        mtext(side=3,text=paste0("1000000Ne_400hapS_1E_",generation,"_",event,"_20Chr_15Mb"),cex=0.8,line=1.2)
...
#}
        ...
        x <- 0:100000
        #plot_name <- c("1000000Ne_400hapS_1E_1000G_1.1i_20Chr_15Mb","1000000Ne_400hapS_1E_1000G_1.5i_20Chr_15Mb","1000000Ne_400hapS_1E_1000G_1.9i_20Chr_15Mb","1000000Ne_400hapS_1E_1000G_0.5e_d_1.5i_20Chr_15Mb")
        ## category
