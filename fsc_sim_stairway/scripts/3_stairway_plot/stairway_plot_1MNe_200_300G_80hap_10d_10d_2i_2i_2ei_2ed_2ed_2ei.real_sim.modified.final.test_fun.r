...
pdf(paste0("combined.1MNe_2E_100_200G_80hapS_5rep_10d_10d_2i_2i_2ei_2ed_2ed_2ei.rotated_x_lab_final.test_fun.pdf"),width = 20, height = 25)
...
for (generation in c("100_200G")){
    ...
    for (event in c("10d_10d","2i_2i","2e_i_2e_d","2e_d_2e_i")){
        ...
        if (plot_name %in% c("xx_1000000Ne_80hapS_2E_100_200G_10d_10d_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1000000Ne_80hapS_2E_100_200G_10d_10d_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1000000Ne_80hapS_2E_100_200G_2i_2i_20Chr_15Mb")){
        ...
        ## distance to x axis
        if (plot_name %in% c("1000000Ne_80hapS_2E_100_200G_10d_10d_20Chr_15Mb")){
            ...
            #,"1000000Ne_80hapS_2E_100_200G_2e_i_2e_d_20Chr_15Mb","1000000Ne_80hapS_2E_100_200G_2e_d_2e_i_20Chr_15Mb"
