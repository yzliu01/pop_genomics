...
#SBATCH --error=fsc2stairway_1MNe_no_singleton_2_e_i_cons.sim_10Chr.%A_%a.e
#SBATCH --output=fsc2stairway_1MNe_no_singleton_2_e_i_cons.sim_10Chr.%A_%a.o
#SBATCH --job-name=fsc2stairway_1MNe_no_singleton_2_e_i_cons.sim_10Chr
