...
file_list_a <- c(             
                "AndHae_New_REF_AndHae.no_singleton_sfs_78_1500x_sm_genic", 
                "AndHae_New_REF_AndHae.no_singleton_sfs_117_1500x_sm_genic",
                "AndHae_New_REF_AndHae.no_singleton_sfs_156_1500x_sm_genic",
...
file_list_b <- c(       
                ...
                expression(paste("Ref1: ", italic("A. haemorrhoa"), " | d", italic("S"), ":  0 | Cov: 1X")), 
                expression(paste("Ref1: ", italic("A. haemorrhoa"), " | d", italic("S"), ":  0 | Cov: 1.5X")),
                expression(paste("Ref1: ", italic("A. haemorrhoa"), " | d", italic("S"), ":  0 | Cov: 2X")),
...
pdf_file <- file.path(result_path,"AndHae_combined_added_plot.1_1.5_2x.pdf")
