...
#SBATCH --error=bee_pools_all_site_no_mono_extended_sw_new_BomVet_REF_BomPas.%A_%a.e.txt
#SBATCH --output=bee_pools_all_site_no_mono_extended_sw_new_BomVet_REF_BomPas.%A_%a.o.txt
#SBATCH --job-name=BomVet_REF_BomPas_bee_pools_all_site_no_mono_extended_sw
...
blueprint_file=`ls $blueprint_file_dir/*BomVet_REF_BomPas*sfs_600x.extended.blueprint | sort -V`
...
run_blueprint_plot_sh=$(ls $blueprint_file_dir/*BomVet_REF_BomPas*sfs_600x.extended.blueprint.sh | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
