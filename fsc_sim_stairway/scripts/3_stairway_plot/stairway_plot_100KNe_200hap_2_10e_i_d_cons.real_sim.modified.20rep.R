...
pdf(paste0("combined.100KNe_200hapS_20rep_2_10_i_d_cons.rotated_x_lab.pdf"),width = 20, height = 25)
#pdf(paste0("combined.1000000Ne_200hapS_20rep_non_pruned.real_sim.rotated_x_lab-.pdf"),width = 20, height = 25)
...
for (generation in c("50G","100G","500G","1000G")){
    ...
    for (event in c("2e_d_cons","10e_d_cons","2e_i_cons","10e_i_cons")){
        ...
        if (plot_name %in% c("100000Ne_200hapS_1E_50G_2e_d_cons_20Chr_15Mb", "100000Ne_200hapS_1E_100G_2e_d_cons_20Chr_15Mb", "100000Ne_200hapS_1E_500G_2e_d_cons_20Chr_15Mb")){
            plot(1,1, type="n", xlim=c(1,5e5), ylim=c(1,1.0e5),log="x", xlab="", ylab="Effective population size",xaxt='n',yaxt='n')
            #log="xy",xlab="Years ago", ylab="Effective population size"
            title(line=2)
            axis(side=2, at=c(15000,25000,50000,60000,80000,100000),label=c(format(c(15000,25000,50000,60000,80000,100000),scientific=FALSE)))

        } else if (plot_name %in% c("100000Ne_200hapS_1E_1000G_2e_d_cons_20Chr_15Mb")){
            plot(1,1, type="n", xlim=c(1,5e6), ylim=c(1,1.0e5),log="x", xlab="Years ago", ylab="Effective population size",xaxt='n',yaxt='n')
