...
combined_plot1 <- marrangeGrob(grobs = plot_list,ncol = 3, nrow = 1, 
...
pdf_file <- file.path(result_path,"AndHae_combined_added_plot.one_COV.new.pdf")
ggsave(pdf_file,combined_plot,width = 18, height = 18)
