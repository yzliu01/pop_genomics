...
pdf(paste0("combined.1MNe_no_singleton_200hapS_5rep_cons_1_1i_1_5i_1_9i.rotated_x_lab_final.pdf"),width = 20, height = 25)
...
#}
        ...
        if (plot_name %in% c("1MNe_no_singleton_200hapS_1E_50G_cons_20Chr_15Mb", "1MNe_no_singleton_200hapS_1E_100G_cons_20Chr_15Mb", "1MNe_no_singleton_200hapS_1E_500G_cons_20Chr_15Mb")){
            ...
            lablist.x <- as.vector(c(50,100,500,1000,10000,100000))
            axis(side=1,at=c(50,100,500,1000,10000,100000),labels=FALSE)
            text(x=c(50,100,500,1000,10000,100000),labels = c(format(lablist.x,scientific=FALSE)),par("usr")[3] - 9000,srt = 38,pos = 3, xpd = TRUE)
        ...
        for (rep in c(1:5)){
            ...
            ## check
            #fs::dir_ls(path=paste0("./ft_sim_1MNe_no_singleton_200hapS_1E_","50G","_","cons","_20Chr_15Mb_","2"), recurse = 1, fail=TRUE, type = "file", glob = "*200hapS*.final.summary")
