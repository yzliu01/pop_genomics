...
#SBATCH --error=fsc2stairway_1MNe_20_80_200_400hapS_1E_1.9i_20Chr_15Mb.%A_%a.e
#SBATCH --output=fsc2stairway_1MNe_20_80_200_400hapS_1E_1.9i_20Chr_15Mb.%A_%a.o
#SBATCH --job-name=fsc2stairway_1MNe_20_80_200_400hapS_1E_1.9i_20Chr_15Mb
...
blueprint_plot_sh_list=(
    "ft_sim_1000000Ne_400hapS_1E_500G_1.9i_20Chr_15Mb_3.blueprint.sh"
    "ft_sim_1000000Ne_400hapS_1E_1000G_1.9i_20Chr_15Mb_1.blueprint.sh"
    "ft_sim_1000000Ne_400hapS_1E_1000G_1.9i_20Chr_15Mb_2.blueprint.sh"
    "ft_sim_1000000Ne_400hapS_1E_1000G_1.9i_20Chr_15Mb_4.blueprint.sh"
)
...
grep -c 'finish' *43966651_*.o | sort -V
