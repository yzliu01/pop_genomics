...
ggplot(merged_data_new, aes(x = year, y = Ne_median, group = species, color = species)) +
  ...
  scale_x_log10(limits = c(10, 250000), breaks = c(10,100,1000,3000,10000,100000), labels = label_number(big.mark = ""))  # Set x-axis limits between 1 and 100,000
#  scale_x_log10(limits = c(10, 250000), breaks = c(10,100,1000,3000,10000,100000,200000), labels = label_number(big.mark = ""))  # Set x-axis limits between 1 and 100,000

ggsave("/home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2/bee_pools_plot_new/plot_in_one_5X.new.pdf",width=6,height=6)
