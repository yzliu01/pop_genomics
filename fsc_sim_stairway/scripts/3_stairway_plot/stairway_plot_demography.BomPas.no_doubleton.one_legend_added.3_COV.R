...
file_list_a <- c(             
                "BomPas_New_REF_BomPas.no_doubleton_sfs_204_1500x_sm_genic", 
                "BomPas_New_REF_BomPas.no_doubleton_sfs_340_1500x_sm_genic",
                "BomPas_New_REF_BomPas.no_doubleton_sfs_476_1500x_sm_genic",

                "BomPas_New_REF_BomMus.no_doubleton_sfs_204_1500x_sm_genic",
                "BomPas_New_REF_BomMus.no_doubleton_sfs_340_1500x_sm_genic",
                "BomPas_New_REF_BomMus.no_doubleton_sfs_476_1500x_sm_genic",             

                "BomPas_New_REF_BomHor.no_doubleton_sfs_204_1500x_sm_genic",
                "BomPas_New_REF_BomHor.no_doubleton_sfs_340_1500x_sm_genic",
                "BomPas_New_REF_BomHor.no_doubleton_sfs_476_1500x_sm_genic",

                #"BomPas_New_REF_BomHyp.no_doubleton_sfs_204_1500x_sm_genic",
                #"BomPas_New_REF_BomHyp.no_doubleton_sfs_340_1500x_sm_genic",
                #"BomPas_New_REF_BomHyp.no_doubleton_sfs_476_1500x_sm_genic",

                "BomPas_New_REF_BomCon.no_doubleton_sfs_204_1500x_sm_genic",
                "BomPas_New_REF_BomCon.no_doubleton_sfs_340_1500x_sm_genic",
                "BomPas_New_REF_BomCon.no_doubleton_sfs_476_1500x_sm_genic",

                "BomPas_New_REF_ApisMel.no_doubleton_sfs_204_1500x_sm_genic",
                "BomPas_New_REF_ApisMel.no_doubleton_sfs_340_1500x_sm_genic",
                "BomPas_New_REF_ApisMel.no_doubleton_sfs_476_1500x_sm_genic"
                )
...
p1_initial <- ggplot(data = data, aes(x = year)) +
    ...
    annotate(geom = "rect", xmin = 10, xmax = 15000, ymin = 1, ymax = 750000, color = "black", linetype='dashed', linewidth = 0.5, alpha = 0.1) +
...
p1_final <- p1_initial + 
    ...
    annotation_custom(ggplotGrob(p1_zoom), xmin = 30000, xmax = 150000, ymin = 200000, ymax = 800000) +
    ## position of annotation frame
    geom_rect(aes(xmin = 30000, xmax = 150000, ymin = 200000, ymax = 800000), color='black', linetype='dashed', linewidth=0.5, alpha=0) +
    ## conncetion line to one side of the frame [geom_rect]
    geom_path(aes(x,y,group=grp), 
                #[selected-annotation:left-right]
                data=data.frame(x = c(15000,30000), y=c(750000,800000),grp=c(1,1,2,2)),
...
pdf_file <- file.path(result_path,"BomPas_combined_added_plot.no_doubleton.pdf")
