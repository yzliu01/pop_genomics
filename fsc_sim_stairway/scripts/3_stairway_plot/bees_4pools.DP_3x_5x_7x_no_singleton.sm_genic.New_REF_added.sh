...
#SBATCH --error=bees_4pools.DP_3x_5x_7x_no_singleton.sm_genic.New_REF_added.%A_%a.e
#SBATCH --output=bees_4pools.DP_3x_5x_7x_no_singleton.sm_genic.New_REF_added.%A_%a.o
#SBATCH --job-name=bees_4pools.DP_3x_5x_7x_no_singleton.sm_genic.New_REF_added
...
blueprint_file=`ls -t $blueprint_file_dir/*no_singleton_sfs_*_1500x.sm_genic.blueprint | head -18 | sort -r`
...
run_blueprint_plot_sh=$(ls -t $blueprint_file_dir/*no_singleton_sfs_*_1500x.sm_genic.blueprint.sh | head -18 | sort -r | sed -n ${SLURM_ARRAY_TASK_ID}p)
