...
pdf(paste0("combined.100000Ne_200hapS_5rep_10d_10d_2i_2i_2ei_2ed_2ed_2ei_non_pruned.rotated_x_lab_final.pdf"),width = 20, height = 25)
...
for (generation in c("100_500G")){
    ...
    for (event in c("10d_10d","2i_2i","2e_i_2e_d","2e_d_2e_i")){
        ...
        plot_name <- paste0("100000Ne_200hapS_2E_",generation,"_",event,"_20Chr_15Mb")
        #print(plot_name)
        ...
        for (rep in c(1:5)){
            ...
            #paste0("data_ft_sim_100000Ne_200hapS_2E_",generation,"_",event,"_20Chr_15Mb")
        ...
        x <- 0:100000
        #plot_name <- c("100000Ne_200hapS_2E_1000G_1.1i_20Chr_15Mb","100000Ne_200hapS_2E_1000G_1.5i_20Chr_15Mb","100000Ne_200hapS_2E_1000G_1.9i_20Chr_15Mb","100000Ne_200hapS_2E_1000G_0.5e_d_1.5i_20Chr_15Mb")
