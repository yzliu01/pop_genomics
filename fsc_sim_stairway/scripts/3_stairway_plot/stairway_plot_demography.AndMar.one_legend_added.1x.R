...
file_list_a <- c(             
                "AndMar_New_REF_AndMar.no_singleton_sfs_80_1500x_sm_genic", 
                "AndMar_New_REF_AndMar.no_singleton_sfs_120_1500x_sm_genic",
                "AndMar_New_REF_AndMar.no_singleton_sfs_160_1500x_sm_genic",
...
file_list_b <- c(      
                expression(paste("Ref1: ", italic("A. marginata"), " | d", italic("S"), ":  0 | Cov: 1X")), 
                expression(paste("Ref1: ", italic("A. marginata"), " | d", italic("S"), ":  0 | Cov: 1.5X")),
                expression(paste("Ref1: ", italic("A. marginata"), " | d", italic("S"), ":  0 | Cov: 2X")),
...
pdf_file <- file.path(result_path,"AndMar_combined_added_plot.1_1.5_2x.pdf")
