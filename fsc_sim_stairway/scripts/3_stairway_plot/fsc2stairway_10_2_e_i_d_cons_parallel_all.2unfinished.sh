...
#SBATCH --array=211,233%2
#SBATCH --time=26:00:00
#SBATCH --error=swp_ft_sim_10000Ne_20_80_200hapS_1E_10_2_e_i_d_cons.unfinished.%A.e.txt
#SBATCH --output=swp_ft_sim_10000Ne_20_80_200hapS_1E_10_2_e_i_d_cons.unfinished.%A.o.txt
#SBATCH --job-name=swp_non_prun_10_2_e_i_d_cons_unfinished
...
blueprint_file=`ls $blueprint_file_dir/ft_sim_10000Ne*e_[id]_cons_20Chr_15Mb_*.blueprint | sort -V`
...
blueprint_sh=`ls $blueprint_file_dir/ft_sim_10000Ne*20Chr_15Mb*.blueprint.sh | sort -V`
run_batch_file(){
...
run_blueprint_plot_sh=$(ls $blueprint_file_dir/ft_sim_10000Ne*e_[id]_cons_20Chr_15Mb_*.blueprint.sh | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
