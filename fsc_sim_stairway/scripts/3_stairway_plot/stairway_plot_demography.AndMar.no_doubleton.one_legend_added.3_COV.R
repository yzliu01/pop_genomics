...
file_list_a <- c(             
                "AndMar_New_REF_AndMar.no_doubleton_sfs_240_1500x_sm_genic", 
                "AndMar_New_REF_AndMar.no_doubleton_sfs_400_1500x_sm_genic",
                "AndMar_New_REF_AndMar.no_doubleton_sfs_560_1500x_sm_genic",

                "AndMar_New_REF_AndBic.no_doubleton_sfs_240_1500x_sm_genic",
                "AndMar_New_REF_AndBic.no_doubleton_sfs_400_1500x_sm_genic",
                "AndMar_New_REF_AndBic.no_doubleton_sfs_560_1500x_sm_genic",

                #"AndMar_New_REF_AndTri.no_doubleton_sfs_240_1500x_sm_genic",
                #"AndMar_New_REF_AndTri.no_doubleton_sfs_400_1500x_sm_genic",
                #"AndMar_New_REF_AndTri.no_doubleton_sfs_560_1500x_sm_genic",

                "AndMar_New_REF_AndHat.no_doubleton_sfs_240_1500x_sm_genic",
                "AndMar_New_REF_AndHat.no_doubleton_sfs_400_1500x_sm_genic",
                "AndMar_New_REF_AndHat.no_doubleton_sfs_560_1500x_sm_genic",

                "AndMar_New_REF_AndHae.no_doubleton_sfs_240_1500x_sm_genic",
                "AndMar_New_REF_AndHae.no_doubleton_sfs_400_1500x_sm_genic",
                "AndMar_New_REF_AndHae.no_doubleton_sfs_560_1500x_sm_genic",

                "AndMar_New_REF_BomPas.no_doubleton_sfs_240_1500x_sm_genic",
                "AndMar_New_REF_BomPas.no_doubleton_sfs_400_1500x_sm_genic",
                "AndMar_New_REF_BomPas.no_doubleton_sfs_560_1500x_sm_genic"
                )
...
file_list_b <- c(      
                ...
                expression(paste("Closer Ref1: ", italic("A. bicolor"), " | Divergence Time: 8.5 Mya | Cov: 3X")),
                expression(paste("Closer Ref1: ", italic("A. bicolor"), " | Divergence Time: 8.5 Mya | Cov: 5X")),
                expression(paste("Closer Ref1: ", italic("A. bicolor"), " | Divergence Time: 8.5 Mya | Cov: 7X")),

                #expression(paste("Closer Ref1: ", italic("A. trimmerana"), " | Divergence Time: 12.5 Mya | Cov: 3X")),
                #expression(paste("Closer Ref1: ", italic("A. trimmerana"), " | Divergence Time: 12.5 Mya | Cov: 5X")),
                #expression(paste("Closer Ref1: ", italic("A. trimmerana"), " | Divergence Time: 12.5 Mya | Cov: 7X")),

                expression(paste("Closer Ref2: ", italic("A. hattorfiana"), " | Divergence Time: 14 Mya | Cov: 3X")),
                expression(paste("Closer Ref2: ", italic("A. hattorfiana"), " | Divergence Time: 14 Mya | Cov: 5X")),
                expression(paste("Closer Ref2: ", italic("A. hattorfiana"), " | Divergence Time: 14 Mya | Cov: 7X")),

                expression(paste("Closer Ref3: ", italic("A. haemorrhoa"), " | Divergence Time: 17.5 Mya | Cov: 3X")),
                expression(paste("Closer Ref3: ", italic("A. haemorrhoa"), " | Divergence Time: 17.5 Mya | Cov: 5X")),
                expression(paste("Closer Ref3: ", italic("A. haemorrhoa"), " | Divergence Time: 17.5 Mya | Cov: 7X")),
...
p1_initial <- ggplot(data = data, aes(x = year)) +
    #xlim(1,150000)+
    #ylim(1,650000)+
    scale_x_continuous(limits= c(10,90000),labels = function(year) format(year, scientific = FALSE)) +
    ...
    annotate(geom = "rect",xmin = 10, xmax = 15000, ymin = 1, ymax = 190000, color = "black", linetype='dashed', linewidth = 0.5, alpha = 0.1) +
    ...
    ## legend line length
    legend.position = c(0.7,0.2), legend.key.width=unit(1,"cm"), legend.text = element_text(size = 12),
...
p1_final <- p1_initial + 
    ...
    annotation_custom(ggplotGrob(p1_zoom), xmin = 20000, xmax = 90000, ymin = 100000, ymax = 200000) +
    ## position of annotation frame
    geom_rect(aes(xmin = 20000, xmax = 90000, ymin = 100000, ymax = 200000), color='black', linetype='dashed', linewidth=0.5, alpha=0) +
    ## conncetion line to one side of the frame [geom_rect]
    geom_path(aes(x,y,group=grp), 
                #[selected-annotation:left-right]
                data=data.frame(x = c(15000,20000), y=c(10000,200000),grp=c(1,1,2,2)),
...
pdf_file <- file.path(result_path,"AndMar_combined_added_plot.no_doubleton.pdf")
