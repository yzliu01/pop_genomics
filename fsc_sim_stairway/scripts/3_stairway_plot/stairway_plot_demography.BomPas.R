...
list.files(pattern = "BomPas_New_REF_BomPas.no_singleton_sfs_*_1500x_sm_genic.final.summary")
...
pdf(paste0("StairwayPlot_BomPas.Median_75CI_95CI.pdf"),width = 20, height = 20)
...
for (group in c(
    ...
    if (group %in% c("BomPas_New_REF_BomPas.no_singleton_sfs_204_1500x_sm_genic", 
                    "BomPas_New_REF_BomPas.no_singleton_sfs_340_1500x_sm_genic"
                    )) {
        plot(1,1, type="n", xlim=c(10,5e5), ylim=c(1e3,7e5),log="x", xlab="", ylab="Effective population size",yaxt='n')
        ## ,xaxt='n',yaxt='n'
    ...
    } else if (group %in% c("BomPas_New_REF_BomPas.no_singleton_sfs_476_1500x_sm_genic"
                            )) {
        plot(1,1, type="n", xlim=c(10,5e5), ylim=c(1e3,7e5),log="x",xlab="Years ago", ylab="Effective population size",yaxt='n')
        lines(get(paste0(group,"_Dat"))$year,get(paste0(group,"_Dat"))$Ne_median,col=adjustcolor("red", alpha = 1),lwd=3)  # plot trajectory
        lines(get(paste0(group,"_Dat"))$year,get(paste0(group,"_Dat"))$Ne_2.5.,col=adjustcolor("blue", alpha = 0.8),lty=5,lwd=2.5)  # plot lower CI boundary
        lines(get(paste0(group,"_Dat"))$year,get(paste0(group,"_Dat"))$Ne_97.5.,col=adjustcolor("blue", alpha = 0.8),lty=5,lwd=2.5)  # plot upper CI boundary
        lines(get(paste0(group,"_Dat"))$year,get(paste0(group,"_Dat"))$Ne_12.5.,col=adjustcolor("goldenrod", alpha = 0.8),lty=5,lwd=2.5)  # plot lower CI boundary
        ...
        y_label <- c(1e3,2e5,4e5,6e5,8e5)
        axis(side=2, at=y_label,label=c(formatC(y_label,format="e",digits=0)))
    } else if (group %in% c("BomPas_New_REF_BomHyp.no_singleton_sfs_204_1500x_sm_genic",
                            "BomPas_New_REF_BomHyp.no_singleton_sfs_340_1500x_sm_genic"
                            #"BomPas_New_REF_BomHyp.no_singleton_sfs_476_1500x_sm_genic"
                            )) {
        plot(1,1, type="n", xlim=c(10,5e5), ylim=c(1e3,7e5),log="x",xlab="", ylab="",yaxt='n')
        lines(get(paste0(group,"_Dat"))$year,get(paste0(group,"_Dat"))$Ne_median,col=adjustcolor("red", alpha = 1),lwd=3)  # plot trajectory
        lines(get(paste0(group,"_Dat"))$year,get(paste0(group,"_Dat"))$Ne_2.5.,col=adjustcolor("blue", alpha = 0.8),lty=5,lwd=2.5)  # plot lower CI boundary
        lines(get(paste0(group,"_Dat"))$year,get(paste0(group,"_Dat"))$Ne_97.5.,col=adjustcolor("blue", alpha = 0.8),lty=5,lwd=2.5)  # plot upper CI boundary
        lines(get(paste0(group,"_Dat"))$year,get(paste0(group,"_Dat"))$Ne_12.5.,col=adjustcolor("goldenrod", alpha = 0.8),lty=5,lwd=2.5)  # plot lower CI boundary
        ...
        y_label <- c(1e3,2e5,4e5,6e5,8e5)
        axis(side=2, at=y_label,label=c(formatC(y_label,format="e",digits=0)))
    } else if (group %in% c("BomPas_New_REF_ApisMel.no_singleton_sfs_204_1500x_sm_genic",
                            "BomPas_New_REF_ApisMel.no_singleton_sfs_340_1500x_sm_genic"
                            )) {
        plot(1,1, type="n", xlim=c(10,5e5), ylim=c(1e3,7e5),log="x",xlab="", ylab="",yaxt='n')
        lines(get(paste0(group,"_Dat"))$year,get(paste0(group,"_Dat"))$Ne_median,col=adjustcolor("red", alpha = 1),lwd=3)  # plot trajectory
        ...
        plot(1,1, type="n", xlim=c(10,5e5), ylim=c(1e3,7e5),log="x",xlab="Years ago",ylab="",yaxt='n')
    ...
    if (all(sapply(c("BomPas_New_REF_BomPas"), grepl, group))) {
