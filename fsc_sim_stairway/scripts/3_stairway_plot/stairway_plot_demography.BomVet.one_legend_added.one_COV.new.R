...
pdf_file <- file.path(result_path,"BomVet_combined_added_plot.one_COV.new.pdf")
...
all_combined_plots <- arrangeGrob(combined_plot1_grob, 
                                    combined_plot2_grob, combined_plot3_grob, combined_plot4_grob, ncol = 1)

# Combine all the grobs into one layout
all_combined_plots <- arrangeGrob(combined_plot2_grob, 
