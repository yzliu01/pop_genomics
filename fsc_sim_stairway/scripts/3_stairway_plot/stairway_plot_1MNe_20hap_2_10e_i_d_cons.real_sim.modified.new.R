...
pdf(paste0("combined.1000000Ne_20hapS_5rep_2_10_i_d_cons_non_pruned.rotated_x_lab.pdf"),width = 20, height = 25)
...
for (generation in c("50G","100G","500G","1000G")){
    ...
    for (event in c("2e_d_cons","10e_d_cons","2e_i_cons","10e_i_cons")){
        ...
        if (plot_name %in% c("1000000Ne_20hapS_1E_50G_2e_d_cons_20Chr_15Mb", "1000000Ne_20hapS_1E_100G_2e_d_cons_20Chr_15Mb", "1000000Ne_20hapS_1E_500G_2e_d_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1000000Ne_20hapS_1E_1000G_2e_d_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1000000Ne_20hapS_1E_1000G_2e_i_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1000000Ne_20hapS_1E_50G_2e_i_cons_20Chr_15Mb","1000000Ne_20hapS_1E_100G_2e_i_cons_20Chr_15Mb","1000000Ne_20hapS_1E_500G_2e_i_cons_20Chr_15Mb")){
            plot(1,1, type="n", xlim=c(1,5e6), ylim=c(1,1.2e6),log="x", xlab="", ylab="",xaxt='n',yaxt='n')
            #xlab="Years ago", ylab="Effective population size"
            title(line=2)
            axis(side=2, at=c(150000,250000,500000,750000,1000000,1200000),label=c(format(c(150000,250000,500000,750000,1000000,1200000),scientific=FALSE)))

        } else if (plot_name %in% c("1000000Ne_20hapS_1E_50G_10e_i_cons_20Chr_15Mb","1000000Ne_20hapS_1E_100G_10e_i_cons_20Chr_15Mb","1000000Ne_20hapS_1E_500G_10e_i_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1000000Ne_20hapS_1E_1000G_10e_i_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1000000Ne_20hapS_1E_1000G_10e_d_cons_20Chr_15Mb")){
        ...
        ##1000000Ne_20hapS_1E_50G_10e_i_cons_20Chr_15Mb
        ## distance to x axis
        if (plot_name %in% c("1000000Ne_20hapS_1E_50G_10e_i_cons_20Chr_15Mb","1000000Ne_20hapS_1E_100G_10e_i_cons_20Chr_15Mb","1000000Ne_20hapS_1E_500G_10e_i_cons_20Chr_15Mb","1000000Ne_20hapS_1E_1000G_10e_i_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1000000Ne_20hapS_1E_50G_2e_i_cons_20Chr_15Mb","1000000Ne_20hapS_1E_100G_2e_i_cons_20Chr_15Mb","1000000Ne_20hapS_1E_500G_2e_i_cons_20Chr_15Mb","1000000Ne_20hapS_1E_1000G_2e_i_cons_20Chr_15Mb")) {
