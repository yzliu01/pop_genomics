...
pdf(paste0("combined.100000Ne_20hapS_5rep_10d_10d_2i_2i_2ei_2ed_2ed_2ei.rotated_x_lab_final.pdf"),width = 20, height = 25)
...
for (generation in c("100_500G")){
    ...
    for (event in c("10d_10d","2i_2i","2e_i_2e_d","2e_d_2e_i")){
        ...
        plot_name <- paste0("100000Ne_20hapS_2E_",generation,"_",event,"_20Chr_15Mb")
        #print(plot_name)
        ## print names with newline 
        cat("\n",plot_name,"\n\n")
        
        if (plot_name %in% c("xx_100000Ne_20hapS_2E_100_500G_10d_10d_20Chr_15Mb")){
            plot(1,1, type="n", xlim=c(1,5e6), ylim=c(1,6.0e4),log="x", xlab="", ylab="Effective population size",xaxt='n',yaxt='n')
            #log="xy",xlab="Years ago", ylab="Effective population size"
            title(line=2)
        } else if (plot_name %in% c("100000Ne_20hapS_2E_100_500G_10d_10d_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("100000Ne_20hapS_2E_100_500G_2i_2i_20Chr_15Mb","100000Ne_20hapS_2E_100_500G_2e_i_2e_d_20Chr_15Mb","100000Ne_20hapS_2E_100_500G_2e_d_2e_i_20Chr_15Mb")){
        ...
        ## distance to x axis
        if (plot_name %in% c("100000Ne_20hapS_2E_100_500G_10d_10d_20Chr_15Mb")){
        ...
        mtext(side=3,text=paste0("100000Ne_20hapS_2E_",generation,"_",event,"_20Chr_15Mb"),cex=0.8,line=1.2)
        ...
        for (rep in c(1:5)){
            ...
            #paste0("data_ft_sim_100000Ne_20hapS_2E_",generation,"_",event,"_20Chr_15Mb")
        ...
        x <- 0:100000
        #plot_name <- c("100000Ne_20hapS_2E_1000G_1.1i_20Chr_15Mb","100000Ne_20hapS_2E_1000G_1.5i_20Chr_15Mb","100000Ne_20hapS_2E_1000G_1.9i_20Chr_15Mb","100000Ne_20hapS_2E_1000G_0.5e_d_1.5i_20Chr_15Mb")
