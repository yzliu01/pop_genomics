...
#SBATCH --error=Se_Bom12Bal_14Lap_10Mon_Ind.all_sites_no_singleton.%A_%a.e.txt
#SBATCH --output=Se_Bom12Bal_14Lap_10Mon_Ind.all_sites_no_singleton.%A_%a.o.txt
#SBATCH --job-name=Se_Bom12Bal_14Lap_10Mon_Ind.all_sites_no_singleton
...
blueprint_file=`ls $blueprint_file_dir/Se_*.blueprint | head -6`
...
run_blueprint_plot_sh=$(ls $blueprint_file_dir/Se_*.blueprint.sh | head -6 | sed -n ${SLURM_ARRAY_TASK_ID}p)
