...
#SBATCH --error=fsc2stairway_1MNe_no_singleton_80_200hapS_10_e_i_cons_sim_10Chr_4left.%A_%a.e
#SBATCH --output=fsc2stairway_1MNe_no_singleton_80_200hapS_10_e_i_cons_sim_10Chr_4left.%A_%a.o
#SBATCH --job-name=fsc2stairway_1MNe_no_singleton_80_200hapS_10_e_i_cons_sim_10Chr_4left
...
run_80_200hapS_blueprint_plot_sh=`ls $blueprint_dir/ft_sim_1000000Ne_no_singleton_80hapS_1E_1000G_10e_i_cons_10Chr_15Mb_*.blueprint.sh | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p`
...
file_list_80_200hapS=`ls $blueprint_dir/ft_sim_1000000Ne_no_singleton_80hapS_1E_1000G_10e_i_cons_10Chr_15Mb_*.blueprint | sort -V`
