...
p5x_final <- p1_initial + 
    ...
    annotation_custom(ggplotGrob(p1_zoom), xmin = 50000, xmax = 180000, ymin = 250000, ymax = 800000) +
    ## position of annotation frame
    geom_rect(aes(xmin = 50000, xmax = 180000, ymin = 250000, ymax = 800000),
...
# Save the plot
ggsave("non_log_plot_all_5x.pdf", p5x_final, width = 10, height = 8)
