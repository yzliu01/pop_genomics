...
#SBATCH --error=bees_4pools.DP_200_1500_all_sites_no_doubleton.extended.sm_genic.New_REF_pas_hae_earlier.%A_%a.e.txt
#SBATCH --output=bees_4pools.DP_200_1500_all_sites_no_doubleton.extended.sm_genic.New_RE_pas_hae_earlier.%A_%a.o.txt
#SBATCH --job-name=bees_4pools.DP_200_1500_all_sites_no_doubleton.extended.sm_genic.New_REF_pas_hae_earlier
...
blueprint_file=`ls $blueprint_file_dir/*New_REF*no_doubleton_sfs_200x.extended.sm_genic.blueprint | sort -V`
...
run_blueprint_plot_sh=$(ls $blueprint_file_dir/*New_REF*no_doubleton_sfs_200x.extended.sm_genic.blueprint.sh | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
