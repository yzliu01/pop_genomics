...
#SBATCH --mem 3g
#SBATCH --array=1-240%15
#SBATCH --time=12:00:00
#SBATCH --error=fsc2stairway_100000Ne_20_80_200hapS_1E_cons_1.1i_1.5i_1.9i_20Chr_15Mb.array.%A_%a.e.txt
#SBATCH --output=fsc2stairway_100000Ne_20_80_200hapS_1E_cons_1.1i_1.5i_1.9i_20Chr_15Mb.array.%A_%a.o.txt
#SBATCH --job-name=fsc2stairway_100000Ne_20_80_200hapS_1E_cons_1.1i_1.5i_1.9i
