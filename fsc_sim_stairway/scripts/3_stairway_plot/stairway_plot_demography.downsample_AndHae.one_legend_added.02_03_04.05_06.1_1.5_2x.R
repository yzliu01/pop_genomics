...
file_list_a <- c(             
                "AndHae_New_REF_AndHae_0_2.no_singleton_sfs_78_1500x_sm_genic", 
                "AndHae_New_REF_AndHae_0_2.no_singleton_sfs_117_1500x_sm_genic",
                "AndHae_New_REF_AndHae_0_2.no_singleton_sfs_156_1500x_sm_genic",

                "AndHae_New_REF_AndHae_0_3.no_singleton_sfs_78_1500x_sm_genic", 
                "AndHae_New_REF_AndHae_0_3.no_singleton_sfs_117_1500x_sm_genic",
                "AndHae_New_REF_AndHae_0_3.no_singleton_sfs_156_1500x_sm_genic",

                "AndHae_New_REF_AndHae_0_4.no_singleton_sfs_78_1500x_sm_genic", 
                "AndHae_New_REF_AndHae_0_4.no_singleton_sfs_117_1500x_sm_genic",
                "AndHae_New_REF_AndHae_0_4.no_singleton_sfs_156_1500x_sm_genic",

                "AndHae_New_REF_AndHae_0_5.no_singleton_sfs_78_1500x_sm_genic", 
                "AndHae_New_REF_AndHae_0_5.no_singleton_sfs_117_1500x_sm_genic",
                "AndHae_New_REF_AndHae_0_5.no_singleton_sfs_156_1500x_sm_genic",

                "AndHae_New_REF_AndHae_0_6.no_singleton_sfs_78_1500x_sm_genic", 
                "AndHae_New_REF_AndHae_0_6.no_singleton_sfs_117_1500x_sm_genic",
                "AndHae_New_REF_AndHae_0_6.no_singleton_sfs_156_1500x_sm_genic"

                #"AndHae_New_REF_AndHat.no_singleton_sfs_78_1500x_sm_genic",
                #"AndHae_New_REF_AndHat.no_singleton_sfs_117_1500x_sm_genic",
                #"AndHae_New_REF_AndHat.no_singleton_sfs_156_1500x_sm_genic",

                #"AndHae_New_REF_AndFul.no_singleton_sfs_78_1500x_sm_genic",
                #"AndHae_New_REF_AndFul.no_singleton_sfs_117_1500x_sm_genic",
                #"AndHae_New_REF_AndFul.no_singleton_sfs_156_1500x_sm_genic",

                #"AndHae_New_REF_BomPas.no_singleton_sfs_78_1500x_sm_genic",
                #"AndHae_New_REF_BomPas.no_singleton_sfs_117_1500x_sm_genic",
                #"AndHae_New_REF_BomPas.no_singleton_sfs_156_1500x_sm_genic"
                )

file_list_b <- c(       

                expression(paste("Ref1: ", italic("A. haemorrhoa"), " | d", italic("S"), ":  0 | Cov: 02_1X")), 
                expression(paste("Ref1: ", italic("A. haemorrhoa"), " | d", italic("S"), ":  0 | Cov: 02_1.5X")),
                expression(paste("Ref1: ", italic("A. haemorrhoa"), " | d", italic("S"), ":  0 | Cov: 02_2X")),

                expression(paste("Ref1: ", italic("A. haemorrhoa"), " | d", italic("S"), ":  0 | Cov: 03_1X")), 
                expression(paste("Ref1: ", italic("A. haemorrhoa"), " | d", italic("S"), ":  0 | Cov: 03_1.5X")),
                expression(paste("Ref1: ", italic("A. haemorrhoa"), " | d", italic("S"), ":  0 | Cov: 03_2X")),

                expression(paste("Ref1: ", italic("A. haemorrhoa"), " | d", italic("S"), ":  0 | Cov: 04_1X")), 
                expression(paste("Ref1: ", italic("A. haemorrhoa"), " | d", italic("S"), ":  0 | Cov: 04_1.5X")),
                expression(paste("Ref1: ", italic("A. haemorrhoa"), " | d", italic("S"), ":  0 | Cov: 04_2X")),

                expression(paste("Ref1: ", italic("A. haemorrhoa"), " | d", italic("S"), ":  0 | Cov: 05_1X")), 
                expression(paste("Ref1: ", italic("A. haemorrhoa"), " | d", italic("S"), ":  0 | Cov: 05_1.5X")),
                expression(paste("Ref1: ", italic("A. haemorrhoa"), " | d", italic("S"), ":  0 | Cov: 05_2X")),

                expression(paste("Ref1: ", italic("A. haemorrhoa"), " | d", italic("S"), ":  0 | Cov: 06_1X")), 
                expression(paste("Ref1: ", italic("A. haemorrhoa"), " | d", italic("S"), ":  0 | Cov: 06_1.5X")),
                expression(paste("Ref1: ", italic("A. haemorrhoa"), " | d", italic("S"), ":  0 | Cov: 06_2X"))

                #expression(paste("Ref2: ", italic("A. hattorfiana"), " | d", italic("S"), ":  (0.1507, 0.1510) | Cov: 1X")),
                #expression(paste("Ref2: ", italic("A. hattorfiana"), " | d", italic("S"), ":  (0.1507, 0.1510) | Cov: 1.5X")),
                #expression(paste("Ref2: ", italic("A. hattorfiana"), " | d", italic("S"), ":  (0.1507, 0.1510) | Cov: 2X")),

                #expression(paste("Ref3: ", italic("A. fulva"), " | d", italic("S"), ":  (0.1527, 0.1531) | Cov: 1X")),
                #expression(paste("Ref3: ", italic("A. fulva"), " | d", italic("S"), ":  (0.1527, 0.1531)  | Cov: 1.5X")),
                #expression(paste("Ref3: ", italic("A. fulva"), " | d", italic("S"), ":  (0.1527, 0.1531)  | Cov: 2X")),

                #expression(paste("Ref4: ", italic("B. pascuorum"), " | d", italic("S"), ":  (1.1801, 1.1831) | Cov: 1X")),
                #expression(paste("Ref4: ", italic("B. pascuorum"), " | d", italic("S"), ":  (1.1801, 1.1831) | Cov: 1.5X")),
                #expression(paste("Ref4: ", italic("B. pascuorum"), " | d", italic("S"), ":  (1.1801, 1.1831) | Cov: 2X"))
                )
...
pdf_file <- file.path(result_path,"AndHae_Ref_AndHae.combined_plot.02_03_04.1_1.5_2x.pdf")
ggsave(pdf_file,combined_plot,width = 18, height = 13.5)

# downsample: 02_03_04.05_06
combined_plot <- marrangeGrob(grobs = plot_list,ncol = 5, nrow = 3,
                            layout_matrix = matrix(seq_len(15), nrow = 3, byrow = FALSE))
pdf_file <- file.path(result_path,"AndHae_Ref_AndHae.combined_plot.02_03_04.05_06.1_1.5_2x.pdf")
