...
pdf(paste0("combined.100000Ne_20hapS_2rep_2_10_i_d_cons_non_pruned.rotated_x_lab.pdf"),width = 20, height = 25)
#pdf(paste0("combined.100000Ne_20hapS_5rep_non_pruned.real_sim.rotated_x_lab-.pdf"),width = 20, height = 25)
