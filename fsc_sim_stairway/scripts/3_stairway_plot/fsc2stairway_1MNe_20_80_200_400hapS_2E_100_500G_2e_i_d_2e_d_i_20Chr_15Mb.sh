...
#SBATCH --error=fsc2stairway_1MNe_20_80_200_400hapS_2E_100_500G_2e_i_d_2e_d_i_20Chr_15Mb.%A_%a.e
#SBATCH --output=fsc2stairway_1MNe_20_80_200_400hapS_2E_100_500G_2e_i_d_2e_d_i_20Chr_15Mb.%A_%a.o
#SBATCH --job-name=fsc2stairway_1MNe_20_80_200_400hapS_2E_100_500G_2e_i_d_2e_d_i
...
blueprint_plot_sh=$(ls $blueprint_dir/ft_sim_1000000Ne_400hapS_1E*cons_20Chr_15Mb*.blueprint.sh | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
