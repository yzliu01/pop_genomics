...
##SBATCH --time=4:00:00
#SBATCH --error=bees_pool_2025.3_test.DP_1x_1.5x_2x.sm_genic.REF_no_singleton.%A_%a.e
#SBATCH --output=bees_pool_2025.3_test.DP_1x_1.5x_2x.sm_genic.REF_no_singleton.%A_%a.o
