...
#SBATCH --error=bees_4pools.DP_200_400_1500x_all_sites_no_singleton.sm_genic.New_REF_mar_earlier.%A_%a.e.txt
#SBATCH --output=bees_4pools.DP_200_400_1500x_all_sites_no_singleton.sm_genic.New_REF_mar_earlier.%A_%a.o.txt
#SBATCH --job-name=DP_200_400_1500x_all_sites_no_singleton.sm_genic.New_REF_mar_earlier
...
blueprint_file=`ls $blueprint_file_dir/*AndMar_New_REF_AndMar*1500x*blueprint | sort -r`
...
run_blueprint_plot_sh=$(ls $blueprint_file_dir/*AndMar_New_REF_AndMar*1500x*blueprint.sh | sort -r | sed -n ${SLURM_ARRAY_TASK_ID}p)
