...
head(a1)
plot(1,1, type="n", xlim=c(1,1e6), ylim=c(1,7e5), xlab="Years ago", ylab="Effective population size")
## ,xaxt='n',yaxt='n'
## specific line color
...
pdf(paste0("StairwayPlot_BomVet.Median_75CI.pdf"),width = 20, height = 20)
...
for (group in c(
    ...
    #plot(get(paste0(group,"_Dat"))$left_time_boundary/mu,(1/get(paste0(group,"_Dat"))$lambda/(2*mu)), type="n", xlim=c(1e3,5e7), ylim=c(1e5,1e6), xlab="Years ago", ylab="Effective population size")
...
#            lwd = 1)      # Grid line width
        ...
        plot(1,1, type="n", xlim=c(1,1e5), ylim=c(1e3,1e5),xlab="Years ago", ylab="Effective population size",xaxt='n',yaxt='n')
...
#            lwd = 1)      # Grid line width
        ...
        plot(1,1, type="n", xlim=c(1,1e5), ylim=c(1e3,1e5),xlab="Years ago",ylab="",xaxt='n',yaxt='n')
