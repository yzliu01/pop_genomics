...
pdf(paste0("combined.1MNe_200_300G_80hapS_5rep_2_10_i_d_cons.rotated_x_lab.pdf"),width = 20, height = 25)
...
for (generation in c("200G","300G")){
    ...
    for (event in c("2e_d_cons","10e_d_cons","2e_i_cons")){
        ...
        plot_name <- paste0("1MNe_80hapS_1E_",generation,"_",event,"_20Chr_15Mb")
        #print(plot_name)
...
#}
        ...
        if (plot_name %in% c("1MNe_80hapS_1E_200G_2e_d_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1MNe_80hapS_1E_300G_2e_d_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1MNe_80hapS_1E_300G_2e_i_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1MNe_80hapS_1E_200G_2e_i_cons_20Chr_15Mb")){
            plot(1,1, type="n", xlim=c(1,5e6), ylim=c(1,1.2e6),log="x", xlab="", ylab="",xaxt='n',yaxt='n')
            #xlab="Years ago", ylab="Effective population size"
            title(line=2)
            axis(side=2, at=c(150000,250000,500000,750000,1000000,1200000),label=c(format(c(150000,250000,500000,750000,1000000,1200000),scientific=FALSE)))

        } else if (plot_name %in% c("1MNe_80hapS_1E_50G_10e_i_cons_20Chr_15Mb","1MNe_80hapS_1E_100G_10e_i_cons_20Chr_15Mb","1MNe_80hapS_1E_500G_10e_i_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1MNe_80hapS_1E_1000G_10e_i_cons_20Chr_15Mb")){
            plot(1,1, type="n", xlim=c(1,5e6), ylim=c(1,5.2e6),log="x", xlab="Years ago", ylab="",xaxt='n',yaxt='n')
            #xlab="Years ago", ylab="Effective population size"
            title(line=2)
            axis(side=2, at=c(200000,500000,1000000,2000000,3000000,4000000,5000000),label=c(format(c(200000,500000,1000000,2000000,3000000,4000000,5000000),scientific=FALSE)))

        } else if (plot_name %in% c("1MNe_80hapS_1E_300G_10e_d_cons_20Chr_15Mb")){
        ...
        ## distance to x axis
        if (plot_name %in% c("1MNe_80hapS_1E_50G_10e_i_cons_20Chr_15Mb","1MNe_80hapS_1E_100G_10e_i_cons_20Chr_15Mb","1MNe_80hapS_1E_500G_10e_i_cons_20Chr_15Mb","1MNe_80hapS_1E_1000G_10e_i_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1MNe_80hapS_1E_200G_2e_i_cons_20Chr_15Mb","1MNe_80hapS_1E_300G_2e_i_cons_20Chr_15Mb")) {
        ...
        mtext(side=3,text=paste0("1MNe_80hapS_1E_",generation,"_",event,"_20Chr_15Mb"),cex=0.8,line=1.2)
...
#}
        ...
        x <- 0:100000
        #plot_name <- c("1MNe_80hapS_1E_1000G_1.1i_20Chr_15Mb","1MNe_80hapS_1E_1000G_1.5i_20Chr_15Mb","1MNe_80hapS_1E_1000G_1.9i_20Chr_15Mb","1MNe_80hapS_1E_1000G_0.5e_d_1.5i_20Chr_15Mb")
        ## category
