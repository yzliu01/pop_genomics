...
for (generation in c("100_500G")){
    ...
    for (event in c("10d_10d","2i_2i","2e_i_2e_d","2e_d_2e_i")){
        ...
        if (plot_name %in% c("xx_10000Ne_20hapS_2E_100_500G_10d_10d_20Chr_15Mb")){
            ...
            title(line=2)
        } else if (plot_name %in% c("10000Ne_20hapS_2E_100_500G_2i_2i_20Chr_15Mb","10000Ne_20hapS_2E_100_500G_2e_i_2e_d_20Chr_15Mb","10000Ne_20hapS_2E_100_500G_2e_d_2e_i_20Chr_15Mb")){
