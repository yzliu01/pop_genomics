...
#SBATCH --error=fsc2stairway_100KNe_20_80_200hapS_2E_100_500G_2d_i_2i_2d_20Chr_15Mb.%A_%a.e
#SBATCH --output=fsc2stairway_100KNe_20_80_200hapS_2E_100_500G_2d_i_2i_2d_20Chr_15Mb.%A_%a.o
#SBATCH --job-name=fsc2stairway_100KNe_20_80_200hapS_2E_100_500G_2d_i_2i_2d
...
#blueprint_plot_sh=$(ls -t $blueprint_dir/ft_sim_100000Ne*2E_100_500G_*.blueprint.sh | grep -E '2d_2d' | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
blueprint_plot_sh=`ls -t $blueprint_dir/ft_sim_100000Ne_20hapS*2E_100_500G_*.blueprint.sh | grep -E '2d_2d' | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p`
...
cd /home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2
blueprint_dir=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2/stairway_plot_blueprint/100000Ne_5rep
#blueprint_file=`ls -t $blueprint_dir/ft_sim_100000Ne*2E_100_500G_*.blueprint | grep -E '2d_2d' | head -30`
blueprint_file=`ls -t $blueprint_dir/ft_sim_100000Ne_20hapS*2E_100_500G_*.blueprint | grep -E '2d_2d'`
