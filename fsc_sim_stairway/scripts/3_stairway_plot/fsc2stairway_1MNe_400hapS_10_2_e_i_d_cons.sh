...
#SBATCH --error=fsc2stairway_1MNe_400hapS_10_2_e_i_d_cons.%A_%a.e.txt
#SBATCH --output=fsc2stairway_1MNe_400hapS_10_2_e_i_d_cons.%A_%a.o.txt
#SBATCH --job-name=fsc2stairway_1MNe_400hapS_10_2_e_i_d_cons
...
run_blueprint_plot_sh=$(ls $blueprint_dir/ft_sim_1000000Ne_400hapS*e_[id]_cons_20Chr_15Mb_*.blueprint.sh | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
...
blueprint_file=`ls $blueprint_dir/ft_sim_1000000Ne_400hapS*e_[id]_cons_20Chr_15Mb_*.blueprint`
