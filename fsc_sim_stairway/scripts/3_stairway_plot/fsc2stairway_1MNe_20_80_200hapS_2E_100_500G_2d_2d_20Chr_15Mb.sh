...
#SBATCH --error=fsc2stairway_1MNe_20_80_200hapS_2E_100_500G_2d_2i_2i_2d_20Chr_15Mb.%A_%a.e
#SBATCH --output=fsc2stairway_1MNe_20_80_200hapS_2E_100_500G_2d_2i_2i_2d_20Chr_15Mb.%A_%a.o
#SBATCH --job-name=fsc2stairway_1MNe_20_80_200hapS_2E_100_500G_2d_2i_2i_2d
...
blueprint_plot_sh=$(ls -t $blueprint_dir/ft_sim_1000000Ne*2E_100_500G_2d_2d_20Chr_15Mb*.blueprint.sh | grep -E '2d_2d' | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
...
blueprint_file=`ls -t $blueprint_dir/ft_sim_1000000Ne*2E_100_500G_2d_2d_20Chr_15Mb*.blueprint | grep -E '2d_2d'`
