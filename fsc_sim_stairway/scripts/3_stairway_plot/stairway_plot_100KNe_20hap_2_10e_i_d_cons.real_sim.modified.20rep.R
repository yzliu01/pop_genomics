...
setwd("/home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2/systematic_ft_non_pruned/100KNe_20rep")
...
pdf(paste0("combined.100KNe_20hapS_20rep_2_10_i_d_cons.rotated_x_lab.pdf"),width = 20, height = 25)
#pdf(paste0("combined.1000000Ne_20hapS_20rep_non_pruned.real_sim.rotated_x_lab-.pdf"),width = 20, height = 25)
...
for (generation in c("50G","100G","500G","1000G")){
    ...
    for (event in c("2e_d_cons","10e_d_cons","2e_i_cons","10e_i_cons")){
        ...
        plot_name <- paste0("100000Ne_20hapS_1E_",generation,"_",event,"_20Chr_15Mb")
        #print(plot_name)
        ## print names with newline 
        cat("\n",plot_name,"\n\n")
        
        if (plot_name %in% c("100000Ne_20hapS_1E_50G_2e_d_cons_20Chr_15Mb", "100000Ne_20hapS_1E_100G_2e_d_cons_20Chr_15Mb", "100000Ne_20hapS_1E_500G_2e_d_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("100000Ne_20hapS_1E_1000G_2e_d_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("100000Ne_20hapS_1E_1000G_2e_i_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("100000Ne_20hapS_1E_50G_2e_i_cons_20Chr_15Mb","100000Ne_20hapS_1E_100G_2e_i_cons_20Chr_15Mb","100000Ne_20hapS_1E_500G_2e_i_cons_20Chr_15Mb")){
            plot(1,1, type="n", xlim=c(1,5e6), ylim=c(1,1.2e5),log="x", xlab="", ylab="",xaxt='n',yaxt='n')
            #xlab="Years ago", ylab="Effective population size"
            title(line=2)
            axis(side=2, at=c(15000,25000,50000,75000,100000,120000),label=c(format(c(15000,25000,50000,75000,100000,120000),scientific=FALSE)))

        } else if (plot_name %in% c("100000Ne_20hapS_1E_50G_10e_i_cons_20Chr_15Mb","100000Ne_20hapS_1E_100G_10e_i_cons_20Chr_15Mb","100000Ne_20hapS_1E_500G_10e_i_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("100000Ne_20hapS_1E_1000G_10e_i_cons_20Chr_15Mb")){
            plot(1,1, type="n", xlim=c(1,5e6), ylim=c(1,5.2e5),log="x", xlab="Years ago", ylab="",xaxt='n',yaxt='n')
            #xlab="Years ago", ylab="Effective population size"
            title(line=2)
            axis(side=2, at=c(25000,50000,75000,95000,150000,300000,450000,500000,520000),label=c(format(c(25000,50000,75000,95000,150000,300000,450000,500000,520000),scientific=FALSE)))

        } else if (plot_name %in% c("100000Ne_20hapS_1E_1000G_10e_d_cons_20Chr_15Mb")){
        ...
        mtext(side=3,text=paste0("100000Ne_20hapS_1E_",generation,"_",event,"_20Chr_15Mb"),cex=0.8,line=1.2)
        ...
        for (rep in c(1:20)){
            ...
            #paste0("data_ft_sim_100000Ne_20hapS_1E_",generation,"_",event,"_20Chr_15Mb")
...
#}
        ...
        x <- 0:100000
        #plot_name <- c("100000Ne_20hapS_1E_1000G_1.1i_20Chr_15Mb","100000Ne_20hapS_1E_1000G_1.5i_20Chr_15Mb","100000Ne_20hapS_1E_1000G_1.9i_20Chr_15Mb","100000Ne_20hapS_1E_1000G_0.5e_d_1.5i_20Chr_15Mb")
        ## category
