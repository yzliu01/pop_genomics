...
#SBATCH --error=bees_pool_BomVet.DP_3x_5x_7x.sm_genic.New_REF_BomVet.%A_%a.e
#SBATCH --output=bees_pool_BomVet.DP_3x_5x_7x.sm_genic.New_REF_BomVet.%A_%a.o
#SBATCH --job-name=bees_pool_BomVet.DP_3x_5x_7x.sm_genic.New_REF_BomVet
...
blueprint_file=`ls -t $blueprint_file_dir/BomVet_New_REF_Vet*blueprint | head -6 | sort`
...
run_blueprint_plot_sh=$(ls -t $blueprint_file_dir/BomVet_New_REF_Vet*blueprint.sh | head -6 | sort | sed -n ${SLURM_ARRAY_TASK_ID}p)
