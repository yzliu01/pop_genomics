...
#SBATCH --error=bees_pool_AndHae.DP_3x_5x_7x.sm_genic.New_REF_BomPasno_doubleton.%A_%a.e
#SBATCH --output=bees_pool_AndHae.DP_3x_5x_7x.sm_genic.New_REF_BomPasno_doubleton.%A_%a.o
#SBATCH --job-name=bees_pool_AndHae.DP_3x_5x_7x.sm_genic.New_REF_BomPasno_doubleton
...
run_blueprint_plot_sh=$(ls -t $blueprint_file_dir/AndHae_New_REF_BomPas*double*1500x*blueprint.sh | head -3 | sort | sed -n ${SLURM_ARRAY_TASK_ID}p)
