...
#SBATCH --error=swp_ft_sim_10000Ne_20_80_200hapS_1E_50G_00d_20Chr_15Mb_5rep_non_prun.parallel.7left.%A.e.txt
#SBATCH --output=swp_ft_sim_10000Ne_20_80_200hapS_1E_50G_00d_20Chr_15Mb_5rep_non_prun.parallel.7left.%A.o.txt
#SBATCH --job-name=swp_7left_non_prun_test3_ft
...
blueprint_file=`ls $blueprint_file_dir/ft_sim_10000Ne*20Chr_15Mb_*.blueprint | sort -V`
...
blueprint_sh=`ls $blueprint_file_dir/ft_sim_10000Ne*20Chr_15Mb*.blueprint.sh | sort -V | head -2`
run_batch_file(){
...
unfinished_folder=/home/yzliu/bin/stairway_plot_v2.1.2/systematic_ft_test3
left_7=$(for i in $(eval echo `ls -td $unfinished_folder/ft_sim_10000Ne_20hapS_1E*[0-5] | tail -7 | cut -d "/" -f 7`);do echo $blueprint_file_dir/$i".blueprint.sh";done)
run_blueprint_plot_sh=$(ls $left_7 | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
