...
pdf(paste0("combined.10000Ne_20hapS_5rep_non_pruned.real_sim.rotated_x_lab_final-.pdf"),width = 20, height = 25)
...
par(mfcol=c(5,4),mar=c(4,4.4,3,1.5)+0.4,cex.lab=1.6, cex.axis=1.3,lwd=2)
