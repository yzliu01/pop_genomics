...
#SBATCH --mem 550g
#SBATCH --array=1-11%2
#SBATCH --time=1-20:14:00
#SBATCH --error=ft_sim_10KNe_20_80_200_200S_1_2E_4e_10e_di_025_01_di_20Chr_15Mb_5rep_11left.%A_%a.e.txt
#SBATCH --output=ft_sim_10KNe_20_80_200_200S_1_2E_4e_10e_di_025_01_di_20Chr_15Mb_5rep_11left.%A_%a.o.txt
...
## https://stackoverflow.com/questions/36223802/store-for-loop-results-as-a-variable-in-bash
fsc_10000Ne(){
    for each_par in $(eval echo $par);do
        fsc27093 -i $each_par -n 5 -q -s 0 -m --foldedSFS -c 12 -g -G -k 300000000
    done
}
## execute the function
#fsc_10000Ne
echo "repeat steps?" >> left_13_test.error
exit
