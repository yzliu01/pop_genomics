...
#SBATCH --error=ft_sim_10KNe_20S_1E_1.5e_3e_di_cons_20Chr_15Mb_5rep_det_err.%A_%a.e.txt
#SBATCH --output=ft_sim_10KNe_20S_1E_1.5e_3e_di_cons_20Chr_15Mb_5rep_det_err.%A_%a.o.txt
#SBATCH --job-name=ft_10KNe_rep5_1E_1.5e_3e_di_cons_det_err
...
par=$(ls -t $par_folder/ft_sim_10000Ne*1E_*e0*_cons_*20Chr_15Mb.par | head -6 | sed -n ${SLURM_ARRAY_TASK_ID}p)
