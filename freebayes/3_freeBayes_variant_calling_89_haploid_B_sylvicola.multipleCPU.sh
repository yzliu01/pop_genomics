...
##SBATCH -t 00:20:00
#SBATCH -t 2-05:00:00
#SBATCH -J freeBayes_haploid_variant_calling_Bsyl.multipleCPU
#SBATCH --mail-type=all
#SBATCH --mail-user=yuanzhen.liu@imbim.uu.se
#SBATCH --error=freeBayes_haploid_variant_calling_Bsyl.multipleCPU.%A.e
#SBATCH --output=freeBayes_haploid_variant_calling_Bsyl.multipleCPU.%A.o
...
NEW_NAME=freeBayes_male_27monticola_62lapponicus.bam.multipleCPU.g.vcf
...
--ploidy 1 --strict-vcf --gvcf > $OUTDIR/gVCF/$NEW_NAME

#freebayes-parallel <(fasta_generate_regions.py $REF_DIR/Bombus_sylvicola_v1.fna.fai 100000) 18 --fasta-reference $REF --bam-list $SAMPLE \
#--ploidy 1 --strict-vcf --gvcf > $OUTDIR/gVCF/$NEW_NAME
