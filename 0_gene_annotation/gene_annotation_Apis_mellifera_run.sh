...
#SBATCH --error=gene_annotation_Apis_mellifera
#SBATCH --output=gene_annotation_Apis_mellifera
#SBATCH --job-name=gene_annotation_Apis_mellifera
...
mkdir /home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/gene_annotation/braker_ApisMel_results_for_protseq
braker_output_dir_for_protseq=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/gene_annotation/braker_ApisMel_results_for_protseq
...
Apis_mellifera_softmask_simple_header_genome=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/ref_genome/Apis_mellifera_HAv-GCF_003254395.2-softmasked.fa
...
braker.pl --genome="$Apis_mellifera_softmask_simple_header_genome" --prot_seq="$Apodiea_gene_AA" \
