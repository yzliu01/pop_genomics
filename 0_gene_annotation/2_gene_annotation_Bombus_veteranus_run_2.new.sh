...
#SBATCH --error=gene_ann_Bombus_veteranus_2.new
#SBATCH --output=gene_ann_Bombus_veteranus_2.new
#SBATCH --job-name=gene_ann_Bombus_veteranus_2.new
...
rm -r braker_BomVet_hymenoptera_results_for_protseq_2_new

mkdir /home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/gene_annotation/braker_BomVet_hymenoptera_results_for_protseq_2_new
braker_output_dir_for_protseq=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/gene_annotation/braker_BomVet_hymenoptera_results_for_protseq_2_new
...
Bombus_veteranus_softmask_simple_header_genome=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/ref_genome/Bombus_veteranus.hifi_asm_pl2.simple_header.fa
...
prothint_augustus_gff=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/gene_annotation/prothint_results_BomVet_hymenoptera/prothint_augustus.gff
...
# --prot_seq="$Hymenoptera_gene_AA" 
braker.pl --genome="$Bombus_veteranus_softmask_simple_header_genome" --hints=$prothint_augustus_gff \
