...
#SBATCH --error=gene_ann_Bombus_veteranus_1.new
#SBATCH --output=gene_ann_Bombus_veteranus_1.new
#SBATCH --job-name=gene_ann_Bombus_veteranus_1.new
...
rm -r braker_BomVet_results_for_protseq_1_new

mkdir /home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/gene_annotation/braker_BomVet_results_for_protseq_1_new
braker_output_dir_for_protseq=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/gene_annotation/braker_BomVet_results_for_protseq_1_new
