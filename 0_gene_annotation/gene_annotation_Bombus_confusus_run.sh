...
#SBATCH --error=gene_annotation_BomCon.%A.e
#SBATCH --output=gene_annotation_BomCon.%A.o
#SBATCH --job-name=gene_annotation_BomCon
...
mkdir /home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/gene_annotation/braker_BomCon_results_for_protseq
braker_output_dir_for_protseq=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/gene_annotation/braker_BomCon_results_for_protseq
...
Bombus_confusus_softmask_simple_header_genome=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/ref_genome/Bombus_confusus-GCA_014737475.1_ASM1473747v1-softmasked.simple_header.fa
...
braker.pl --genome="$Bombus_confusus_softmask_simple_header_genome" --prot_seq="$Apodiea_gene_AA" \
