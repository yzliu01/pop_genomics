...
#SBATCH --error=gene_annotation_BomMus_alt.%A.e
#SBATCH --output=gene_annotation_BomMus_alt.%A.o
#SBATCH --job-name=gene_annotation_BomMus_alt
...
rm -r braker_BomMus_alt_results_for_protseq

mkdir /home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/gene_annotation/braker_BomMus_alt_results_for_protseq
braker_output_dir_for_protseq=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/gene_annotation/braker_BomMus_alt_results_for_protseq
