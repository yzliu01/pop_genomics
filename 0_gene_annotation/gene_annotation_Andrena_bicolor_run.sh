...
#SBATCH --error=gene_annotation_AndBic.%A.e
#SBATCH --output=gene_annotation_AndBic.%A.o
#SBATCH --job-name=gene_annotation_AndBic
...
rm -r braker_AndBic_results_for_protseq

mkdir /home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/gene_annotation/braker_AndBic_results_for_protseq
braker_output_dir_for_protseq=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/gene_annotation/braker_AndBic_results_for_protseq
...
braker.pl --genome="$Andrena_bicolor_softmask_simple_header_genome" --prot_seq="$Apodiea_gene_AA" \
...
## 
cd /home/yzliu/miniforge3/envs/snpEff/share/snpeff-5.2-0/data/AndBio-GCA_960531205.1
## copy braker.gtf to snpeff data folder
cp /home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/gene_annotation/braker_AndBio_results_for_protseq/braker.gtf .
## compress the file
## pigz is faster than gzip
## https://www.baeldung.com/linux/gzip-and-gunzip
bgzip /home/yzliu/miniforge3/envs/snpEff/share/snpeff-5.2-0/data/AndBio-GCA_960531205.1/genes.gtf
pigz
gzip
