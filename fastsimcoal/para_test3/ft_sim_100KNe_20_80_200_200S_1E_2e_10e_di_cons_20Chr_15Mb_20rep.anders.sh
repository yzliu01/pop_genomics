...
#SBATCH --error=ft_sim_100KNe_20_80_200_200S_1E_2e_10e_di_cons_20Chr_15Mb_20rep.%A.e
#SBATCH --output=ft_sim_100KNe_20_80_200_200S_1E_2e_10e_di_cons_20Chr_15Mb_20rep.%A.o
#SBATCH --job-name=ft_100KNe_1E_2e_10e_di_cons_20rep
...
par=$(ls $par_folder/ft_sim_100000Ne*1E_*_cons_*20Chr_15Mb.par | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
