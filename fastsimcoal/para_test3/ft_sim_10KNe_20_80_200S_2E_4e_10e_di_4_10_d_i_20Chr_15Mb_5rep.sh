...
#SBATCH --error=ft_sim_10KNe_20_80_200S_2E_4e_10e_di_4_10_d_i_20Chr_15Mb_5rep.%A_%a.e.txt
#SBATCH --output=ft_sim_10KNe_20_80_200S_2E_4e_10e_di_4_10_d_i_20Chr_15Mb_5rep.%A_%a.o.txt
#SBATCH --job-name=ft_10KNe_rep5_2E_4e_10e_d_i_4_10_d_i
