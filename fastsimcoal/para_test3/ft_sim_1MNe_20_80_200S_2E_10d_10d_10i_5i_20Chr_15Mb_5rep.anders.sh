...
#SBATCH --error=ft_sim_1MNe_20_80_200S_2E_10d_10d_10i_5i_20Chr_15Mb_5rep.anders.%A_%a.e.txt
#SBATCH --output=ft_sim_1MNe_20_80_200S_2E_10d_10d_10i_5i_20Chr_15Mb_5rep.anders.%A_%a.o.txt
