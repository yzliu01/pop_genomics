...
#SBATCH --mem 200G
#SBATCH --array=2-5%4 # 20haps
##SBATCH --array=21-60%5
##SBATCH --time=00:30:00 # 20haps
#SBATCH --time=08:14:00
#SBATCH --error=ft_sim_1MNe_400S_1E_00_01_05_09d_2e_10e_d_i_20Chr_15Mb_5rep.anders_left2.%A_%a.e.txt
#SBATCH --output=ft_sim_1MNe_400S_1E_00_01_05_09d_2e_10e_d_i_20Chr_15Mb_5rep.anders_left2.%A_%a.o.txt
#SBATCH --job-name=ft_sim_1MNe_400S_8
