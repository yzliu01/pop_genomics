...
#SBATCH --error=ft_sim_10KNe_20_80_200S_2E_10i_5i_2i_20Chr_15Mb_5rep.anders.%A_%a.e.txt
#SBATCH --output=ft_sim_10KNe_20_80_200S_2E_10i_5i_2i_20Chr_15Mb_5rep.anders.%A_%a.o.txt
#SBATCH --job-name=anders_ft_sim_10KNe_20_80_200S_2E_10i_5i_2i_single
