...
#SBATCH --error=ft_sim_1MNe_20_80_200S_2E_5i_5i_20Chr_15Mb_5rep.258.%A_%a.e.txt
#SBATCH --output=ft_sim_1MNe_20_80_200S_2E_5i_5i_20Chr_15Mb_5rep.258.%A_%a.o.txt
#SBATCH --job-name=258ft_1MNe_rep5_5i_5i
