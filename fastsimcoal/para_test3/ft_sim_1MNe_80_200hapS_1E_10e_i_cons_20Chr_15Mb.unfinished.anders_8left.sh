...
##SBATCH --mem 1600g ## maximun 1500g
#SBATCH --array=1-8%8
#SBATCH --time=03:00:00
#SBATCH --error=ft_sim_1MNe_80_200hapS_1E_10_i_cons_20Chr_15Mb.anders_8left.%A_%a.e.txt
#SBATCH --output=ft_sim_1MNe_80_200hapS_1E_10_i_cons_20Chr_15Mb.anders_8left.%A_%a.o.txt
#SBATCH --job-name=ft_sim_1MNe_80_200hapS_1E_10_i_cons_20Chr_15Mb
...
fsc27093 -i ../*.par -n 5 -c 12 -q -x -s 0 -m --foldedSFS -g -G -k 300000000
