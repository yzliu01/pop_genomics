...
#SBATCH --error=ft_sim_100KNe_20_80_200S_2E_2e_i_d_2e_d_i_2i_2i_20Chr_15Mb_20rep.anders.%A_%a.e
#SBATCH --output=ft_sim_100KNe_20_80_200S_2E_2e_i_d_2e_d_i_2i_2i_20Chr_15Mb_20rep.anders.%A_%a.o
#SBATCH --job-name=ft_100KNe_2E_2e_i_d_2e_d_i_2i_2i_anders_20rep
...
## exclude 5i_5i scenario
#rename par par---- $par_folder/*5i_5i_20Chr_15Mb.par

par=$(ls $par_folder/ft_sim_100000Ne*2E_100_500G_*20Chr_15Mb.par | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
...
fsc27093 -i ../*.par -n 20 -q -x -s 0 -m --foldedSFS -c 12 -g -G -k 300000000

## copy files to faststorage
eDAN_DIR=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/steps/systematic_fsc_test3/100KNe_20rep
cp -r * $eDAN_DIR
