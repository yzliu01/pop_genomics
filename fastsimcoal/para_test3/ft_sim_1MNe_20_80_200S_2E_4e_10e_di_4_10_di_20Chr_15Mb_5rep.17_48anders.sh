...
#SBATCH --mem 80g
#SBATCH --array=17-48%8
#SBATCH --time=08:14:00
#SBATCH --error=ft_sim_1MNe_20_80_200S_2E_4e_10e_di_4_10_di_20Chr_15Mb_5rep.17_48anders.%A_%a.e.txt
#SBATCH --output=ft_sim_1MNe_20_80_200S_2E_4e_10e_di_4_10_di_20Chr_15Mb_5rep.17_48anders.%A_%a.o.txt
#SBATCH --job-name=17_48anders_ft_1MNe_rep5_2E_4e_10e_di_4_10_di
...
par=$(ls $par_folder/ft_sim_1000000Ne*2E_*e*20Chr_15Mb.par | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
