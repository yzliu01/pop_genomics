...
#SBATCH --mem 20g #for 2e_i
#SBATCH --array=1-3%3 #for 2e_i
##SBATCH --mem 30g #for 10e_i
##SBATCH --array=1-12%12 #for 10e_i
#SBATCH --time=02:00:00 #for 2e_i
##SBATCH --time=05:00:00 #for 10e_i
#SBATCH --error=ft_sim_100KNe_20_80_200hapS_1E_2_10e_i_cons_20Chr_15Mb.anders.%A_%a.e.txt
#SBATCH --output=ft_sim_100KNe_20_80_200hapS_1E_2_10e_i_cons_20Chr_15Mb.anders.%A_%a.o.txt
#SBATCH --job-name=ft_sim_100KNe_20_80_200hapS_1E_2_10e_i_cons_20Chr_15Mb
...
unfinished_list=("ft_sim_100000Ne_80hapS_1E_50G_2e_i_cons_20Chr_15Mb.par"
                "ft_sim_100000Ne_80hapS_1E_100G_2e_i_cons_20Chr_15Mb.par"
                "ft_sim_100000Ne_80hapS_1E_500G_2e_i_cons_20Chr_15Mb.par"
                )
...
"ft_sim_100000Ne_80hapS_1E_500G_2e_i_cons_20Chr_15Mb.par"
"ft_sim_100000Ne_80hapS_1E_100G_2e_i_cons_20Chr_15Mb.par"
"ft_sim_100000Ne_80hapS_1E_50G_2e_i_cons_20Chr_15Mb.par"
