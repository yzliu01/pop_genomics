...
#SBATCH --error=ft_sim_1000000Ne_200hapS_2E_100_500G_2e_i_d_2e_d_i_20Chr_15Mb.anders.%A_%a.e.txt
#SBATCH --output=ft_sim_1000000Ne_200hapS_2E_100_500G_2e_i_d_2e_d_i_20Chr_15Mb.anders.%A_%a.o.txt
...
par=$(ls $par_folder/ft_sim_1000000Ne*2E_100_500G_2e*2e*20Chr_15Mb.par | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
