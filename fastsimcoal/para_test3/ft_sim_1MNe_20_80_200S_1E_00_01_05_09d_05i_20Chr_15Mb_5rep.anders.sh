...
#SBATCH --mem 35g
#SBATCH --array=1-60%5 # 20haps
##SBATCH --array=21-60%5
##SBATCH --time=00:30:00 # 20haps
#SBATCH --time=04:14:00
#SBATCH --error=ft_sim_1MNe_20_80_200S_1E_00_01_05_09d_05i_20Chr_15Mb_5rep.anders.%A_%a.e.txt
#SBATCH --output=ft_sim_1MNe_20_80_200S_1E_00_01_05_09d_05i_20Chr_15Mb_5rep.anders.%A_%a.o.txt
#SBATCH --job-name=ft_1MNe_rep5_anders
