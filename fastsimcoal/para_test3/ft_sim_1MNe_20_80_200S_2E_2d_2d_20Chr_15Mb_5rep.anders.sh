...
#SBATCH --error=ft_sim_1MNe_20_80_200S_2E_2d_2d_20Chr_15Mb_5rep.%A_%a.e.txt
#SBATCH --output=ft_sim_1MNe_20_80_200S_2E_2d_2d_20Chr_15Mb_5rep.%A_%a.o.txt
#SBATCH --job-name=ft_sim_1MNe_20_80_200S_2E_2d_2d_20Chr_15Mb_5rep
...
par=$(ls $par_folder/ft_sim_1000000Ne_20*hapS*2E_100_500G_*2d_2d_20Chr_15Mb.par | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
