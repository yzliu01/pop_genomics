...
#SBATCH --error=ft_sim_1MNe_05i_20Chr_15Mb_5rep.%A_%a.e
#SBATCH --output=ft_sim_1MNe_05i_20Chr_15Mb_5rep.%A_%a.o
#SBATCH --job-name=ft_sim_1MNe_05i_20Chr_15Mb_5rep
...
par_folder=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/population_genomics/fastsimcoal/para_test3/1000000Ne
## test par
...
par=$(ls $par_folder/ft_sim_1000000Ne*1E_*05i_20Chr_15Mb.par | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
