...
#SBATCH --error=ft_sim_1MNe_20_80_200S_2E_2i_2i_20Chr_15Mb_5rep.147.%A_%a.e.txt
#SBATCH --output=ft_sim_1MNe_20_80_200S_2E_2i_2i_20Chr_15Mb_5rep.147.%A_%a.o.txt
#SBATCH --job-name=147ft_1MNe_rep5_2i_2i
