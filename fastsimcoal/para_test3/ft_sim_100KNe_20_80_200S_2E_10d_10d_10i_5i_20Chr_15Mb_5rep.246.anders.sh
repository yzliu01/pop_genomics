...
#SBATCH --error=ft_sim_100KNe_20_80_200S_2E_10d_10d_10i_5i_20Chr_15Mb_5rep.246anders.%A_%a.e.txt
#SBATCH --output=ft_sim_100KNe_20_80_200S_2E_10d_10d_10i_5i_20Chr_15Mb_5rep.246anders.%A_%a.o.txt
#SBATCH --job-name=246ft_100KNe_rep5_2E_10d_10d_10i_5i_anders
