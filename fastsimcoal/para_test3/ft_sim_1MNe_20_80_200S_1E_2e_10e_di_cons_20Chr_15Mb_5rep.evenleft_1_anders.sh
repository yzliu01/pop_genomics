...
#SBATCH --mem 1000g
#SBATCH --array=24-48:4
##SBATCH --array=24,28,32,36,40,44,48:4
##SBATCH --array=4,8,12,16,18,20,22,24,26,28,30,32,34,36,38,40,42,44,46,48%8
#SBATCH --time=03:00:00
#SBATCH --error=ft_sim_1MNe_20_80_200S_1E_2e_10e_di_cons_20Chr_15Mb_5rep.evenleft_anders_1.%A_%a.e.txt
#SBATCH --output=ft_sim_1MNe_20_80_200S_1E_2e_10e_di_cons_20Chr_15Mb_5rep.evenleft_anders_1.%A_%a.o.txt
#SBATCH --job-name=evenleft_1_anders_ft_1MNe_rep5_1E_2e_10e_di_cons
