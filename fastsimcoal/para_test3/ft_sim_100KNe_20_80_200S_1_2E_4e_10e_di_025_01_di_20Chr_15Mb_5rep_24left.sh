...
#SBATCH --error=ft_sim_100KNe_20_80_200_200S_1_2E_4e_10e_di_025_01_di_20Chr_15Mb_5rep_24left.%A_%a.e.txt
#SBATCH --output=ft_sim_100KNe_20_80_200_200S_1_2E_4e_10e_di_025_01_di_20Chr_15Mb_5rep_24left.%A_%a.o.txt
#SBATCH --job-name=ft_100KNe_rep5_1_2E_2e_10e_di_cons_24left
...
#find -maxdepth 2 -print | grep -e 'e_[id]_' | grep '_5.gen$' | sort -V | cut -d "/" -f 2 > finished_par_gen5_new
#find -maxdepth 2 -print | grep -e 'e_[id]_' | grep '_1.gen$' | sort -V | cut -d "/" -f 2 > finished_par_gen1

unfinished_par_list=`sort finished_par_gen5_new finished_par_gen1 | uniq -u`
...
fsc27093 -i $par -n 5 -q -s 0 -m --foldedSFS -g -G -k 300000000
#  -c 12 -B 12 
exit
