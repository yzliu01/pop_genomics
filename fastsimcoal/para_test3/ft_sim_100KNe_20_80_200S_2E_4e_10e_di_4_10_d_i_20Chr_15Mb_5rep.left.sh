...
#SBATCH --array=7,19,23,31,35,38-39,42-43,47-48%12
##SBATCH --array=7,19,23,27-48%12
#SBATCH --time=20:14:00
#SBATCH --error=ft_sim_100KNe_20_80_200S_2E_4e_10e_di_4_10_d_i_20Chr_15Mb_5rep.left.%A_%a.e.txt
#SBATCH --output=ft_sim_100KNe_20_80_200S_2E_4e_10e_di_4_10_d_i_20Chr_15Mb_5rep.left.%A_%a.o.txt
...
fsc27093 -i $par -n 5 -q -s 0 -m --foldedSFS -c 8 -g -G -k 300000000
