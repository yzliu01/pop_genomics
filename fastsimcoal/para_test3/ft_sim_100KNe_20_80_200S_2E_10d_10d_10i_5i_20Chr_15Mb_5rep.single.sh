...
#SBATCH --error=ft_sim_100KNe_20_80_200S_2E_10d_10d_10i_5i_20Chr_15Mb_5rep.single.%A.e.txt
#SBATCH --output=ft_sim_100KNe_20_80_200S_2E_10d_10d_10i_5i_20Chr_15Mb_5rep.single.%A.o.txt
#SBATCH --job-name=ft_100KNe_rep5_2E_10d_10d_10i_5i.single
...
## test par
par=$par_folder/ft_sim_100000Ne_200hapS_2E_100_500G_10i_5i_20Chr_15Mb.par
## ft_sim_100000Ne_200hapS_1E_500G_05i_20Chr_15Mb.par
#par=$(ls $par_folder/ft_sim_100000Ne*2E_100_500G_10*20Chr_15Mb.par | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
