...
#SBATCH --error=ft_sim_1MNe_80_200hapS_1E_10_i_cons_20Chr_15Mb.anders.%A_%a.e.txt
#SBATCH --output=ft_sim_1MNe_80_200hapS_1E_10_i_cons_20Chr_15Mb.anders.%A_%a.o.txt
...
fsc27093 -i ../*.par -n 5 -q -x -s 0 -m --foldedSFS -g -G -k 300000000
