...
#SBATCH --error=ft_sim_10KNe_20_80_200S_2E_10i_5i_2i_20Chr_15Mb_5rep.9anders.%A_%a.e.txt
#SBATCH --output=ft_sim_10KNe_20_80_200S_2E_10i_5i_2i_20Chr_15Mb_5rep.9anders.%A_%a.o.txt
#SBATCH --job-name=9anders_ft_sim_10KNe_20_80_200S_2E_10i_5i_2i_single
...
par=$(ls $par_folder/ft_sim_10000Ne*2E_*i_*i*20Chr_15Mb.par | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
