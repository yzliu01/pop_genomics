...
#SBATCH --time=05-00:14:00
##SBATCH --time=04-00:14:00
#SBATCH --error=ft_sim_1MNe_20_80_200_200S_1E_00_01_05_09d_05i_20Chr_15Mb_5rep_new_single.%A.e.txt
#SBATCH --output=ft_sim_1MNe_20_80_200_200S_1E_00_01_05_09d_05i_20Chr_15Mb_5rep_new_single.%A.o.txt
#SBATCH --job-name=ft_1MNe_rep5_new_single
...
par=$(ls $par_folder/ft_sim_1000000Ne*1E_*20Chr_15Mb_[1-5].par | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
