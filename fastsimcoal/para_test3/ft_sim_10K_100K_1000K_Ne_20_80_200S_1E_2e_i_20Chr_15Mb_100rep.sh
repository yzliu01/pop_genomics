...
#SBATCH --error=ft_sim_10K_100K_1000K_Ne_20_80_200S_1E_2e_i_20Chr_15Mb_100rep.%A_%a.e
#SBATCH --output=ft_sim_10K_100K_1000K_Ne_20_80_200S_1E_2e_i_20Chr_15Mb_100rep.%A_%a.o
#SBATCH --job-name=ft_sim_10K_100K_1000K_Ne_20_80_200S_1E_2e_i_20Chr_15Mb_100rep
...
par=$(ls $par_folder/ft_sim_100000Ne_80hapS_1E_100G_2e_i_cons_20Chr_15Mb.par | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
