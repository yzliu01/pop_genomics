...
#SBATCH --mem 80g
#SBATCH --array=43,45,48,50,53,55,58,60 # 20haps
##SBATCH --array=21-60%5
##SBATCH --time=00:30:00 # 20haps
#SBATCH --time=04:14:00
#SBATCH --error=ft_sim_1MNe_20_80_200S_1E_00_01_05_09d_05i_20Chr_15Mb_5rep.8left_anders.%A_%a.e.txt
#SBATCH --output=ft_sim_1MNe_20_80_200S_1E_00_01_05_09d_05i_20Chr_15Mb_5rep.8left_anders.%A_%a.o.txt
#SBATCH --job-name=8left_ft_1MNe_rep5_anders
