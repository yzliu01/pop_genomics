...
#SBATCH --error=ft_sim_1MNe_20_80_200S_2E_4e_10e_di_4_10_di_20Chr_15Mb_5rep.anders.%A_%a.e.txt
#SBATCH --output=ft_sim_1MNe_20_80_200S_2E_4e_10e_di_4_10_di_20Chr_15Mb_5rep.anders.%A_%a.o.txt
#SBATCH --job-name=anders_ft_1MNe_rep5_2E_4e_10e_di_4_10_di
