...
#SBATCH --error=ft_sim_1MNe_80_200hapS_1E_10_i_cons_20Chr_15Mb.anders.new.%A_%a.e
#SBATCH --output=ft_sim_1MNe_80_200hapS_1E_10_i_cons_20Chr_15Mb.anders.new.%A_%a.o
...
fsc27093 -i ../*.par -n 5 -c 0 -q -x -s 0 -m --foldedSFS -g -G -k 300000000
