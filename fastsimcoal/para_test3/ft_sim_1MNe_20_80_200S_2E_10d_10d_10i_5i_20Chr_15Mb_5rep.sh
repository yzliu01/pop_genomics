...
#SBATCH --time=3-01:14:00
#SBATCH --error=ft_sim_1MNe_20_80_200S_2E_10d_10d_10i_5i_20Chr_15Mb_5rep.%A_%a.e.txt
#SBATCH --output=ft_sim_1MNe_20_80_200S_2E_10d_10d_10i_5i_20Chr_15Mb_5rep.%A_%a.o.txt
#SBATCH --job-name=ft_1MNe_rep5_10d_10d_10i_5i_3
...
par=$(ls $par_folder/ft_sim_1000000Ne*2E_100_500G_10*20Chr_15Mb.par | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
