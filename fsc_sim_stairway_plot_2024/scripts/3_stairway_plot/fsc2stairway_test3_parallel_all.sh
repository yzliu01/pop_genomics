...
#SBATCH --error=swp_ft_sim_10000Ne_20_80_200hapS_1E_50G_00d_20Chr_15Mb_5rep_non_prun.parallel.%A.e.txt
#SBATCH --output=swp_ft_sim_10000Ne_20_80_200hapS_1E_50G_00d_20Chr_15Mb_5rep_non_prun.parallel.%A.o.txt
#SBATCH --job-name=swp_non_prun_test3_ft
...
run_blueprint_plot_sh=$(ls $blueprint_file_dir/ft_sim_10000Ne*20Chr_15Mb*.blueprint.sh | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
