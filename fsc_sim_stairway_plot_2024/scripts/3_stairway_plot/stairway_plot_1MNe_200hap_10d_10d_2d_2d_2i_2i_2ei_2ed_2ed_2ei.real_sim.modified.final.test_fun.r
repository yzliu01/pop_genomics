...
pdf(paste0("combined.1000000Ne_200hapS_5rep_10d_10d_2d_2d_2i_2i_2ei_2ed_2ed_2ei.rotated_x_lab_final.new.pdf"),width = 20, height = 12)
...
layout(matrix(c(1:28),nrow=1,ncol=7,byrow=T),width=c(rep(1,6)),height=c(1,1))
...
for (generation in c("100_500G")){
    ...
    for (event in c("2i_2i","2d_2d","10d_10d","2d_2i","2i_2d","2e_i_2e_d","2e_d_2e_i")){
        ...
        if (plot_name %in% c("1000000Ne_200hapS_2E_100_500G_2i_2i_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1000000Ne_200hapS_2E_100_500G_2d_2d_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1000000Ne_200hapS_2E_100_500G_10d_10d_20Chr_15Mb")){
            plot(1,1, type="n", xlim=c(1,1.0e6), ylim=c(1,9.0e5),log="x", xlab="Years ago", ylab="",xaxt='n',yaxt='n')
            #xlab="Years ago", ylab="Effective population size"
            title(line=2)
            axis(side=2, at=c(10000,50000,500000,800000),label=c(format(c(10000,50000,500000,800000),scientific=FALSE)))

        } else if (plot_name %in% c("1000000Ne_200hapS_2E_100_500G_2d_2i_20Chr_15Mb","1000000Ne_200hapS_2E_100_500G_2i_2d_20Chr_15Mb","1000000Ne_200hapS_2E_100_500G_2e_i_2e_d_20Chr_15Mb","1000000Ne_200hapS_2E_100_500G_2e_d_2e_i_20Chr_15Mb")){
        ...
        ## distance to x axis
        if (plot_name %in% c("1000000Ne_200hapS_2E_100_500G_2d_2d_20Chr_15Mb","1000000Ne_200hapS_2E_100_500G_10d_10d_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1000000Ne_200hapS_2E_100_500G_2i_2i_20Chr_15Mb")) {
