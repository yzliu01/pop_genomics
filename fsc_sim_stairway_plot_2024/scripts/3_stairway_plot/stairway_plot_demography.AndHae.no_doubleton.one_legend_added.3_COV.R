...
file_list_a <- c(             
                "AndHae_New_REF_AndHae.no_doubleton_sfs_234_1500x_sm_genic", 
                "AndHae_New_REF_AndHae.no_doubleton_sfs_390_1500x_sm_genic",
                "AndHae_New_REF_AndHae.no_doubleton_sfs_546_1500x_sm_genic",

                "AndHae_New_REF_AndFul.no_doubleton_sfs_234_1500x_sm_genic",
                "AndHae_New_REF_AndFul.no_doubleton_sfs_390_1500x_sm_genic",
                "AndHae_New_REF_AndFul.no_doubleton_sfs_546_1500x_sm_genic",

                "AndHae_New_REF_AndHat.no_doubleton_sfs_234_1500x_sm_genic",
                "AndHae_New_REF_AndHat.no_doubleton_sfs_390_1500x_sm_genic",
                "AndHae_New_REF_AndHat.no_doubleton_sfs_546_1500x_sm_genic",

                "AndHae_New_REF_BomPas.no_doubleton_sfs_234_1500x_sm_genic",
                "AndHae_New_REF_BomPas.no_doubleton_sfs_390_1500x_sm_genic",
                "AndHae_New_REF_BomPas.no_doubleton_sfs_546_1500x_sm_genic"
                )
...
p1_initial <- ggplot(data = data, aes(x = year)) +
    ...
    annotate(geom = "rect", xmin = 10, xmax = 15000, ymin = 1000, ymax = 300000, color = "black", linetype='dashed', linewidth = 0.5, alpha = 0.1) +
...
p1_zoom <- ggplot(data = data, aes(x = year)) +
    ...
    scale_y_continuous(limits = c(1000,400000), labels = function(Ne_median) format(Ne_median, scientific = FALSE))

p1_final <- p1_initial + 
    ## position of zoom plot
    annotation_custom(ggplotGrob(p1_zoom), xmin = 50000, xmax = 200000, ymin = 200000, ymax = 400000) +    
    ## position of annotation frame
    geom_rect(aes(xmin = 50000, xmax = 200000, ymin = 200000, ymax = 400000), color='black', linetype='dashed', linewidth=0.5, alpha=0) +
    ## conncetion line to one side of the frame [geom_rect]
    geom_path(  #[selected-annotation:left-right]
                data = data.frame(x = c(15000, 50000), y = c(300000, 400000)), aes(x = x, y = y),
...
pdf_file <- file.path(result_path,"AndHae_combined_added_plot.no_doubleton.pdf")
