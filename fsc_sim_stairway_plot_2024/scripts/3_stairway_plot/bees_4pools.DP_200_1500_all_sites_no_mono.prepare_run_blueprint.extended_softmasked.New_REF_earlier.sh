...
#SBATCH --error=bees_4pools.DP_200_1500_all_sites_no_mono.prepare_run_blueprint.extended_softmasked.New_REF_earlier.%A_%a.e.txt
#SBATCH --output=bees_4pools.DP_200_1500_all_sites_no_mono.prepare_run_blueprint.extended_softmasked.New_REF_earlier.%A_%a.o.txt
#SBATCH --job-name=bees_4pools.DP_200_1500_all_sites_no_mono.prepare_run_blueprint.extended_softmasked.New_REF_earlier
...
blueprint_file=`ls $blueprint_file_dir/*New_REF*200x.extended_softmasked.blueprint | sort -V`
...
run_blueprint_plot_sh=$(ls $blueprint_file_dir/*New_REF*200x.extended_softmasked.blueprint.sh | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
