...
for (generation in c("50G","100G","500G","1000G")){
    ...
    for (event in c("2e_d_cons","10e_d_cons","2e_i_cons")){
        ...
        } else if (plot_name %in% c("1MNe_20hapS_1E_50G_2e_i_cons_20Chr_15Mb","1MNe_20hapS_1E_100G_2e_i_cons_20Chr_15Mb","1MNe_20hapS_1E_500G_2e_i_cons_20Chr_15Mb","1MNe_20hapS_1E_1000G_2e_i_cons_20Chr_15Mb")) {
