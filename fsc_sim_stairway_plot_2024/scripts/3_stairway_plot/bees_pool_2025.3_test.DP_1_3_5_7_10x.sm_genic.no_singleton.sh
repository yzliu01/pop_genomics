...
##SBATCH --time=4:00:00
#SBATCH --error=bees_pool_2025.3_test.DP_1_3_5_7_10x.sm_genic.no_singleton.%A_%a.e
#SBATCH --output=bees_pool_2025.3_test.DP_1_3_5_7_10x.sm_genic.no_singleton.%A_%a.o
#SBATCH --job-name=bees_pool_2025.3_test.DP_1_3_5_7_10x.sm_genic.no_singleton
...
blueprint_file=`ls -t $blueprint_file_dir/*blueprint | sort -V`
...
run_blueprint_plot_sh=$(ls -t $blueprint_file_dir/*blueprint.sh | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
