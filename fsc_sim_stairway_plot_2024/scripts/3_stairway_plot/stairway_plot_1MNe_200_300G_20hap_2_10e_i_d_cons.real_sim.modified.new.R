...
pdf(paste0("combined.1MNe_200_300G_20hapS_5rep_2_10_i_d_cons.rotated_x_lab.pdf"),width = 20, height = 25)
...
#}
        ...
        if (plot_name %in% c("1MNe_20hapS_1E_200G_2e_d_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1MNe_20hapS_1E_300G_2e_d_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1MNe_20hapS_1E_300G_2e_i_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1MNe_20hapS_1E_200G_2e_i_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1MNe_20hapS_1E_300G_10e_d_cons_20Chr_15Mb")){
        ...
        ## distance to x axis
        if (plot_name %in% c("1MNe_20hapS_1E_50G_10e_i_cons_20Chr_15Mb","1MNe_20hapS_1E_100G_10e_i_cons_20Chr_15Mb","1MNe_20hapS_1E_500G_10e_i_cons_20Chr_15Mb","1MNe_20hapS_1E_1000G_10e_i_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1MNe_20hapS_1E_200G_2e_i_cons_20Chr_15Mb","1MNe_20hapS_1E_300G_2e_i_cons_20Chr_15Mb")) {
        ...
        mtext(side=3,text=paste0("1MNe_20hapS_1E_",generation,"_",event,"_20Chr_15Mb"),cex=0.8,line=1.2)
        ...
        for (rep in c(1:5)){
            ...
            assign(paste0("a",rep), read.table(mixedsort(sort(fs::dir_ls(path=paste0("./ft_sim_1000000Ne_20hapS_1E_",generation,"_",event,"_20Chr_15Mb_",rep), recurse = 1, fail=TRUE, type = "file", glob = "*20hapS*.final.summary"))),header=T,sep="\t"))
