...
file_list_b <- c(             
                "BomPas_REF_BomPas.no_singleton_204_1500x", 
                "BomPas_REF_BomPas.no_singleton_340_1500x",
                "BomPas_REF_BomPas.no_singleton_476_1500x",
                "BomPas_REF_BomHyp.no_singleton_204_1500x",
                "BomPas_REF_BomHyp.no_singleton_340_1500x",
                "BomPas_REF_BomHyp.no_singleton_476_1500x",
                "BomPas_REF_ApisMel.no_singleton_204_1500x",
                "BomPas_REF_ApisMel.no_singleton_340_1500x",
                "BomPas_REF_ApisMel.no_singleton_476_1500x"
                )
...
p1_initial <- ggplot(data = data, aes(x = year)) +
    ...
    annotate(geom = "rect",xmin = 1, xmax = 15000, ymin = 1000, ymax = 550000, color = "black", linetype='dashed', linewidth = 0.5, alpha = 0.1) +
    ...
    scale_x_continuous(lim= c(1,150000),labels = function(year) format(year, scientific = FALSE)) +
    scale_y_continuous(lim= c(1,650000),labels = function(Ne_median) format(Ne_median, scientific = FALSE))
    #ggtitle(group)
    #ylab(bquote(N[e]))
...
p1_final <- p1_initial + 
    ...
    annotation_custom(ggplotGrob(p1_zoom), xmin = 45000, xmax = 150000, ymin = 400000, ymax = 600000) +
    ## position of annotation frame
    geom_rect(aes(xmin = 45000, xmax = 150000, ymin = 400000, ymax = 600000), color='black', linetype='dashed', linewidth=0.5, alpha=0) +
...
pdf_file <- file.path(result_path,"BomPas_combined_plot.pdf")
