...
file_list_b <- c(      
                expression(paste(bold("Ref_species_1: "), bolditalic("A. marginata"), bold(" | Coverage: 240_1500x"))), 
                expression(paste(bold("Ref_species_1: "), bolditalic("A. marginata"), bold(" | Coverage: 400_1500x"))),
                expression(paste(bold("Ref_species_1: "), bolditalic("A. marginata"), bold(" | Coverage: 560_1500x"))),
                expression(paste(bold("Ref_species_2: "), bolditalic("A. hattorfiana"), bold(" | Coverage: 240_1500x"))),
                expression(paste(bold("Ref_species_2: "), bolditalic("A. hattorfiana"), bold(" | Coverage: 400_1500x"))),
                expression(paste(bold("Ref_species_2: "), bolditalic("A. hattorfiana"), bold(" | Coverage: 560_1500x"))),
                expression(paste(bold("Ref_species_3: "), bolditalic("A. haemorrhoa"), bold(" | Coverage: 240_1500x"))),
                expression(paste(bold("Ref_species_3: "), bolditalic("A. haemorrhoa"), bold(" | Coverage: 400_1500x"))),
                expression(paste(bold("Ref_species_3: "), bolditalic("A. haemorrhoa"), bold(" | Coverage: 560_1500x"))),
                expression(paste(bold("Ref_species_4: "), bolditalic("B. pascuorum"), bold(" | Coverage: 240_1500x"))),
                expression(paste(bold("Ref_species_4: "), bolditalic("B. pascuorum"), bold(" | Coverage: 400_1500x"))),
                expression(paste(bold("Ref_species_4: "), bolditalic("B. pascuorum"), bold(" | Coverage: 560_1500x")))
                )
...
p1_initial <- ggplot(data = data, aes(x = year)) +
    #xlim(1,150000)+
    #ylim(1,650000)+
    scale_x_continuous(limits= c(10,110000),labels = function(year) format(year, scientific = FALSE)) +
...
p1_zoom <- ggplot(data = data, aes(x = year)) +
    ...
    scale_y_continuous(limits = c(1000,90000), labels = function(Ne_median) format(Ne_median, scientific = FALSE))
...
pdf_file <- file.path(result_path,"AndMar_combined_plot.new.pdf")
