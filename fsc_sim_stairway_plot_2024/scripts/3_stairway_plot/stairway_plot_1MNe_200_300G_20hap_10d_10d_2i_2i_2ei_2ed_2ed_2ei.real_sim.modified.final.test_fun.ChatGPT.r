...
file_list0 <- fs::dir_ls(path=final_summary, recurse = 1, fail=TRUE, type = "file", glob = "*1MNe_20hapS_2E_100_200G_10d_10d_20Chr_15Mb*_1.final.summary")
...
pdf(paste0("combined.1MNe_2E_100_200G_20hapS_5rep_10d_10d_2i_2i_2ei_2ed_2ed_2ei.rotated_x_lab_final.test_fun.pdf"),width = 20, height = 25)
...
for (generation in c("100_200G")){
    ...
    for (event in c("10d_10d","2i_2i","2e_i_2e_d","2e_d_2e_i")){
        ...
        plot_name <- paste0("1MNe_20hapS_2E_",generation,"_",event,"_20Chr_15Mb")
        #print(plot_name)
...
#    }
#}   
        if (plot_name %in% c("1MNe_20hapS_2E_100_200G_10d_10d_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1MNe_20hapS_2E_100_200G_2i_2i_20Chr_15Mb")){
        ...
        if (plot_name %in% c("1MNe_20hapS_2E_100_200G_10d_10d_20Chr_15Mb")){
            ...
            #,"1MNe_20hapS_2E_100_200G_2e_i_2e_d_20Chr_15Mb","1MNe_20hapS_2E_100_200G_2e_d_2e_i_20Chr_15Mb"
        ...
        mtext(side=3,text=paste0("1MNe_20hapS_2E_",generation,"_",event,"_20Chr_15Mb"),cex=0.8,line=1.2)
        ...
        for (rep in c(1:5)){
            ...
            #print(class(data))
            print(str(data))
            #paste0("data_ft_sim_1MNe_20hapS_2E_",generation,"_",event,"_20Chr_15Mb")
...
#}
        ...
        x <- 0:100000
        #plot_name <- c("1MNe_20hapS_2E_1000G_1.1i_20Chr_15Mb","1MNe_20hapS_2E_1000G_1.5i_20Chr_15Mb","1MNe_20hapS_2E_1000G_1.9i_20Chr_15Mb","1MNe_20hapS_2E_1000G_0.5e_d_1.5i_20Chr_15Mb")
