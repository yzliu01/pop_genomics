...
ggplot(merged_data_new, aes(x = year, y = Ne_median, group = species, color = species)) +
  ...
  scale_color_manual(values = c("A.haemorrhoa" = "#01665e", "A.marginata" = "#542788", "B.pascuorum" = "#df812d", "B.veteranus" = "#b2182b")) +  # Custom colors for species
  scale_fill_manual(values = c("A.haemorrhoa" = "#01665e", "A.marginata" = "#542788", "B.pascuorum" = "#df812d", "B.veteranus" = "#b2182b")) +  # Custom fill colors
...
ggsave("/home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2/bee_pools_plot_new/plot_in_one_3x.no_doubleton-.pdf",width=6,height=6)
