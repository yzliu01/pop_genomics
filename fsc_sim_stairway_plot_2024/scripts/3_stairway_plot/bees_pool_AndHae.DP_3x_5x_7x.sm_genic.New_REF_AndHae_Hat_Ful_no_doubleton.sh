...
#SBATCH --error=bees_pool_AndHae.DP_3x_5x_7x.sm_genic.New_REF_AndHae_Hat_Ful.%A_%a.e
#SBATCH --output=bees_pool_AndHae.DP_3x_5x_7x.sm_genic.New_REF_AndHae_Hat_Ful.%A_%a.o
#SBATCH --job-name=bees_pool_AndHae.DP_3x_5x_7x.sm_genic.New_REF_AndHae_Hat_Ful
...
blueprint_file=`ls -t $blueprint_file_dir/AndHae_New_REF_*double*1500x*blueprint | head -9 | sort`
...
run_blueprint_plot_sh=$(ls -t $blueprint_file_dir/AndHae_New_REF_*double*1500x*blueprint.sh | head -9 | sort | sed -n ${SLURM_ARRAY_TASK_ID}p)
