...
file_list_a <- c(             
                ...
                "AndHae_REF_AndHae.DP_1x.P_10",
                "AndMar_REF_AndMar.DP_1x.P_10",
                "BomPas_REF_BomPas.DP_1x.P_10",
                "BomVet_REF_BomVet.DP_1x.P_10"
                )
...
file_path_hae <- fs::dir_ls(path=paste0(result_path,"/",file_list_a[1]), recurse = 2, fail=TRUE, type = "file", glob = "*1x.P_10.final.summary")
...
file_path_mar <- fs::dir_ls(path=paste0(result_path,"/",file_list_a[2]), recurse = 2, fail=TRUE, type = "file", glob = "*1x.P_10.final.summary")
...
file_path_pas <- fs::dir_ls(path=paste0(result_path,"/",file_list_a[3]), recurse = 2, fail=TRUE, type = "file", glob = "*1x.P_10.final.summary")
...
file_path_vet <- fs::dir_ls(path=paste0(result_path,"/",file_list_a[4]), recurse = 2, fail=TRUE, type = "file", glob = "*1x.P_10.final.summary")
...
combined_plot <- p3x_final + p5x_final + p7x_final + plot_layout(ncol = 3)
