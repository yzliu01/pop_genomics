...
sfs_20_80_200=sfs_Ne10000_hapS_20_80_200_5rep_05i_final.blueprint.txt
...
blueprint_file_list_5rep=sfs_Ne10000_hapS_20_80_200_5rep_05i_final.5rep_blueprint.file_name.list
...
stairway_dir=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2/stairway_plot_blueprint/10000Ne_5rep
...
for size in {20,80,200};do
    for bp_file in `grep "$size"hapS $blueprint_file_list_5rep`;do
        ...
        # ft_sim_10000Ne_80hapS_2E_100_500G_10d_10d_20Chr_15Mb_0.blueprint
        cat $stairway_dir/templates/ft_sim_10000Ne_"$size"hapS_2E_100_500G_10d_10d_20Chr_15Mb_0.blueprint > $stairway_dir/$bp_file
    done
done
...
sfs_FilePlotName_20_80_200=sfs_Ne10000_hapS_20_80_200_5rep_05i_final.blueprint.txt
## ft_sim_10000Ne_20hapS_1E_50G_00d_20Chr_15Mb_1
## ft_sim_10000Ne_20hapS_1E_50G_00d_20Chr_15Mb_2
