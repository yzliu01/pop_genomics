...
sfs_20_80_200=sfs_Ne100000_hapS_20_80_200_5rep_05i_final.blueprint.txt
...
blueprint_file_list_5rep=sfs_Ne100000_hapS_20_80_200_5rep_05i_final.5rep_blueprint.file_name.list
...
for size in {20,80,200};do
    for bp_file in `grep "$size"hapS $blueprint_file_list_5rep`;do
        ...
        # ft_sim_100000Ne_20hapS_1E_50G_cons_20Chr_15Mb_0.blueprint
        cat $stairway_dir/templates/ft_sim_100000Ne_"$size"hapS_1E_50G_cons_20Chr_15Mb_0.blueprint > $stairway_dir/$bp_file
    done
done
...
sfs_FilePlotName_20_80_200=sfs_Ne100000_hapS_20_80_200_5rep_05i_final.blueprint.txt
