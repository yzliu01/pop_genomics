...
par_list_new_5rep_blueprint=ft_sim_10K_100K_1MNe_20_80_200_200S_1E_00_01_05_09d_05i_20Chr_15Mb.new.5rep_blueprint.list
...
for par in `cat ft_sim_10K_100K_1MNe_20_80_200_200S_1E_00_01_05_09d_05i_20Chr_15Mb.new.list`;do
    for rep in {1..5};do
        echo "$par"_1_"$rep"_MSFS.blueprint >> $par_list_new_5rep_blueprint
...
## copy $ft_dir_5rep_blueprint_list to $stairway_dir
...
## put plueprint content into blueprint file
