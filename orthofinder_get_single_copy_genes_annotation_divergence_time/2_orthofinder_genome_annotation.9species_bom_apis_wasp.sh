...
#SBATCH --job-name=9bom_apis_wasp
#SBATCH --error=9bom_apis_wasp.%A.e
#SBATCH --output=9bom_apis_wasp.%A.o
...
work_dir=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/ref_genome/ref_annotation/primary_transcripts/new_transcript_id_9_bom_apis_wasp
