...
#SBATCH --job-name=orthofinder_15bee_species_outgroup
#SBATCH --error=orthofinder_15bee_species_outgroup.%A.e
#SBATCH --output=orthofinder_15bee_species_outgroup.%A.o
...
work_dir=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/ref_genome/ref_annotation/primary_transcripts/new_transcript_id
