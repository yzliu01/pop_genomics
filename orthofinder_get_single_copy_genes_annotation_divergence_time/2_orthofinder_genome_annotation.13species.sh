...
#SBATCH --job-name=orthofinder_13bee_species
#SBATCH --error=orthofinder_13bee_species.%A.e
#SBATCH --output=orthofinder_13bee_species.%A.o
...
work_dir=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/ref_genome/ref_annotation/primary_transcripts/new_transcript_id_13species
