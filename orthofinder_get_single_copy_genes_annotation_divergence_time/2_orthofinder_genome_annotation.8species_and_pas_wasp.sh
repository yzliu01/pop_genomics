...
#SBATCH --job-name=8and_pas_wasp
#SBATCH --error=8and_pas_wasp.%A.e
#SBATCH --output=8and_pas_wasp.%A.o
...
work_dir=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/ref_genome/ref_annotation/primary_transcripts/new_transcript_id_8_and_pas_wasp
