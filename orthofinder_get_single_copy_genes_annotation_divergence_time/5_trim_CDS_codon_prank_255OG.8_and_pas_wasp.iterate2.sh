...
#SBATCH --mem 10g
##SBATCH --array=1-1%60
#SBATCH --job-name=5_255OG_8_And_Pas_Wasp.iterate2
#SBATCH --error=5_255OG_8_And_Pas_Wasp.iterate2.%A.e
#SBATCH --output=5_255OG_8_And_Pas_Wasp.iterate2.%A.o
...
trimmed_stop_codon_concat=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/ref_genome/ref_annotation/primary_transcripts/extracted_cds_new/new_transcript_id_8_and_pas_wasp
...
for input_fa in $(ls OG*.cds.8_species.trimmed.trimmed_stop_codon.fa) # not finished
do
