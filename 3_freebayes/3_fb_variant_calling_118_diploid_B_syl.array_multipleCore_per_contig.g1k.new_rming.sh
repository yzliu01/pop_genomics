...
##SBATCH -p node
#SBATCH -n 12
#SBATCH --array=1,3,10,14,399
##SBATCH -C mem256GB
#SBATCH -t 4-24:00:00
#SBATCH -J FBDipArray_multipleCPU_g1k
#SBATCH --mail-type=all
#SBATCH --mail-user=yuanzhen.liu@imbim.uu.se
#SBATCH --error=fb_diploid_variant_calling_Bsyl.array_multipleCPU_g1k.rming.%A.e
#SBATCH --output=fb_diploid_variant_calling_Bsyl.array_multipleCPU_g1k.rming.%A.o
...
freebayes-parallel $REF_DIR/freebayes_syl_contig_region/$contig_region 12 \
--fasta-reference $REF --bam-list $SAMPLE -r $contig -g 1000 \
--ploidy 2 --strict-vcf --gvcf > $OUTDIR/freebayes_contig_g1k_old/fb_female_52mon_66lap.$contig.g.vcf
