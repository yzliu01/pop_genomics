...
#SBATCH --error=angsd_likelihood_sfs_bed.%A_%a.e
#SBATCH --output=angsd_likelihood_sfs_bed.%A_%a.o
#SBATCH --job-name=angsd_likelihood_sfs_bed
...
## -r file:regions.txt
angsd -bam <(echo $bam) -rf $REF_MASKED_DIR/$ref_bed -doSaf 1 -anc $REF_DIR/$ref -out "$SAF_OUT_DIR/$sfs_out".bed -GL 2 -P 40 -doMajorMinor 1 -minMapQ 1 -minQ 20

exit 0

#Obtain a maximum likelihood estimate of the SFS using EM algorithm
#realSFS "$SAF_OUT_DIR/$sfs_out".bed.saf.idx -maxIter 100 -P 20 >"$sfs_out".bed.sfs
