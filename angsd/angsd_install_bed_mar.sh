...
#SBATCH --error=angsd_likelihood_sfs_chr_mar.%A_%a.e
#SBATCH --output=angsd_likelihood_sfs_chr_mar.%A_%a.o
#SBATCH --job-name=angsd_likelihood_sfs_chr_mar
...
ref=Andrena_marginata_GCA_963932335.1-softmasked.fa
...
bam=Andmar.New_REF_AndMar.sort.marked_dups.bam
...
#realSFS "$SAF_OUT_DIR/$sfs_out".chr.saf.idx -maxIter 100 -P 20 >"$sfs_out".chr.sfs
...
sfs<-scan("Andmar.ENA|OZ010659|OZ010659.1.saf.idx")
barplot(sfs[-1])
