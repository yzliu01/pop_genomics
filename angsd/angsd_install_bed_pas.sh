...
#SBATCH --error=angsd_likelihood_sfs_chr_pas.%A_%a.e
#SBATCH --output=angsd_likelihood_sfs_chr_pas.%A_%a.o
#SBATCH --job-name=angsd_likelihood_sfs_chr_pas
...
ref=Bombus_pascuorum-GCA_905332965.1-softmasked.fa
...
bam=Bompas.New_REF_BomPas.sort.marked_dups.bam
