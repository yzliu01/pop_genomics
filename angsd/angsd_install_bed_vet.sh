...
#SBATCH --mem 50g
#SBATCH --array=1-742%742
##SBATCH --array=1-2%2
##SBATCH --time=00:10:00
#SBATCH --time=00:40:00
#SBATCH --error=angsd_likelihood_sfs_chr_vet.%A_%a.e
#SBATCH --output=angsd_likelihood_sfs_chr_vet.%A_%a.o
#SBATCH --job-name=angsd_likelihood_sfs_chr_vet
...
ref=Bombus_veteranus.hifi_asm_pl2.fa
...
bam=Bomvet.New_REF_BomVet.sort.marked_dups.bam
