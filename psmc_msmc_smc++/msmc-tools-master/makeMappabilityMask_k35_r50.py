...
with open("/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/ref_genome/SNPable/xx/rawMask_k35_r50.fa", "r") as f:
  for line in f:
    if line.startswith('>'):
      chr = line.split()[0][1:]
      mask = MaskGenerator("/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/ref_genome/SNPable/xx/ref_mappability.mask.bed.gz".format(chr), chr)
      pos = 0
      continue
    for c in line.strip():
      pos += 1
