...
bcftools mpileup -C 50 -f $ref_dir/$ref $input_dir/$in_bam | bcftools call -c | \
    vcfutils.pl vcf2fq -d 38 -D 232 | gzip > $in_bam.fq.gz
...
#[mpileup] maximum number of reads per input file set to -d 250
#sh: line 1: 1304236 Segmentation fault      (core dumped) psmc -N25 -t15 -r5 -b -p 4+25*2+4+6 -o round-1.AndMar_hifi_asm.aligned.bam.fq.split_100000.psmc AndMar_hifi_asm.aligned.bam.fq.split_100000.psmcfa
