...
#SBATCH --error=smc++.syl_35_90.mon3_lap3_inc3_sy3.ph_mu36_knot30.%A.e
#SBATCH --output=smc++.syl_35_90.mon3_lap3_inc3_sy3.ph_mu36_knot30.%A.o
...
smc++ estimate --cores 4 3.60e-9 --knots 30 $OUT/$INPUT_Results/$INPUT_Results.contig*.txt -o $OUT/$INPUT_Results
#--spline cubic
#--timepoints 1e1 1e7
...
smc++ plot -g 1 $OUT/syl_35_90.mon3_lap3_inc3_sy3.ph_CLH_36.knots38.pdf \
...
#	cd $results
##		for chr in {293,448,486,584};do
#	rename final final.mu36knot38 model.final.json
