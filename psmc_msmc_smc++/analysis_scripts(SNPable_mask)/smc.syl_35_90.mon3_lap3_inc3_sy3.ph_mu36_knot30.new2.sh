...
#SBATCH --error=smc++.syl_35_90.mon3_lap3_inc3_sy3.ph_mu36_knot30_new2.%A.e
#SBATCH --output=smc++.syl_35_90.mon3_lap3_inc3_sy3.ph_mu36_knot30_new2.%A.o
...
smc++ estimate --cores 4 3.60e-9 --timepoints 1e1 1e7 --knots 30 $OUT/$INPUT_Results/$INPUT_Results.contig*.txt -o $OUT/$INPUT_Results
#--spline cubic
#--timepoints 1e1 1e7
...
smc++ plot -g 1 $OUT/syl_35_90.mon3_lap3_inc3_sy3.ph_CLH_mu36.knots30.pdf \
...
#for results in {mon_3ind,lap_3ind,inc_3ind,syl_3ind}; do
	cd $results
##		for chr in {293,448,486,584};do
	rename final final.mu36knot30 model.final.json
##	rename mu36knot38json mu36knot40.json model.final.mu36knot38json
##		rename lap_3ind _lap_3ind  *contig_$chr*.txt; done
##		mv $results.contig_$chr*.txt _$results.contig_$chr*.txt
##		done
#	cd ..
