...
##SBATCH -C mem512GB
#SBATCH -t 00:30:00
#SBATCH -J msmc2.syl_35_90.mon2_lap2_inc2_syl2.new3
#SBATCH --mail-type=all
#SBATCH --mail-user=yuanzhen.liu2@gmail.com
#SBATCH --error=msmc2.syl_35_90.mon2_lap2_inc2_syl2.new3.%A.%a.e
#SBATCH --output=msmc2.syl_35_90.mon2_lap2_inc2_syl2.new3.%A.%a.o
...
time msmc -s -I 0-1,2-3 -o ./mon_6hap_out_prefix.new3 ./mon6_lap6_inc5_syl4.contig_*.multihetseq.txt
#,4-5,6,7,8,9,10,11
time msmc -s -I 12-13,14-15 -o ./lap_6hap_out_prefix.new3 ./mon6_lap6_inc5_syl4.contig_*.multihetseq.txt
#,16-17,18,19,20,21,22,23
time msmc -s -I 24-25,26-27 -o ./inc_6hap_out_prefix.new3 ./mon6_lap6_inc5_syl4.contig_*.multihetseq.txt
#,28-29,30,31,32,33
time msmc -s -I 34-35,36-37 -o ./syl_6hap_out_prefix.new3 ./mon6_lap6_inc5_syl4.contig_*.multihetseq.txt
#,38-39,40,41
...
#-o ./cross_3inc_3syl_36hap_out_prefix.new2 ./mon6_lap6_inc5_syl4.contig_*.multihetseq.txt
...
# -o ./cross_lap_syl_8hap_out_prefix.new ./mon6_lap6_inc5_syl4.contig_*.multihetseq.txt
