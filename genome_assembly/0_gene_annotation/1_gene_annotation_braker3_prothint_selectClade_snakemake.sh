...
example_data=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/population_genomics/0_gene_annotation/example_data
...
## fasta header names are the first string, before the space
## ENA|OZ010659|OZ010659.1
REF_DIR=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/ref_genome
less $REF_DIR/Andrena_marginata_GCA_963932335.1-softmasked.fa.fai
less $REF_DIR/Andrena_marginata_GCA_963932335.1-softmasked.fa | sed 's/\ Andrena.*//' > $REF_DIR/Andrena_marginata_GCA_963932335.1-softmasked.simple_header.fa
sed 's/|/_/g' $REF_DIR/Andrena_marginata_GCA_963932335.1-softmasked.simple_header.fa > $REF_DIR/Andrena_marginata_GCA_963932335.1-softmasked.simple_header_new.fa
e.g., ENA|OZ010659|OZ010659.1	--->  ENA_OZ010659_OZ010659.1 (working with this form)

## Bombus confusus
cd $REF_DIR
less Bombus_confusus-GCA_014737475.1_ASM1473747v1-softmasked.fa | sed 's/\ Bombus.*//' > Bombus_confusus-GCA_014737475.1_ASM1473747v1-softmasked.simple_header.fa
...
output_dir_AndBic=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/gene_annotation/prothint_results_AndBic
output_dir_BomCon=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/gene_annotation/prothint_results_BomCon
...
output_dir_BomVet_hymenoptera=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/gene_annotation/prothint_results_BomVet_hymenoptera
output_dir_softmask_BomVet_hymenoptera=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/gene_annotation/prothint_results_softmask_BomVet_hymenoptera
...
time $prothint_py $Bombus_confusus_softmask_genome $Apodiea_gene_AA --workdir $output_dir_BomCon

time $prothint_py $Andrena_bicolor_softmask_genome $Apodiea_gene_AA --workdir $output_dir_AndBic

## self_annotated genomw
#time $prothint_py $Bombus_veteranus_softmask_genome $Apodiea_gene_AA --workdir $output_dir_BomVet
time $prothint_py $Bombus_veteranus_softmask_genome $Apodiea_gene_AA --workdir $output_dir_softmask_BomVet

## Hymenoptera_gene_AA
#time $prothint_py $Bombus_veteranus_softmask_genome $Hymenoptera_gene_AA --workdir $output_dir_BomVet_hymenoptera
time $prothint_py $Bombus_veteranus_softmask_genome $Hymenoptera_gene_AA --workdir $output_dir_softmask_BomVet_hymenoptera
...
$selectClade_py --species species.tab raw.fasta levels.tab level2species.tab Hymenoptera > Hymenoptera_gene_AA.fa
