...
#SBATCH --error=2_gene_annotation_repeat_softmask_Bombus_veteranus_run_2
#SBATCH --output=2_gene_annotation_repeat_softmask_Bombus_veteranus_run_2
#SBATCH --job-name=2_gene_annotation_repeat_softmask_Bombus_veteranus_run_2
