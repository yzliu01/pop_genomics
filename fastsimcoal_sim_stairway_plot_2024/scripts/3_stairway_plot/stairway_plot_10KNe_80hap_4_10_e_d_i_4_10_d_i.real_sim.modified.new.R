...
## check the files
# mixedsort(sort(fs::dir_ls(path=".", recurse = 1, fail=TRUE, type = "file", glob = "*G_*4e_d_4i*80hapS*.final.summary")))

pdf(paste0("combined.10000Ne_80hapS_5rep_4_10_e_d_i_4_10_d_i_non_pruned.rotated_x_lab.pdf"),width = 20, height = 25)
...
for (generation in c("50G","100G","500G","1000G")){
    ...
    for (event in c("4e_d_4i","10e_d_10i","4e_i_4d","10e_i_10d")){
        ...
        if (plot_name %in% c("10000Ne_80hapS_2E_50G_4e_d_4i_20Chr_15Mb", "10000Ne_80hapS_2E_100G_4e_d_4i_20Chr_15Mb", "10000Ne_80hapS_2E_500G_4e_d_4i_20Chr_15Mb")){
            plot(1,1, type="n", xlim=c(1,5e5), ylim=c(1,1.5e4),log="x", xlab="", ylab="Effective population size",xaxt='n',yaxt='n')
            #log="xy",xlab="Years ago", ylab="Effective population size"
            title(line=2)
        } else if (plot_name %in% c("10000Ne_80hapS_2E_1000G_4e_d_4i_20Chr_15Mb")){
            ...
            title(line=2)
        } else if (plot_name %in% c("10000Ne_80hapS_2E_1000G_10e_d_10i_20Chr_15Mb","10000Ne_80hapS_2E_1000G_4e_i_4d_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("10000Ne_80hapS_2E_50G_10e_i_10d_20Chr_15Mb","10000Ne_80hapS_2E_100G_10e_i_10d_20Chr_15Mb","10000Ne_80hapS_2E_500G_10e_i_10d_20Chr_15Mb")){
            plot(1,1, type="n", xlim=c(1,5e6), ylim=c(1,5.5e4),log="x", xlab="", ylab="",xaxt='n',yaxt='n')
            #xlab="Years ago", ylab="Effective population size"
            title(line=2)
        } else if (plot_name %in% c("10000Ne_80hapS_2E_1000G_10e_i_10d_20Chr_15Mb")){
        ...
        #10000Ne_80hapS_2E_50G_10e_i_10d_20Chr_15Mb
        if (plot_name %in% c("10000Ne_80hapS_2E_50G_10e_i_10d_20Chr_15Mb","10000Ne_80hapS_2E_100G_10e_i_10d_20Chr_15Mb","10000Ne_80hapS_2E_500G_10e_i_10d_20Chr_15Mb","10000Ne_80hapS_2E_1000G_10e_i_10d_20Chr_15Mb")){
