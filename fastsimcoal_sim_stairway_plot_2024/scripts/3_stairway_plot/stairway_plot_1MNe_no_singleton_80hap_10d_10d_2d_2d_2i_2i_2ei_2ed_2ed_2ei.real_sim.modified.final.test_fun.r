...
pdf(paste0("combined.1MNe_no_singleton_80hapS_5rep_10d_10d_2d_2d_2i_2i_2ei_2ed_2ed_2ei.rotated_x_lab_final.new.pdf"),width = 20, height = 12)
...
for (generation in c("100_500G")){
    ...
    for (event in c("2i_2i","2d_2d","10d_10d","2d_2i","2i_2d","2e_i_2e_d","2e_d_2e_i")){
        ...
        plot_name <- paste0("1MNe_80hapS_2E_",generation,"_",event,"_20Chr_15Mb")
        #print(plot_name)
        ## print names with newline 
        cat("\n",plot_name,"\n\n")
        
        if (plot_name %in% c("1MNe_80hapS_2E_100_500G_2i_2i_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1MNe_80hapS_2E_100_500G_2d_2d_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1MNe_80hapS_2E_100_500G_10d_10d_20Chr_15Mb")){
            plot(1,1, type="n", xlim=c(1,1.0e6), ylim=c(1,9.0e5),log="x", xlab="Years ago", ylab="",xaxt='n',yaxt='n')
            #xlab="Years ago", ylab="Effective population size"
            title(line=2)
            axis(side=2, at=c(10000,50000,500000,800000),label=c(format(c(10000,50000,500000,800000),scientific=FALSE)))

        } else if (plot_name %in% c("1MNe_80hapS_2E_100_500G_2d_2i_20Chr_15Mb","1MNe_80hapS_2E_100_500G_2i_2d_20Chr_15Mb","1MNe_80hapS_2E_100_500G_2e_i_2e_d_20Chr_15Mb","1MNe_80hapS_2E_100_500G_2e_d_2e_i_20Chr_15Mb")){
        ...
        ## distance to x axis
        if (plot_name %in% c("1MNe_80hapS_2E_100_500G_2d_2d_20Chr_15Mb","1MNe_80hapS_2E_100_500G_10d_10d_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1MNe_80hapS_2E_100_500G_2i_2i_20Chr_15Mb")) {
            ...
            #,"1MNe_80hapS_2E_100_500G_2e_i_2e_d_20Chr_15Mb","1MNe_80hapS_2E_100_500G_2e_d_2e_i_20Chr_15Mb"
        ...
        mtext(side=3,text=paste0("1MNe_80hapS_2E_",generation,"_",event,"_20Chr_15Mb"),cex=0.8,line=1.2)
        ...
        for (rep in c(1:5)){
            ...
            assign(paste0("a",rep), read.table(mixedsort(sort(fs::dir_ls(path=paste0("./ft_sim_1MNe_no_singleton_80hapS_2E_",generation,"_",event,"_20Chr_15Mb_",rep), recurse = 1, fail=TRUE, type = "file", glob = "*80hapS*.final.summary"))),header=T,sep="\t"))
            #print(head(get(paste0("a",rep)),n=2L))
            #paste0("data_ft_sim_1MNe_no_singleton_80hapS_2E_",generation,"_",event,"_20Chr_15Mb")
        ...
        x <- 0:100000
        #plot_name <- c("1MNe_80hapS_2E_1000G_1.1i_20Chr_15Mb","1MNe_80hapS_2E_1000G_1.5i_20Chr_15Mb","1MNe_80hapS_2E_1000G_1.9i_20Chr_15Mb","1MNe_80hapS_2E_1000G_0.5e_d_1.5i_20Chr_15Mb")
