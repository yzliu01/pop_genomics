...
#SBATCH --array=41-60%20
#SBATCH --time=26:00:00
#SBATCH --error=fsc2stairway_1MNe_no_singleton_80_200hapS_1E_10_e_i_cons.%A_%a.e
#SBATCH --output=fsc2stairway_1MNe_no_singleton_80_200hapS_1E_10_e_i_cons.%A_%a.o
#SBATCH --job-name=fsc2stairway_1MNe_no_singleton_80_200hapS_1E_10_e_i_cons
...
run_80_200hapS_blueprint_plot_sh=`cat <(ls $blueprint_dir/ft_sim_1000000Ne_no_singleton_80hapS_1E*10e_i_cons_20Chr_15Mb_*.blueprint.sh) <(ls $blueprint_dir/ft_sim_1000000Ne_no_singleton_200hapS_1E*10e_i_cons_20Chr_15Mb_*.blueprint.sh) | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p`
...
file_list_80_200hapS=$( cat <(ls $blueprint_dir/ft_sim_1000000Ne_no_singleton_80hapS_1E*10e_i_cons_20Chr_15Mb_*.blueprint) <(ls $blueprint_dir/ft_sim_1000000Ne_no_singleton_200hapS_1E*10e_i_cons_20Chr_15Mb_*.blueprint) )
#blueprint_file=`echo $file_list_80_200hapS | tr " " "\n"`

#for file in `echo $file_list_80_200hapS | tr " " "\n"`
#    do
#    echo $file
#done
