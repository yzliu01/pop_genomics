...
pdf(paste0("combined.10000Ne_no_singleton_80hapS_5rep_2_10_i_d_cons_non_pruned.rotated_x_lab.pdf"),width = 12, height = 12)
#pdf(paste0("combined.10000Ne_no_singleton_80hapS_5rep_non_pruned.real_sim.rotated_x_lab-.pdf"),width = 20, height = 25)
...
for (generation in c("50G","100G","500G","1000G")){
    ...
    for (event in c("2e_d_cons","10e_d_cons","2e_i_cons","10e_i_cons")){
        ...
        } else if (plot_name %in% c("10000Ne_80hapS_1E_50G_2e_i_cons_20Chr_15Mb","10000Ne_80hapS_1E_100G_2e_i_cons_20Chr_15Mb","10000Ne_80hapS_1E_500G_2e_i_cons_20Chr_15Mb","10000Ne_80hapS_1E_1000G_2e_i_cons_20Chr_15Mb")) {
