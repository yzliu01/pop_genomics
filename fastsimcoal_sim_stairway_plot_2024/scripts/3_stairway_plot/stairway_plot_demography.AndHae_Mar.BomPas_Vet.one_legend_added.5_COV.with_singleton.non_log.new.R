...
file_list_a <- c(     
                #1x
                "AndHae_REF_AndHae.with_singleton.DP_5x.P_10",
                "AndMar_REF_AndMar.with_singleton.DP_5x.P_10",
                "BomPas_REF_BomPas.with_singleton.DP_5x.P_10",
                "BomVet_REF_BomVet.with_singleton.DP_5x.P_10"
...
# Save the plot
ggsave("plot_all_5x.with_singleton.tick_xy_log.pdf", p5x_final, width = 10, height = 8)
