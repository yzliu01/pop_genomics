...
combined_plot_95CI_with_singleton <- wrap_plots(plot_list, nrow = 3)
...
# Save to PDF
ggsave(filename = "./combined_plot_40S_50_1000G_01_05_09d_5_replicates_with_75CI_with_singleton.no_log.new.pdf",
