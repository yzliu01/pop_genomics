...
pdf(paste0("combined.1MNe_no_singleton_100S_5rep_05i_non_pruned.new.pdf"),width = 12, height = 12)
#pdf(paste0("combined.1MNe_no_singleton_100S_5rep_non_pruned.real_sim.rotated_x_lab-.pdf"),width = 20, height = 25)
...
for (generation in c("50G","100G","500G","1000G")){
    ...
    for (event in c("05i")){
        ...
        plot_name <- paste0("1MNe_100S_1E_",generation,"_",event,"_20Chr_15Mb")
        #print(plot_name)
        ## print names with newline 
        cat("\n",plot_name,"\n\n")
        
        if (plot_name %in% c("1MNe_100S_1E_50G_cons_20Chr_15Mb", "1MNe_100S_1E_100G_cons_20Chr_15Mb", "1MNe_100S_1E_500G_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1MNe_100S_1E_1000G_cons_20Chr_15Mb")){
            ...
            text(x=c(50,100,500,1000,10000,100000),labels = c(format(lablist.x,scientific=FALSE)),par("usr")[3] - 1000,srt = 45,pos = 3, xpd = TRUE)
## extra 05i
        } else if (plot_name %in% c("1MNe_100S_1E_50G_05i_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1MNe_100S_1E_100G_05i_20Chr_15Mb","1MNe_100S_1E_500G_05i_20Chr_15Mb","1MNe_100S_1E_1000G_05i_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1MNe_100S_1E_50G_1.1i_20Chr_15Mb","1MNe_100S_1E_100G_1.1i_20Chr_15Mb","1MNe_100S_1E_500G_1.1i_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1MNe_100S_1E_1000G_1.1i_20Chr_15Mb","1MNe_100S_1E_1000G_1.5i_20Chr_15Mb","1MNe_100S_1E_1000G_1.9i_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1MNe_100S_1E_50G_1.5i_20Chr_15Mb","1MNe_100S_1E_100G_1.5i_20Chr_15Mb","1MNe_100S_1E_500G_1.5i_20Chr_15Mb",
                                    "1MNe_100S_1E_50G_1.9i_20Chr_15Mb","1MNe_100S_1E_100G_1.9i_20Chr_15Mb","1MNe_100S_1E_500G_1.9i_20Chr_15Mb")){
            plot(1,1, type="n", xlim=c(1,5e6), ylim=c(30000,1.0e5),log="x", cex.axis = 0.8, xlab="", ylab="",xaxt='n',yaxt='n')
            #xlab="Generations ago", ylab="Effective population size"
            title(line=2)
            axis(side=2, at=c(500000,750000,1000000),label=c(format(c(500000,750000,1000000),scientific=FALSE)))
        ...
        mtext(side=3,text=paste0("1MNe_100S_1E_",generation,"_",event),cex=0.8,line=1.2)
        ...
        for (rep in c(1:5)){
            ...
            #paste0("data_ft_sim_1MNe_100S_1E_",generation,"_",event,"_20Chr_15Mb")
        ...
        x <- 0:100000
        #plot_name <- c("1MNe_100S_1E_1000G_1.1i_20Chr_15Mb","1MNe_100S_1E_1000G_1.5i_20Chr_15Mb","1MNe_100S_1E_1000G_1.9i_20Chr_15Mb","1MNe_100S_1E_1000G_0.5e_d_1.5i_20Chr_15Mb")
        fx <- function(x) {
