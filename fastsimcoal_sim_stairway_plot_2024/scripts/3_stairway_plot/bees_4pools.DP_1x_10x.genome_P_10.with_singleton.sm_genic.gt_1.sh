...
#SBATCH --error=bees_4pools.DP_1x_10x.genome_P_10.with_singleton.sm_genic.gt_1.%A_%a.e
#SBATCH --output=bees_4pools.DP_1x_10x.genome_P_10.with_singleton.sm_genic.gt_1.%A_%a.o
#SBATCH --job-name=bees_4pools.DP_1x_10x.genome_P_10.with_singleton.sm_genic.gt_1
...
## linear
#blueprint_file_dir=./stairway_plot_blueprint/pool_downsample_genome
## shuf
blueprint_file_dir=./stairway_plot_blueprint/pool_shuf_downsample_genome
## check declining PasVet first
blueprint_file=`ls -t $blueprint_file_dir/*DP_{1x,10x}.P_10.with_singleton.blueprint | head -8 | sort -V`
...
## shuf genome
#blueprint_file=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2/stairway_plot_blueprint/pool_shuf_downsample_genome/AndMar_REF_AndMar.DP_10x.P_05.blueprint
#blueprint_file=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2/stairway_plot_blueprint/pool_shuf_downsample_genome/AndMar_REF_AndMar.DP_10x.P_01.blueprint
create_batch_files(){
...
run_blueprint_plot_sh=$(ls -t $blueprint_file_dir/*DP_{1x,10x}.P_10.with_singleton.blueprint.sh | head -8 | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
