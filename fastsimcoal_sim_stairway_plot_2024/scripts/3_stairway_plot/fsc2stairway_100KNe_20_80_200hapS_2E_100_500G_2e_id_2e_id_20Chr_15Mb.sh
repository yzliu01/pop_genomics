...
#SBATCH --error=fsc2stairway_100KNe_20_80_200hapS_2E_100_500G_2e_id_2e_id_20Chr_15Mb.%A_%a.e
#SBATCH --output=fsc2stairway_100KNe_20_80_200hapS_2E_100_500G_2e_id_2e_id_20Chr_15Mb.%A_%a.o
#SBATCH --job-name=fsc2stairway_100KNe_20_80_200hapS_2E_100_500G_2e_id_2e_id
...
blueprint_plot_sh=`ls -t $blueprint_dir/ft_sim_100000Ne*2E_100_500G_*.blueprint.sh | grep -E 'md_' | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p`
...
blueprint_file=`ls -t $blueprint_dir/ft_sim_100000Ne*2E_100_500G_*.blueprint | grep -E 'md_' | sort -V`
