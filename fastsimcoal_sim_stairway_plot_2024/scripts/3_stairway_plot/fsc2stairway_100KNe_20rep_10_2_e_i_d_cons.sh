...
#SBATCH --error=fsc2stairway_100kNe_20rep_20_80_200hapS_1E_10_2_e_i_d_cons.%A_%a.e
#SBATCH --output=fsc2stairway_100kNe_20rep_20_80_200hapS_1E_10_2_e_i_d_cons.%A_%a.o
#SBATCH --job-name=fsc2stairway_100kNe_20rep_20_80_200hapS_1E_10_2_e_i_d_cons
...
blueprint_file=`ls $blueprint_dir/ft_sim_100000Ne*e_[id]_cons_20Chr_15Mb_*.blueprint`
...
create_batch_files &> ./systematic_ft_non_pruned/100KNe_20rep/error/fsc2stairway_100KNe_20rep_10_2_e_i_d_cons.error.new.txt
