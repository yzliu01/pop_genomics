...
events <- c(
  "50G_05i", "100G_05i", "500G_05i", "1000G_05i"
)
n_reps <- 5
...
x_limits_list <- list(
  "50G_05i"   = c(1, 1000000),
  "100G_05i"   = c(1, 1000000),
  "500G_05i"   = c(1, 1000000),
  "1000G_05i"   = c(1, 1000000)
)
    ...
    for (event in events) {
      ...
      p <- ggplot() +
        ...
        theme(
          ...
          legend.position = if (event == "50G_05i" && singleton == "_") c(0.3, 0.8) else "none",
...
ggsave("500kNe_05i_20_80_200S.new1.pdf", final_plot, width = 10, height = 13.5, limitsize = FALSE) # 9 * 2 rows
