...
p1_initial <- ggplot(merged_data_new, aes(x = year, y = Ne_median, group = species, color = species)) +
  ...
  annotate(geom = "rect", xmin = 10, xmax = 25000, ymin = 1000, ymax = 500000, 
...
# Save the plot
ggsave("with_singleton_non_log_plot_all_7x.pdf", p7x_final, width = 10, height = 8)
...
pdf_file <- file.path(result_path,"with_singleton_all_combined_3_5_7x.pdf")
