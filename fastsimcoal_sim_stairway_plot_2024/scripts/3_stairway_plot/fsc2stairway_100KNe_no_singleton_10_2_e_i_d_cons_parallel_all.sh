...
run_blueprint_plot_sh=$(ls $blueprint_dir/ft_sim_1000000Ne*10e_i_cons_20Chr_15Mb_*.blueprint.sh $blueprint_dir/ft_sim_1000000Ne_80hapS_1E_50G_1.1i_20Chr_15Mb_2.blueprint.sh | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
...
blueprint_file=`ls $blueprint_dir/ft_sim_1000000Ne*10e_i_cons_20Chr_15Mb_*.blueprint $blueprint_dir/ft_sim_1000000Ne_80hapS_1E_50G_1.1i_20Chr_15Mb_2.blueprint | sort -V`
