...
pdf(paste0("combined.1MNe_no_singleton_20hapS_5rep_2_10_i_d_cons.rotated_x_lab.pdf"),width = 12, height = 12)
...
for (generation in c("50G","100G","500G","1000G")){
    ...
    for (event in c("2e_d_cons","10e_d_cons","2e_i_cons","10e_i_cons")){
        ...
        if (plot_name %in% c("1MNe_no_singleton_20hapS_1E_50G_2e_d_cons_20Chr_15Mb", "1MNe_no_singleton_20hapS_1E_100G_2e_d_cons_20Chr_15Mb", "1MNe_no_singleton_20hapS_1E_500G_2e_d_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1MNe_no_singleton_20hapS_1E_1000G_2e_d_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1MNe_no_singleton_20hapS_1E_1000G_2e_i_cons_20Chr_15Mb")){
            plot(1,1, type="n", xlim=c(1,5e6), ylim=c(1,2e6),log="x", xlab="Generations ago", ylab="",xaxt='n',yaxt='n')
            #xlab="Generations ago", ylab="Effective population size"
            title(line=2)
            axis(side=2, at=c(50000,250000,500000,2000000),label=c(format(c(50000,250000,500000,2000000),scientific=FALSE)))

        } else if (plot_name %in% c("1MNe_no_singleton_20hapS_1E_50G_2e_i_cons_20Chr_15Mb","1MNe_no_singleton_20hapS_1E_100G_2e_i_cons_20Chr_15Mb","1MNe_no_singleton_20hapS_1E_500G_2e_i_cons_20Chr_15Mb")){
            plot(1,1, type="n", xlim=c(1,5e6), ylim=c(1,2e6),log="x", xlab="", ylab="",xaxt='n',yaxt='n')
            #xlab="Generations ago", ylab="Effective population size"
            title(line=2)
            axis(side=2, at=c(50000,250000,500000,2000000),label=c(format(c(50000,250000,500000,2000000),scientific=FALSE)))

        } else if (plot_name %in% c("1MNe_no_singleton_20hapS_1E_50G_10e_i_cons_20Chr_15Mb","1MNe_no_singleton_20hapS_1E_100G_10e_i_cons_20Chr_15Mb","1MNe_no_singleton_20hapS_1E_500G_10e_i_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1MNe_no_singleton_20hapS_1E_1000G_10e_i_cons_20Chr_15Mb")){
            plot(1,1, type="n", xlim=c(1,5e6), ylim=c(1,5e6),log="x", xlab="Generations ago", ylab="",xaxt='n',yaxt='n')
            #xlab="Generations ago", ylab="Effective population size"
            title(line=2)
            axis(side=2, at=c(500000,3000000,5000000),label=c(format(c(500000,3000000,5000000),scientific=FALSE)))

        } else if (plot_name %in% c("1MNe_no_singleton_20hapS_1E_1000G_10e_d_cons_20Chr_15Mb")){
            plot(1,1, type="n", xlim=c(1,5e6), ylim=c(1,2e6),log="x", xlab="Generations ago", ylab="",xaxt='n',yaxt='n')
            #xlab="Generations ago", ylab="Effective population size"
            title(line=2)
            axis(side=2, at=c(50000,250000,500000,2000000),label=c(format(c(50000,250000,500000,2000000),scientific=FALSE)))
        ...
        ## distance to x axis
        if (plot_name %in% c("1MNe_no_singleton_20hapS_1E_50G_10e_i_cons_20Chr_15Mb","1MNe_no_singleton_20hapS_1E_100G_10e_i_cons_20Chr_15Mb","1MNe_no_singleton_20hapS_1E_500G_10e_i_cons_20Chr_15Mb","1MNe_no_singleton_20hapS_1E_1000G_10e_i_cons_20Chr_15Mb")){
            text(x=c(50,100,500,1000,10000,100000),labels = c(format(lablist.x,scientific=FALSE)),par("usr")[3] - 710000,srt = 45,pos = 3, xpd = TRUE)
        } else if (plot_name %in% c("1MNe_no_singleton_20hapS_1E_50G_2e_i_cons_20Chr_15Mb","1MNe_no_singleton_20hapS_1E_100G_2e_i_cons_20Chr_15Mb","1MNe_no_singleton_20hapS_1E_500G_2e_i_cons_20Chr_15Mb","1MNe_no_singleton_20hapS_1E_1000G_2e_i_cons_20Chr_15Mb")) {
