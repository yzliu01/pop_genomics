...
pdf(paste0("combined.50000Ne_40S_5rep_cons_1_1i_1_5i_1_9i_non_pruned.test_log_0.pdf"),width = 12, height = 12)
...
for (generation in c("50G","100G","500G","1000G")){
    ...
    for (event in c("cons","1.1i","1.5i","1.9i")){
        ...
        for (rep in c(1:5)){
            ...
            #data_sub <- data_tmp[data_tmp$year >= 1, ]  # filter x ≥ 10
            data_sub <- data_tmp[data_tmp$year >= 0, ]  # filter x ≥ 10
