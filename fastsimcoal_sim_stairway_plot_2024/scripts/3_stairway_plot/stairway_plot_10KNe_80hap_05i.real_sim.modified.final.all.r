...
pdf(paste0("combined.5000Ne_40S_5rep_05i_non_pruned.new.pdf"),width = 12, height = 12)
#pdf(paste0("combined.5000Ne_40S_5rep_non_pruned.real_sim.rotated_x_lab-.pdf"),width = 20, height = 25)
