...
#mixedsort(sort(fs::dir_ls(path=final_summary, recurse = 1, fail=TRUE, type = "file", glob = "*G_*e_*_cons*80hapS*15Mb_*.final.summary")))
...
pdf(paste0("combined.1MNe_no_singleton_200_300G_80hapS_5rep_2_10_i_d_cons.rotated_x_lab.pdf"),width = 20, height = 25)
#pdf(paste0("combined.1000000Ne_80hapS_5rep_non_pruned.real_sim.rotated_x_lab-.pdf"),width = 20, height = 25)
...
for (generation in c("200G","300G")){
    ...
    for (event in c("2e_d_cons","10e_d_cons","2e_i_cons")){
        ...
        plot_name <- paste0("1MNe_80hapS_no_singleton_1E_",generation,"_",event,"_20Chr_15Mb")
        #print(plot_name)
...
#}
        ...
        if (plot_name %in% c("1MNe_80hapS_no_singleton_1E_200G_2e_d_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1MNe_80hapS_no_singleton_1E_300G_2e_d_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1MNe_80hapS_no_singleton_1E_300G_2e_i_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1MNe_80hapS_no_singleton_1E_200G_2e_i_cons_20Chr_15Mb")){
            plot(1,1, type="n", xlim=c(1,5e6), ylim=c(1,1.2e6),log="x", xlab="", ylab="",xaxt='n',yaxt='n')
            #xlab="Years ago", ylab="Effective population size"
            title(line=2)
            axis(side=2, at=c(150000,250000,500000,750000,1000000,1200000),label=c(format(c(150000,250000,500000,750000,1000000,1200000),scientific=FALSE)))

        } else if (plot_name %in% c("1MNe_80hapS_no_singleton_1E_50G_10e_i_cons_20Chr_15Mb","1MNe_80hapS_no_singleton_1E_100G_10e_i_cons_20Chr_15Mb","1MNe_80hapS_no_singleton_1E_500G_10e_i_cons_20Chr_15Mb")){
            ...
            #xlab="Years ago", ylab="Effective population size"
            title(line=2)
            axis(side=2, at=c(200000,500000,1000000,2000000,3000000,4000000,5000000),label=c(format(c(200000,500000,1000000,2000000,3000000,4000000,5000000),scientific=FALSE)))

        } else if (plot_name %in% c("1MNe_80hapS_no_singleton_1E_1000G_10e_i_cons_20Chr_15Mb")){
            plot(1,1, type="n", xlim=c(1,5e6), ylim=c(1,5.2e6),log="x", xlab="Years ago", ylab="",xaxt='n',yaxt='n')
            #xlab="Years ago", ylab="Effective population size"
            title(line=2)
            axis(side=2, at=c(200000,500000,1000000,2000000,3000000,4000000,5000000),label=c(format(c(200000,500000,1000000,2000000,3000000,4000000,5000000),scientific=FALSE)))

        } else if (plot_name %in% c("1MNe_80hapS_no_singleton_1E_300G_10e_d_cons_20Chr_15Mb")){
        ...
        ## distance to x axis
        if (plot_name %in% c("1MNe_80hapS_no_singleton_1E_50G_10e_i_cons_20Chr_15Mb","1MNe_80hapS_no_singleton_1E_100G_10e_i_cons_20Chr_15Mb","1MNe_80hapS_no_singleton_1E_500G_10e_i_cons_20Chr_15Mb","1MNe_80hapS_no_singleton_1E_1000G_10e_i_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1MNe_80hapS_no_singleton_1E_200G_2e_i_cons_20Chr_15Mb","1MNe_80hapS_no_singleton_1E_300G_2e_i_cons_20Chr_15Mb")) {
        ...
        mtext(side=3,text=paste0("1MNe_no_singleton_80hapS_1E_",generation,"_",event,"_20Chr_15Mb"),cex=0.8,line=1.2)
        ...
        for (rep in c(1:5)){
            ...
            assign(paste0("a",rep), read.table(mixedsort(sort(fs::dir_ls(path=paste0("./ft_sim_1000000Ne_no_singleton_80hapS_1E_",generation,"_",event,"_20Chr_15Mb_",rep), recurse = 1, fail=TRUE, type = "file", glob = "*80hapS*.final.summary"))),header=T,sep="\t"))
...
#}
        ...
        x <- 0:100000
        #plot_name <- c("1MNe_80hapS_no_singleton_1E_1000G_1.1i_20Chr_15Mb","1MNe_80hapS_no_singleton_1E_1000G_1.5i_20Chr_15Mb","1MNe_80hapS_no_singleton_1E_1000G_1.9i_20Chr_15Mb","1MNe_80hapS_no_singleton_1E_1000G_0.5e_d_1.5i_20Chr_15Mb")
        ## category
        ...
        fx <- function(x) {
            ...
            ## gen_50
                ...
                ## piewise 
                if (x <= 50) {
                    return(500000*(exp(log(1/2)/50*x)))
                } else {
                    return(500000*(exp(log(1/2)/50*x)))
                }
            } else if (all(sapply(c("50G","G_2e_i_cons"), grepl, plot_name))) {
                if (x <= 50) {
                    return(500000*(exp(log(2)/50*x)))
                } else {
                    return(500000*(exp(log(2)/50*50)))
                }
            } else if (all(sapply(c("50G","G_10e_d_cons"), grepl, plot_name))) {
                if (x <= 50) {
                    return(500000*(exp(log(1/10)/50*x)))
                } else {
                    return(500000*(exp(log(1/10)/50*50)))
                }
            } else if (all(sapply(c("50G","G_10e_i_cons"), grepl, plot_name))) {
                if (x <= 50) {
                    return(500000*(exp(log(10)/50*x)))
                } else {
                    return(500000*(exp(log(10)/50*50)))
                }
            
            ## gen_100
            } else if (all(sapply(c("100G","G_2e_d_cons"), grepl, plot_name))) {
                if (x <= 100) {
                    return(500000*(exp(log(1/2)/100*x)))
                } else {
                    return(500000*(exp(log(1/2)/100*100)))
                }
            } else if (all(sapply(c("100G","G_2e_i_cons"), grepl, plot_name))) {
                if (x <= 100) {
                    return(500000*(exp(log(2)/100*x)))
                } else {
                    return(500000*(exp(log(2)/100*100)))
                }
            } else if (all(sapply(c("100G","G_10e_d_cons"), grepl, plot_name))) {
                if (x <= 100) {
                    return(500000*(exp(log(1/10)/100*x)))
                } else {
                    return(500000*(exp(log(1/10)/100*100)))
                }
            } else if (all(sapply(c("100G","G_10e_i_cons"), grepl, plot_name))) {
                if (x <= 100) {
                    return(500000*(exp(log(10)/100*x)))
                } else {
                    return(500000*(exp(log(10)/100*100)))
                }
            ## gen_200
            } else if (all(sapply(c("200G","G_2e_d_cons"), grepl, plot_name))) {
                if (x <= 200) {
                    return(500000*(exp(log(1/2)/200*x)))
                } else {
                    return(500000*(exp(log(1/2)/200*200)))
                }
            } else if (all(sapply(c("200G","G_2e_i_cons"), grepl, plot_name))) {
                if (x <= 200) {
                    return(500000*(exp(log(2)/200*x)))
                } else {
                    return(500000*(exp(log(2)/200*200)))
                }
            } else if (all(sapply(c("200G","G_10e_d_cons"), grepl, plot_name))) {
                if (x <= 200) {
                    return(500000*(exp(log(1/10)/200*x)))
                } else {
                    return(500000*(exp(log(1/10)/200*200)))
                }
            } else if (all(sapply(c("200G","G_10e_i_cons"), grepl, plot_name))) {
                if (x <= 200) {
                    return(500000*(exp(log(10)/200*x)))
                } else {
                    return(500000*(exp(log(10)/200*200)))
                }

            ## gen_300
            } else if (all(sapply(c("300G","G_2e_d_cons"), grepl, plot_name))) {
                if (x <= 300) {
                    return(500000*(exp(log(1/2)/300*x)))
                } else {
                    return(500000*(exp(log(1/2)/300*300)))
                }
            } else if (all(sapply(c("300G","G_2e_i_cons"), grepl, plot_name))) {
                if (x <= 300) {
                    return(500000*(exp(log(2)/300*x)))
                } else {
                    return(500000*(exp(log(2)/300*300)))
                }
            } else if (all(sapply(c("300G","G_10e_d_cons"), grepl, plot_name))) {
                if (x <= 300) {
                    return(500000*(exp(log(1/10)/300*x)))
                } else {
                    return(500000*(exp(log(1/10)/300*300)))
                }
            } else if (all(sapply(c("300G","G_10e_i_cons"), grepl, plot_name))) {
                if (x <= 300) {
                    return(500000*(exp(log(10)/300*x)))
                } else {
                    return(500000*(exp(log(10)/300*300)))
                }
            ...
            ## gen_500
                ...
                ## piewise 
                if (x <= 500) {
                    return(500000*(exp(log(1/2)/500*x)))
                } else {
                    return(500000*(exp(log(1/2)/500*500)))
                }
            } else if (all(sapply(c("500G","G_2e_i_cons"), grepl, plot_name))) {
                if (x <= 500) {
                    return(500000*(exp(log(2)/500*x)))
                } else {
                    return(500000*(exp(log(2)/500*500)))
                }
            } else if (all(sapply(c("500G","G_10e_d_cons"), grepl, plot_name))) {
                if (x <= 500) {
                    return(500000*(exp(log(1/10)/500*x)))
                } else {
                    return(500000*(exp(log(1/10)/500*500)))
                }
            } else if (all(sapply(c("500G","G_10e_i_cons"), grepl, plot_name))) {
                if (x <= 500) {
                    return(500000*(exp(log(10)/500*x)))
                } else {
                    return(500000*(exp(log(10)/500*500)))
                }
            
            ## gen_1000
            } else if (all(sapply(c("1000G","G_2e_d_cons"), grepl, plot_name))) {
                if (x <= 1000) {
                    return(500000*(exp(log(1/2)/1000*x)))
                } else {
                    return(500000*(exp(log(1/2)/1000*1000)))
                }
            } else if (all(sapply(c("1000G","G_2e_i_cons"), grepl, plot_name))) {
                if (x <= 1000) {
                    return(500000*(exp(log(2)/1000*x)))
                } else {
                    return(500000*(exp(log(2)/1000*1000)))
                }
            } else if (all(sapply(c("1000G","G_10e_d_cons"), grepl, plot_name))) {
                if (x <= 1000) {
                    return(500000*(exp(log(1/10)/1000*x)))
                } else {
                    return(500000*(exp(log(1/10)/1000*1000)))
                }
            # } else if (all(sapply(c("1000G","G_0.5e_d_1.5i"), grepl, plot_name))) {
            } else {#G_10e_i_cons
                if (x <= 1000) {
                    return(500000*(exp(log(10)/1000*x)))
                } else {
                    return(500000*(exp(log(10)/1000*1000)))
                }
            #} else {
            #    ## return empty value
            #    NULL
