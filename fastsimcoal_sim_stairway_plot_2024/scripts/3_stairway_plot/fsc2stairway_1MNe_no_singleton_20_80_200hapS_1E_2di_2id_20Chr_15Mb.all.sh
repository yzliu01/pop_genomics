...
#SBATCH --error=fsc2stairway_1MNe_20_80_200hapS_1E_05i_20Chr_15Mb.%A_%a.e
#SBATCH --output=fsc2stairway_1MNe_20_80_200hapS_1E_05i_20Chr_15Mb.%A_%a.o
#SBATCH --job-name=fsc2stairway_1MNe_20_80_200hapS_1E_05i_20Chr_15Mb
...
blueprint_plot_sh=$(ls -t $blueprint_dir/*100_500G_2[id]_2[di]*blueprint.sh | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
...
cd /home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2
blueprint_dir=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2/stairway_plot_blueprint/1000000Ne_5rep_no_singletons
blueprint_file=`ls -t $blueprint_dir/*100_500G_2[id]_2[di]*blueprint | sort -V`
