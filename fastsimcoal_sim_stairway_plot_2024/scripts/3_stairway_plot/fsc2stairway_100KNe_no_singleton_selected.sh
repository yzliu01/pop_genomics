...
#SBATCH --error=fsc2stairway_100KNe_no_singleton_20_80_200hapS_1E_rest_main.%A_%a.e
#SBATCH --output=fsc2stairway_100KNe_no_singleton_20_80_200hapS_1E_rest_main.%A_%a.o
#SBATCH --job-name=fsc2stairway_100KNe_no_singleton_20_80_200hapS_1E_rest_main
