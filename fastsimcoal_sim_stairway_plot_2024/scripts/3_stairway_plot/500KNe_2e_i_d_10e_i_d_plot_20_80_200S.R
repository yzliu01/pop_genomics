...
## else
      ...
      if (xx <= 1000) 500000 else 500000 * 0
    }
  })
}
...
x_limits_list <- list(
  "50G_2e_d_cons"   = c(1, 100000),
  "100G_2e_d_cons"   = c(1, 100000),
  "500G_2e_d_cons"   = c(1, 100000),
  "1000G_2e_d_cons"   = c(1, 100000),
  ...
  "50G_2e_i_cons"   = c(1, 100000),
  "100G_2e_i_cons"   = c(1, 100000),
  "500G_2e_i_cons"   = c(1, 100000),
  "1000G_2e_i_cons"   = c(1, 100000),

  "50G_10e_i_cons"   = c(1, 100000),
  "100G_10e_i_cons"   = c(1, 100000),
  "500G_10e_i_cons"   = c(1, 100000),
  "1000G_10e_i_cons"   = c(1, 100000)
)

# Set per-event y-axis limits
y_limits_list <- list(
  "50G_2e_d_cons"   = c(1, 2000000),
  "100G_2e_d_cons"   = c(1, 2000000),
  "500G_2e_d_cons"   = c(1, 2000000),
  "1000G_2e_d_cons"   = c(1, 2000000),
  ...
  "50G_2e_i_cons"   = c(1, 2000000),
  "100G_2e_i_cons"   = c(1, 2000000),
  "500G_2e_i_cons"   = c(1, 2000000),
  "1000G_2e_i_cons"   = c(1, 2000000),

  "50G_10e_i_cons"   = c(1, 6000000),
  "100G_10e_i_cons"   = c(1, 6000000),
  "500G_10e_i_cons"   = c(1, 6000000),
  "1000G_10e_i_cons"   = c(1, 6000000)
)
...
#for (sample_size in c(20)) {
  for (singleton in c("_", "_no_singleton_")) {
    for (event in events) {
      ...
      for (rep in 1:n_reps) {
        rep_path <- paste0("./ft_sim_1000000Ne", singleton, sample_size, "hapS_1E_", event, "_20Chr_15Mb_", rep)
...
ggsave("500kNe_2e_id_10e_id_20_80_200S.new1.pdf", final_plot, width = 10, height = 54, limitsize = FALSE)
...
# cd $R_dir
# Rscript 3_stairway_plot/500KNe_2e_i_d_10e_i_d_plot_20_80_200S.R
