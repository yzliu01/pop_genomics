...
blueprint_plot_sh=$(ls -t $blueprint_dir/ft_sim_1000000Ne*2E_100_500G_*.blueprint.sh | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
...
blueprint_file=`ls -t $blueprint_dir/ft_sim_1000000Ne*2E_100_500G_*.blueprint | sort -V`
