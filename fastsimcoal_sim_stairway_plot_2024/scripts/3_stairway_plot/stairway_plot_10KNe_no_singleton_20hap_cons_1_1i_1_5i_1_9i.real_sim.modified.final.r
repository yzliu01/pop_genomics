...
pdf(paste0("combined.10KNe_no_singleton_20hapS_5rep_00d_1_1i_1_5i_1_9i_non_pruned.rotated_x_lab_final.new6.pdf"),width = 12, height = 12)
#pdf(paste0("combined.10KNe_no_singleton_20hapS_5rep_non_pruned.real_sim.rotated_x_lab-.pdf"),width = 20, height = 25)
