...
pdf(paste0("combined.1MNe_no_singleton_200hapS_5rep_cons_1_1i_1_5i_1_9i.rotated_x_lab_final.new6.pdf"),width = 12, height = 12)
#pdf(paste0("combined.1MNe_no_singleton_200hapS_5rep_non_pruned.real_sim.rotated_x_lab-.pdf"),width = 20, height = 25)
...
#    }
#}         
        if (plot_name %in% c("1MNe_no_singleton_200hapS_1E_50G_cons_20Chr_15Mb", "1MNe_no_singleton_200hapS_1E_100G_cons_20Chr_15Mb", "1MNe_no_singleton_200hapS_1E_500G_cons_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1MNe_no_singleton_200hapS_1E_1000G_cons_20Chr_15Mb","1MNe_no_singleton_200hapS_1E_1000G_1.1i_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1MNe_no_singleton_200hapS_1E_50G_1.1i_20Chr_15Mb","1MNe_no_singleton_200hapS_1E_100G_1.1i_20Chr_15Mb","1MNe_no_singleton_200hapS_1E_500G_1.1i_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1MNe_no_singleton_200hapS_1E_1000G_1.5i_20Chr_15Mb","1MNe_no_singleton_200hapS_1E_1000G_1.9i_20Chr_15Mb")){
        ...
        } else if (plot_name %in% c("1MNe_no_singleton_200hapS_1E_50G_1.5i_20Chr_15Mb","1MNe_no_singleton_200hapS_1E_100G_1.5i_20Chr_15Mb","1MNe_no_singleton_200hapS_1E_500G_1.5i_20Chr_15Mb",
