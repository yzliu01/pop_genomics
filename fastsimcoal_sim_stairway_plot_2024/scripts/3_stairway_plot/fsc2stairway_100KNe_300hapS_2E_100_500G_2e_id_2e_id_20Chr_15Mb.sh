...
#SBATCH --error=fsc2stairway_100KNe_300hapS_2E_100_500G_2e_id_2e_id_20Chr_15Mb.array.%A_%a.e
#SBATCH --output=fsc2stairway_100KNe_300hapS_2E_100_500G_2e_id_2e_id_20Chr_15Mb.array.%A_%a.o
#SBATCH --job-name=fsc2stairway_100KNe_300hapS_2E_100_500G_2e_id_2e_id_20Chr_15Mb
...
blueprint_plot_sh=$(ls $blueprint_dir/ft_sim_100000Ne_300hapS_2E_100_500G_*.blueprint.sh | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
...
cd /home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2
blueprint_dir=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2/stairway_plot_blueprint/100000Ne_5rep
blueprint_file=`ls $blueprint_dir/ft_sim_100000Ne_300hapS_2E_100_500G_*.blueprint | sort -V`
