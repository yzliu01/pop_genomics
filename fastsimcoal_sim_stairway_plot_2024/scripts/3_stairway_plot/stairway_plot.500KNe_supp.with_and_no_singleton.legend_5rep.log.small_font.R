...
fx <- function(x, plot_name) {
  sapply(x, function(xx) {
    if (grepl("G_cons", plot_name)) {
      ...
      if (xx <= 1000) 500000 else 500000 * 1.9
    }
  })
}
...
y_limits_list <- list(
  "50G_cons"   = c(1, 1000000),
  "50G_1.1i"   = c(1, 1000000),
  "50G_1.5i"   = c(1, 1000000),
  "50G_1.9i"   = c(1, 1000000),
  "100G_cons"   = c(1, 1000000),
  "100G_1.1i"   = c(1, 1000000),
  "100G_1.5i"   = c(1, 1000000),
  "100G_1.9i"   = c(1, 1000000),
  "500G_cons"   = c(1, 1000000),
  "500G_1.1i"   = c(1, 1000000),
  "500G_1.5i"   = c(1, 1000000),
  "500G_1.9i"   = c(1, 1000000),
  "1000G_cons"   = c(1, 1000000),
  "1000G_1.1i"   = c(1, 1000000),
  "1000G_1.5i"   = c(1, 1000000),
  "1000G_1.9i" = c(1, 1000000)
)
...
for (sample_size in c(20)){
    ...
    for (singleton in c("_","_no_singleton_")){
        ...
        for (i in seq_along(events)) {
            ...
            all_reps <- list()
                ...
                for (rep in 1:n_reps) {
                    ...
                    # "./ft_sim_1000000Ne_20hapS_1E_50G_1.1i_20Chr_15Mb_1"
                    # "./ft_sim_1000000Ne_no_singleton_20hapS_1E_50G_1.1i_20Chr_15Mb_1"
                ...
                if (is.null(y_limits)) y_limits <- c(1, 1000000)
                ...
                p <- ggplot() +
                    ...
                    #scale_y_continuous(limits = c(10, 1000000), labels = label_number()) +
        ...
        # Store the plot with a key that maintains order
        plot_list[[paste0(sample_size, singleton, event)]] <- p
        }
    }
    #plot_list[[event]] <- p
}
...
combined_plot_500KNe_75CI_with_no_singleton <- wrap_plots(plot_list, ncol = 4)
print(combined_plot_500KNe_75CI_with_no_singleton)

#combined_plot_1_75CI_with_singleton <- plot_list[[events[1]]] | plot_list[[events[2]]]
#print(combined_plot_1_75CI_with_singleton)

# Save to PDF
ggsave(filename = "./combined_plot_500KNe_10_40_100S_50_100_500_1000G_cons_01_05_09d_5_replicates_75CI_with_no_singleton.log_x.all_20.pdf",
       plot = combined_plot_500KNe_75CI_with_no_singleton, width = 10, height = 18, limitsize = FALSE)

ggsave(filename = "./combined_plot_500KNe_10_40_100S_50_100_500_1000G_cons_01_05_09d_5_replicates_75CI_with_no_singleton.log_x.all_20_80_200.pdf",
       plot = combined_plot_500KNe_75CI_with_no_singleton, width = 10, height = 54, limitsize = FALSE) # height = 3*18=54
...
# For final combine plots
library(gridExtra)
combined_plot_500KNe_75CI_with_no_singleton <- do.call(grid.arrange, c(plot_list, nrow = 3, ncol = 4))
...
combined_plot_500KNe_75CI_with_no_singleton <- grid.arrange(
...
# Arrange plots in 3x4 grid with empty last column
combined_plot_1_75CI_with_singleton <- grid.arrange(
