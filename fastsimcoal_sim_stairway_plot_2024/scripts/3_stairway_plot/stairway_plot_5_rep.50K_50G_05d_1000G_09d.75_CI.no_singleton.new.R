...
for (i in seq_along(events)) {
  ...
  p <- ggplot() +
    ...
    #geom_ribbon(data = long_df, aes(x = year, ymin = Ne_12.5., ymax = Ne_87.5., group = replicate),
...
# Combine plots
combined_plot_75CI_no_singleton <- plot_list[[events[1]]] | plot_list[[events[2]]]
print(combined_plot_75CI_no_singleton)

# Save to PDF
ggsave(filename = "./combined_plot_40S_50G_05d_1000G_09d_5_replicates_with_75CI_no_singleton.new.pdf",
       plot = combined_plot_75CI_no_singleton, width = 12, height = 6)
