...
events <- c(
            "ft_sim_10000Ne_no_singleton_20hapS_1E_100G_1.5i","ft_sim_100000Ne_no_singleton_20hapS_1E_100G_1.5i", "ft_sim_1000000Ne_no_singleton_20hapS_1E_100G_1.5i",
            "ft_sim_10000Ne_no_singleton_80hapS_1E_100G_1.5i","ft_sim_100000Ne_no_singleton_80hapS_1E_100G_1.5i", "ft_sim_1000000Ne_no_singleton_80hapS_1E_100G_1.5i",
            "ft_sim_10000Ne_no_singleton_200hapS_1E_100G_1.5i","ft_sim_100000Ne_no_singleton_200hapS_1E_100G_1.5i", "ft_sim_1000000Ne_no_singleton_200hapS_1E_100G_1.5i"
            )
n_reps <- 5
plot_list <- list()
...
combined_plot_2_75CI_no_singleton <- grid.arrange(
...
# Save to PDF
ggsave(filename = "./combined_plot_10_40_100S_100G_05d_5_replicates_with_75CI_no_singleton.log.2_x.pdf",
       plot = combined_plot_2_75CI_no_singleton, width = 10, height = 6)
