...
pdf(paste0("combined.1MNe_no_singleton_80hapS_5rep_cons_1_1i_1_5i_1_9i.rotated_x_lab_final.new6.pdf"),width = 12, height = 12)
#pdf(paste0("combined.1MNe_no_singleton_80hapS_5rep_non_pruned.real_sim.rotated_x_lab-.pdf"),width = 20, height = 25)
...
for (generation in c("50G","100G","500G","1000G")){
    ...
    for (event in c("cons","1.1i","1.5i","1.9i")){
        ...
        plot_name <- paste0("1MNe_no_singleton_80hapS_1E_",generation,"_",event,"_20Chr_15Mb")
        #print(plot_name)
...
#    }
#}         
        if (plot_name %in% c("1MNe_no_singleton_80hapS_1E_50G_cons_20Chr_15Mb", "1MNe_no_singleton_80hapS_1E_100G_cons_20Chr_15Mb", "1MNe_no_singleton_80hapS_1E_500G_cons_20Chr_15Mb")){
            plot(1,1, type="n", xlim=c(1,5e5), ylim=c(100000,1.0e6),log="x", xlab="", ylab="Effective population size",xaxt='n',yaxt='n')
            #log="xy",xlab="Generations ago", ylab="Effective population size"
            title(line=2)
            ...
            text(x=c(50,100,500,1000,10000,100000),labels = c(format(lablist.x,scientific=FALSE)),par("usr")[3] - 145000,srt = 45,pos = 3, xpd = TRUE)
            ## negative to go down

        } else if (plot_name %in% c("1MNe_no_singleton_80hapS_1E_1000G_cons_20Chr_15Mb","1MNe_no_singleton_80hapS_1E_1000G_1.1i_20Chr_15Mb")){
            plot(1,1, type="n", xlim=c(1,5e6), ylim=c(100000,1.0e6),log="x", xlab="Generations ago", ylab="Effective population size",xaxt='n',yaxt='n')
        ...
        } else if (plot_name %in% c("1MNe_no_singleton_80hapS_1E_50G_1.1i_20Chr_15Mb","1MNe_no_singleton_80hapS_1E_100G_1.1i_20Chr_15Mb","1MNe_no_singleton_80hapS_1E_500G_1.1i_20Chr_15Mb")){
            plot(1,1, type="n", xlim=c(1,5e6), ylim=c(100000,1.0e6),log="x", xlab="", ylab="",xaxt='n',yaxt='n')
            #xlab="Generations ago", ylab="Effective population size"
            title(line=2)
            axis(side=2, at=c(500000,750000,1000000),label=c(format(c(500000,750000,1000000),scientific=FALSE)))
        ...
        } else if (plot_name %in% c("1MNe_no_singleton_80hapS_1E_1000G_1.5i_20Chr_15Mb","1MNe_no_singleton_80hapS_1E_1000G_1.9i_20Chr_15Mb")){
            plot(1,1, type="n", xlim=c(1,5e6), ylim=c(100000,1.0e6),log="x", xlab="Generations ago", ylab="",xaxt='n',yaxt='n')
            #xlab="Generations ago", ylab="Effective population size"
            title(line=2)
            axis(side=2, at=c(500000,750000,1000000),label=c(format(c(500000,750000,1000000),scientific=FALSE)))
        ...
        } else if (plot_name %in% c("1MNe_no_singleton_80hapS_1E_50G_1.5i_20Chr_15Mb","1MNe_no_singleton_80hapS_1E_100G_1.5i_20Chr_15Mb","1MNe_no_singleton_80hapS_1E_500G_1.5i_20Chr_15Mb",
                                    "1MNe_no_singleton_80hapS_1E_50G_1.9i_20Chr_15Mb","1MNe_no_singleton_80hapS_1E_100G_1.9i_20Chr_15Mb","1MNe_no_singleton_80hapS_1E_500G_1.9i_20Chr_15Mb")){
            plot(1,1, type="n", xlim=c(1,5e6), ylim=c(100000,1.0e6),log="x", xlab="", ylab="",xaxt='n',yaxt='n')
            #xlab="Generations ago", ylab="Effective population size"
            title(line=2)
            axis(side=2, at=c(500000,750000,1000000),label=c(format(c(500000,750000,1000000),scientific=FALSE)))
        ...
        #lablist.x <- as.vector(c(50,100,500,1000,10000,100000))
        #axis(side=1,at=c(50,100,500,1000,10000,100000),labels=FALSE)
        #text(x=c(50,100,500,1000,10000,100000),labels = c(format(lablist.x,scientific=FALSE)),par("usr")[3] - 5000,srt = 45,pos = 3, xpd = TRUE)
        ...
        for (rep in c(1:5)){
            ...
            assign(paste0("a",rep), read.table(mixedsort(sort(fs::dir_ls(path=paste0("./ft_sim_1MNe_no_singleton_80hapS_1E_",generation,"_",event,"_20Chr_15Mb_",rep), recurse = 1, fail=TRUE, type = "file", glob = "*80hapS*.final.summary"))),header=T,sep="\t"))
            #print(head(get(paste0("a",rep)),n=2L))
            #paste0("data_ft_sim_1MNe_no_singleton_80hapS_1E_",generation,"_",event,"_20Chr_15Mb")
...
#}
        ...
        x <- 0:100000
        #plot_name <- c("1MNe_no_singleton_80hapS_1E_1000G_1.1i_20Chr_15Mb","1MNe_no_singleton_80hapS_1E_1000G_1.5i_20Chr_15Mb","1MNe_no_singleton_80hapS_1E_1000G_1.9i_20Chr_15Mb","1MNe_no_singleton_80hapS_1E_1000G_0.5e_d_1.5i_20Chr_15Mb")
        fx <- function(x) {
