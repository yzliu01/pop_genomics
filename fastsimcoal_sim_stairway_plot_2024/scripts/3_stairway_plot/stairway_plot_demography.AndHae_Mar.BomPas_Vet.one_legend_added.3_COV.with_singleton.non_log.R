...
file_list_a <- c(             
                "AndHae_New_REF_AndHae.with_singleton_sfs_234_1500x_sm_genic",
                "AndMar_New_REF_AndMar.with_singleton_sfs_240_1500x_sm_genic",
                "BomPas_New_REF_BomPas.with_singleton_sfs_204_1500x_sm_genic",
                "BomVet_New_REF_BomVet.with_singleton_sfs_174_1500x_sm_genic"               
                )
...
p1_initial <- ggplot(merged_data_new, aes(x = year, y = Ne_median, group = species, color = species)) +
  ...
  scale_y_continuous(limits = c(1, 2600000), labels = label_number(big.mark = "")) +
  ...
  annotate(geom = "rect", xmin = 10, xmax = 25000, ymin = 1000, ymax = 2600000, 
...
# single plot old
    ...
    scale_y_continuous(limits = c(1,2600000),
...
p3x_final <- p1_initial + 
    ...
    annotation_custom(ggplotGrob(p1_zoom), xmin = 50000, xmax = 180000, ymin = 150000, ymax = 2600000) +
    ## position of annotation frame
    geom_rect(aes(xmin = 50000, xmax = 180000, ymin = 150000, ymax = 2600000),
...
# Save the plot
ggsave("with_singleton_non_log_plot_all_3x.pdf", p3x_final, width = 10, height = 8)
