...
#SBATCH --error=fsc2stairway_100KNe_no_singleton_20_80_200hapS_1E_05i.%A_%a.e
#SBATCH --output=fsc2stairway_100KNe_no_singleton_20_80_200hapS_1E_05i.%A_%a.o
#SBATCH --job-name=fsc2stairway_100KNe_no_singleton_20_80_200hapS_1E_05i
...
run_blueprint_plot_sh=$(ls $blueprint_dir/ft_sim_100000Ne*05i_20Chr_15Mb_*.blueprint.sh | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
...
blueprint_file=`ls $blueprint_dir/ft_sim_100000Ne*05i_20Chr_15Mb_*.blueprint | sort -V`
