...
#SBATCH --error=fsc2stairway_10KNe_no_singleton_80_hapS_10e_d.%A_%a.e.txt
#SBATCH --output=fsc2stairway_10KNe_no_singleton_80_hapS_10e_d.%A_%a.o.txt
#SBATCH --job-name=fsc2stairway_10KNe_no_singleton_80_hapS_10e_d
...
blueprint_plot_sh=$(ls -t $blueprint_dir/ft_sim_10000Ne_80hapS_1E_500G_10e_d_cons_20Chr_15Mb_1.blueprint.sh | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
...
cd /home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2
blueprint_dir=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2/stairway_plot_blueprint/10000Ne_5rep_no_singletons
blueprint_file=`ls -t $blueprint_dir/ft_sim_10000Ne_80hapS_1E_500G_10e_d_cons_20Chr_15Mb_1.blueprint | sort -V`
