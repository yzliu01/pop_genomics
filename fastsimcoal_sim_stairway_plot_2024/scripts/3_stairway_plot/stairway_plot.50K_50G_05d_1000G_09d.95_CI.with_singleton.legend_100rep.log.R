...
p <- ggplot() +
    ...
    theme(
      ...
      legend.position = if (i == 1) c(0.8, 0.7) else "none",
...
# Combine plots
combined_plot_100rep_log_with_singleton <- plot_list[[events[1]]] | plot_list[[events[2]]]
print(combined_plot_100rep_log_with_singleton)

# Save to PDF
ggsave(filename = "./combined_plot_40S_50G_05d_1000G_09d_100_replicates_with_95CI_with_singleton.log_new.pdf",
       plot = combined_plot_100rep_log_with_singleton, width = 12, height = 6)
