...
## x and xx can cause problem, be careful
...
## else
      ...
      warning("No pattern matched for: ", plot_name)
      if (xx <= 1000) 5000 else 5000  # Changed from 5000*0 to 5000
    }
  })
}
...
y_limits_list <- list(
  "50G_2e_d_cons"   = c(1, 20000),
  "100G_2e_d_cons"   = c(1, 20000),
  "500G_2e_d_cons"   = c(1, 20000),
  "1000G_2e_d_cons"   = c(1, 20000),

  "50G_10e_d_cons"   = c(1, 10000),
  "100G_10e_d_cons"   = c(1, 10000),
  "500G_10e_d_cons"   = c(1, 10000),
  "1000G_10e_d_cons"   = c(1, 10000),

  "50G_2e_i_cons"   = c(1, 20000),
  "100G_2e_i_cons"   = c(1, 20000),
  "500G_2e_i_cons"   = c(1, 20000),
  "1000G_2e_i_cons"   = c(1, 20000),

  "50G_10e_i_cons"   = c(1, 60000),
  "100G_10e_i_cons"   = c(1, 60000),
  "500G_10e_i_cons"   = c(1, 60000),
  "1000G_10e_i_cons"   = c(1, 60000)
)
...
#ggsave("5kNe_2e_id_10e_id_20_80_200S.new1.pdf", final_plot, width = 10, height = 18, limitsize = FALSE)
ggsave("5kNe_2e_id_10e_id_20_80_200S.new1.pdf", final_plot, width = 10, height = 54, limitsize = FALSE)
...
# srun --mem=500g -c 10 --time=01:00:00 --pty bash
# conda activate R
# R_dir=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/population_genomics/fastsimcoal_sim_stairway_plot_2024/scripts/
# cd $R_dir
# Rscript 3_stairway_plot/5KNe_2e_i_d_10e_i_d_plot_20_80_200S.R
## killed

## exit the requested resource
#exit
## error info
#slurmstepd: error: Detected 2 oom_kill events in StepId=63618812.0. Some of the step tasks have been OOM Killed.
#srun: error: s21n84: task 0: Out Of Memory

#jobinfo 63619244
#sstat: error: StepId=63619244.batch not found running.
#Name                : bash
#User                : yzliu
#Account             : --
...
#State               : RUNNING
#ExitCode            : --
#Submit              : 2025-06-24T17:14:26
#Start               : 2025-06-24T17:14:35
#End                 : --
#Waited              : 00:00:09
#Reserved walltime   : 01:00:00
#Used walltime       : 00:05:23
#Used CPU time       : 00:00:00
#% User (Computation): --
#% System (I/O)      : --
#Mem reserved        : 1000G
#Max Mem used        : 576.41G (cn-1042)
#Max Disk Write      : 1.00M (cn-1042)
#Max Disk Read       : 117.60M (cn-1042)
