...
# Combine plots
combined_plot_75CI_with_singleton <- plot_list[[events[1]]] | plot_list[[events[2]]]
print(combined_plot_75CI_with_singleton)

# Save to PDF
ggsave(filename = "./combined_plot_40S_50G_05d_1000G_09d_5_replicates_with_75CI_with_singleton.new.pdf",
       plot = combined_plot_75CI_with_singleton, width = 12, height = 6)
