...
#SBATCH --error=bees_4pools.DP_200_1500_all_sites_no_singleton.prepare_run_blueprint.extended.sm_ann_no_mis.New_REF_earlier_pas_REF_pas_all_sites.%A_%a.e.txt
#SBATCH --output=bees_4pools.DP_200_1500_all_sites_no_singleton.prepare_run_blueprint.extended.sm_ann_no_mis.New_REF_earlier_pas_REF_pas_all_sites.%A_%a.o.txt
#SBATCH --job-name=bees_4pools.DP_200_1500_all_sites_no_singleton.prepare_run_blueprint.extended.sm_ann_no_mis.New_REF_earlier_pas_REF_pas_all_sites
