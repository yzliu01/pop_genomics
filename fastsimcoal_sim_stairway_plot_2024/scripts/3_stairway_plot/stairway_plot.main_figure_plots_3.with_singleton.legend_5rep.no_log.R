...
x_limits_list <- list(
  ...
  "1000G_1.5i"   = c(1, 1500),
  "1000G_1.9i" = c(1, 1500),
"ft_sim_10000Ne_20hapS_1E_100G_1.5i" = c(1, 250),
"ft_sim_100000Ne_20hapS_1E_100G_1.5i" = c(1, 250),
"ft_sim_1000000Ne_20hapS_1E_100G_1.5i" = c(1, 250),
"ft_sim_10000Ne_80hapS_1E_100G_1.5i" = c(1, 250),
#"ft_sim_100000Ne_80hapS_1E_100G_1.5i" = c(1, 250),
"ft_sim_1000000Ne_80hapS_1E_100G_1.5i" = c(1, 250),
"ft_sim_10000Ne_200hapS_1E_100G_1.5i" = c(1, 250),
"ft_sim_100000Ne_200hapS_1E_100G_1.5i" = c(1, 250),
"ft_sim_1000000Ne_200hapS_1E_100G_1.5i" = c(1, 250),
##
"ft_sim_100000Ne_80hapS_1E_100G_1.5i" = c(1, 500),
"ft_sim_100000Ne_80hapS_1E_100G_05i" = c(1, 500), 
"ft_sim_100000Ne_80hapS_1E_100G_2e_i_cons" = c(1, 500),
"ft_sim_100000Ne_80hapS_1E_100G_2e_d_cons" = c(1, 500)
...
##
"ft_sim_100000Ne_80hapS_1E_100G_1.5i" = c(1, 100000),
"ft_sim_100000Ne_80hapS_1E_100G_05i" = c(20000, 100000), 
...
p <- ggplot() +
    ...
    theme(
      ...
      legend.position = if (i == 1) c(0.7, 0.4) else "none",
...
# Save to PDF
ggsave(filename = "./combined_plot_40S_100G_05i_2e_di_5_replicates_with_75CI_with_singleton.no_log.pdf",
