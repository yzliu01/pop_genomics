...
#SBATCH --error=fsc2stairway_10000Ne_300hapS_2E_100_500G_2e_id_2e_id_20Chr_15Mb.array.%A_%a.e
#SBATCH --output=fsc2stairway_10KNe_300hapS_2E_100_500G_2e_id_2e_id_20Chr_15Mb.array.%A_%a.o
#SBATCH --job-name=fsc2stairway_10KNe_300hapS_2E_100_500G_2e_id_2e_id_20Chr_15Mb
...
blueprint_plot_sh=$(ls -t $blueprint_dir/ft_sim_10000Ne_300hapS_2E_100_500G_*.blueprint.sh | grep -E 'md_' | head -5 | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
...
cd /home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2
blueprint_dir=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2/stairway_plot_blueprint/10000Ne_5rep
blueprint_file=`ls -t $blueprint_dir/ft_sim_10000Ne_300hapS_2E_100_500G_*.blueprint | grep -E 'md_' | head -5 | sort -V`
