...
pdf(paste0("stairway_plot_main_figure_increasing_decline_timing_1.grid.pdf"),width = 12, height = 12)
...
#for (generation in c("50G","100G","500G","1000G")){
    ...
    for (generation in c("50G","100G","500G","1000G")){
        ...
        if (plot_name %in% c(
            "50000Ne_40S_1E_50G_1.1i_20Chr_15Mb",
            "50000Ne_40S_1E_100G_1.1i_20Chr_15Mb", 
            "50000Ne_40S_1E_500G_1.1i_20Chr_15Mb",
            "50000Ne_40S_1E_1000G_1.1i_20Chr_15Mb"
            )){
            ...
            plot(1,1, type="n", xlim=c(1,5e6), ylim=c(30000,1.0e5),log="x", cex.axis = 0.8, xlab="", ylab="Effective population size",xaxt='n',yaxt='n')
            #xlab="Generations ago", ylab="Effective population size"
            title(line=2)
            axis(side=2, at=c(50000,75000,100000),label=c(format(c(50000,75000,100000),scientific=FALSE)))
