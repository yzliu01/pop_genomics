...
#SBATCH --error=fsc2stairway_100KNe.50K_50G_05d_1000G_09d.no_singleton.%A_%a.e
#SBATCH --output=fsc2stairway_100KNe.50K_50G_05d_1000G_09d.no_singleton.%A_%a.o
#SBATCH --job-name=fsc2stairway_100KNe.50K_50G_05d_1000G_09d.no_singleton
...
run_blueprint_plot_sh=$(ls $blueprint_dir/ft_sim_100000Ne_80hapS_1E*50G_1.5i_20Chr_15Mb_*.blueprint.sh $blueprint_dir/ft_sim_100000Ne_80hapS_1E_1000G_1.9i_20Chr_15Mb_*.blueprint.sh | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
...
blueprint_file=`ls $blueprint_dir/ft_sim_100000Ne_80hapS_1E*50G_1.5i_20Chr_15Mb_*.blueprint $blueprint_dir/ft_sim_100000Ne_80hapS_1E_1000G_1.9i_20Chr_15Mb_*.blueprint | sort -V`
