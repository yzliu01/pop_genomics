...
result_path <- "/home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2/systematic_ft_non_pruned/1MNe_swp-"
setwd(result_path)
...
# instant increase and decrease
      ...
      if (xx <= 50) 500000 else 500000 * 1.1
    } else if (grepl("50G.*1.5i", plot_name)) {
      if (xx <= 50) 500000 else 500000 * 1.5
    } else if (grepl("50G.*1.9i", plot_name)) {
      if (xx <= 50) 500000 else 500000 * 1.9
    } else if (grepl("50G.*05i", plot_name)) {
      if (xx <= 50) 500000 else 500000 * 0.5
    } else if (grepl("100G.*1.1i", plot_name)) {
      if (xx <= 100) 500000 else 500000 * 1.1
    } else if (grepl("100G.*1.5i", plot_name)) {
      if (xx <= 100) 500000 else 500000 * 1.5
    } else if (grepl("100G.*1.9i", plot_name)) {
      if (xx <= 100) 500000 else 500000 * 1.9
    } else if (grepl("100G.*05i", plot_name)) {
      if (xx <= 100) 500000 else 500000 * 0.5
    } else if (grepl("500G.*1.1i", plot_name)) {
      if (xx <= 500) 500000 else 500000 * 1.1
    } else if (grepl("500G.*1.5i", plot_name)) {
      if (xx <= 500) 500000 else 500000 * 1.5
    } else if (grepl("500G.*1.9i", plot_name)) {
      if (xx <= 500) 500000 else 500000 * 1.9
    } else if (grepl("500G.*05i", plot_name)) {
      if (xx <= 500) 500000 else 500000 * 0.5
    } else if (grepl("1000G.*1.1i", plot_name)) {
      if (xx <= 1000) 500000 else 500000 * 1.1
    } else if (grepl("1000G.*05i", plot_name)) {
      if (xx <= 1000) 500000 else 500000 * 0.5
    } else if (grepl("1000G.*1.5i", plot_name)) {
      if (xx <= 1000) 500000 else 500000 * 1.5

## exponential increase and decrease
## 50G
    } else if (grepl("50G_2e_d_cons", plot_name)) {
      if (xx <= 50) 500000*(0.9862^xx) else 500000*(0.9862^50)
    } else if (grepl("50G_10e_d_cons", plot_name)) {
      if (xx <= 50) 500000*(0.9549^xx) else 500000*(0.9549^50)
    } else if (grepl("50G_2e_i_cons", plot_name)) {
      if (xx <= 50) 500000*(1.0140^xx) else 500000*(1.0140^50)
    } else if (grepl("50G_10e_i_cons", plot_name)) {
      if (xx <= 50) 500000*(1.0472^xx) else 500000*(1.0472^50)
## 100G
    } else if (grepl("100G_2e_d_cons", plot_name)) {
      if (xx <= 100) 500000*(0.9931^xx) else 500000*(0.9931^100)
    } else if (grepl("100G_10e_d_cons", plot_name)) {
      if (xx <= 100) 500000*(0.9773^xx) else 500000*(0.9773^100)
    } else if (grepl("100G_2e_i_cons", plot_name)) {
      if (xx <= 100) 500000*(1.0069^xx) else 500000*(1.0069^100)
    } else if (grepl("100G_10e_i_cons", plot_name)) {
      if (xx <= 100) 500000*(1.0233^xx) else 500000*(1.0233^100)
## 500G
    } else if (grepl("500G_2e_d_cons", plot_name)) {
      if (xx <= 500) 500000*(0.9986^xx) else 500000*(0.9986^500)
    } else if (grepl("500G_10e_d_cons", plot_name)) {
      if (xx <= 500) 500000*(0.9954^xx) else 500000*(0.9954^500)
    } else if (grepl("500G_2e_i_cons", plot_name)) {
      if (xx <= 500) 500000*(1.0014^xx) else 500000*(1.0014^500)
    } else if (grepl("500G_10e_i_cons", plot_name)) {
      if (xx <= 500) 500000*(1.0046^xx) else 500000*(1.0046^500)
## 1000G
    } else if (grepl("1000G_2e_d_cons", plot_name)) {
      if (xx <= 1000) 500000*(0.9993^xx) else 500000*(0.9993^1000)
    } else if (grepl("1000G_10e_d_cons", plot_name)) {
      if (xx <= 1000) 500000*(0.9977^xx) else 500000*(0.9977^1000)
    } else if (grepl("1000G_2e_i_cons", plot_name)) {
      if (xx <= 1000) 500000*(1.0007^xx) else 500000*(1.0007^1000)
    } else if (grepl("1000G_10e_i_cons", plot_name)) {
      if (xx <= 1000) 500000*(1.0023^xx) else 500000*(1.0023^1000)

## two pop size change event at 500_100G
    } else if (grepl("100_500G_2i_2i", plot_name)) {
      if (xx <= 100) 500000 else if (100 < xx & xx <= 500) 2*500000 else 2*2*500000
    } else if (grepl("100_500G_2d_2i", plot_name)) {
      if (xx <= 100) 500000 else if (100 < xx & xx <= 500) 1/2*500000 else 1/2*2*500000
    } else if (grepl("100_500G_2i_2d", plot_name)) {
      if (xx <= 100) 500000 else if (100 < xx & xx <= 500) 2*500000 else 2*1/2*500000
    } else if (grepl("100_500G_2d_2d", plot_name)) {
      if (xx <= 100) 500000 else if (100 < xx & xx <= 500) 1/2*500000 else 1/2*1/2*500000
    } else if (grepl("100_500G_10d_10d", plot_name)) {
      if (xx <= 100) 500000 else if (100 < xx & xx <= 500) 1/10*500000 else 1/10*1/10*500000
    } else if (grepl("100_500G_2e_i_2e_d", plot_name)) {
      if (xx <= 100) 500000*(exp(log(2)/100*xx)) else if (xx <= 500) 500000*(exp(log(2)/100*100))*(exp(log(1/2)/400*(xx-100))) else 500000*(exp(log(2)/100*100))*(exp(log(1/2)/400*400))
    } else if (grepl("100_500G_2e_d_2e_i", plot_name)) {
      if (xx <= 100) 500000*(exp(log(1/2)/100*xx)) else if (xx <= 500) 500000*(exp(log(1/2)/100*100))*(exp(log(2)/400*(xx-100))) else 500000*(exp(log(1/2)/100*100))*(exp(log(2)/400*400))
## else
    } else {
      if (xx <= 100) 500000 else 500000 * 0
    }
  })
}
...
y_limits_list <- list(
  "100_500G_2i_2i"   = c(1, 2500000),
  "100_500G_2d_2d"   = c(1, 1500000),
  "100_500G_10d_10d"   = c(1, 1500000),
  "100_500G_2d_2i"   = c(1, 1500000),
  "100_500G_2i_2d"   = c(1, 1500000),
  "100_500G_2e_i_2e_d"   = c(1, 1500000),
  "100_500G_2e_d_2e_i"   = c(1, 1500000)
)
...
#for (sample_size in c(20)) {
  for (singleton in c("_", "_no_singleton_")) {
    for (event in events) {
      ...
      for (rep in 1:n_reps) {
        rep_path <- paste0("./ft_sim_1000000Ne", singleton, sample_size, "hapS_2E_", event, "_20Chr_15Mb_", rep)
      ...
      p <- ggplot() +
        ...
        labs(title = paste0("500kNe", singleton, sample_size,"S_" , event),
             x = "Generations ago",
...
ggsave("500KNe_2d_2d_2i_2i_10i_10i_2d_2i_2i_2d_2ei_2ed_2ed_2ei_plot_20_80_200S.new1.pdf", final_plot, width = 17.5, height = 13.5, limitsize = FALSE) # 3 * 2 rows
