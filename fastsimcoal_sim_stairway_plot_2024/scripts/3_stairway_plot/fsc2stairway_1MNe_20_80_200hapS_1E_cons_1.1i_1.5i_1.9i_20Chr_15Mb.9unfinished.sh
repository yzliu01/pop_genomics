...
#SBATCH --mem 4g
#SBATCH --array=188,190-195,231-232,235%10
#SBATCH --time=18:00:00
#SBATCH --error=fsc2stairway_1MNe_20_80_200hapS_1E_cons_1.1i_1.5i_1.9i_20Chr_15Mb.array.%A_%a.e.txt
#SBATCH --output=fsc2stairway_1MNe_20_80_200hapS_1E_cons_1.1i_1.5i_1.9i_20Chr_15Mb.array.%A_%a.o.txt
#SBATCH --job-name=fsc2stairway_1MNe_20_80_200hapS_1E_cons_1.1i_1.5i_1.9i
