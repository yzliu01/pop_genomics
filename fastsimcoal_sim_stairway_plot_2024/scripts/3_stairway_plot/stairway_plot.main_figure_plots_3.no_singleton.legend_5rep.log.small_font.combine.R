...
fx <- function(x, plot_name) {
  sapply(x, function(xx) {
    if (grepl("G_cons", plot_name)) {
      5000
# 10KNe
    } else if (grepl("10000Ne_no_singleton_20hapS_1E_100G.*1.5i", plot_name)) {
      if (xx <= 100) 5000 else 5000 * 1.5
    } else if (grepl("10000Ne_no_singleton_80hapS_1E_100G.*1.5i", plot_name)) {
      if (xx <= 100) 5000 else 5000 * 1.5
    } else if (grepl("10000Ne_no_singleton_200hapS_1E_100G.*1.5i", plot_name)) {
      if (xx <= 100) 5000 else 5000 * 1.5
# 100KNe
    } else if (grepl("100000Ne_no_singleton_20hapS_1E_100G.*1.5i", plot_name)) {
      if (xx <= 100) 50000 else 50000 * 1.5
    } else if (grepl("100000Ne_no_singleton_80hapS_1E_100G.*1.5i", plot_name)) {
      if (xx <= 100) 50000 else 50000 * 1.5
    } else if (grepl("100000Ne_no_singleton_200hapS_1E_100G.*1.5i", plot_name)) {
      if (xx <= 100) 50000 else 50000 * 1.5
# 1000KNe
    } else if (grepl("1000000Ne_no_singleton_20hapS_1E_100G.*1.5i", plot_name)) {
      if (xx <= 100) 500000 else 500000 * 1.5
    } else if (grepl("1000000Ne_no_singleton_80hapS_1E_100G.*1.5i", plot_name)) {
      if (xx <= 100) 500000 else 500000 * 1.5
    } else if (grepl("1000000Ne_no_singleton_200hapS_1E_100G.*1.5i", plot_name)) {
      if (xx <= 100) 500000 else 500000 * 1.5
# 100KNe
    } else if (grepl("ft_sim_100000Ne_no_singleton_80hapS_1E_100G_05i", plot_name)) {
      if (xx <= 100) 50000 else 50000 * 0.5
# 100KNe
    } else if (grepl("ft_sim_100000Ne_no_singleton_80hapS_1E_100G_2e_i_cons", plot_name)) {
      if (xx <= 100) 50000 * (1.0069^xx) else 50000 * (1.0069^100)
# 100KNe
    } else if (grepl("ft_sim_100000Ne_no_singleton_80hapS_1E_100G_2e_d_cons", plot_name)) {
...
events <- c(
            "ft_sim_100000Ne_no_singleton_80hapS_1E_100G_1.5i","ft_sim_100000Ne_no_singleton_80hapS_1E_100G_05i", "ft_sim_100000Ne_no_singleton_80hapS_1E_100G_2e_i_cons","ft_sim_100000Ne_no_singleton_80hapS_1E_100G_2e_d_cons"
            )
n_reps <- 5
plot_list <- list()
...
"ft_sim_10000Ne_no_singleton_20hapS_1E_100G_1.5i" = c(1, 100000),
"ft_sim_100000Ne_no_singleton_20hapS_1E_100G_1.5i" = c(1, 100000),
"ft_sim_1000000Ne_no_singleton_20hapS_1E_100G_1.5i" = c(1, 100000),
"ft_sim_10000Ne_no_singleton_80hapS_1E_100G_1.5i" = c(1, 100000),
"ft_sim_100000Ne_no_singleton_80hapS_1E_100G_1.5i" = c(1, 100000),
"ft_sim_1000000Ne_no_singleton_80hapS_1E_100G_1.5i" = c(1, 100000),
"ft_sim_10000Ne_no_singleton_200hapS_1E_100G_1.5i" = c(1, 100000),
"ft_sim_100000Ne_no_singleton_200hapS_1E_100G_1.5i" = c(1, 100000),
"ft_sim_1000000Ne_no_singleton_200hapS_1E_100G_1.5i" = c(1, 100000),
##
"ft_sim_100000Ne_no_singleton_80hapS_1E_100G_1.5i" = c(1, 100000),
"ft_sim_100000Ne_no_singleton_80hapS_1E_100G_05i" = c(1, 100000), 
"ft_sim_100000Ne_no_singleton_80hapS_1E_100G_2e_i_cons" = c(1, 100000),
"ft_sim_100000Ne_no_singleton_80hapS_1E_100G_2e_d_cons" = c(1, 100000)
...
"ft_sim_10000Ne_no_singleton_20hapS_1E_100G_1.5i" = c(1, 20000),
"ft_sim_100000Ne_no_singleton_20hapS_1E_100G_1.5i" = c(1, 100000),
"ft_sim_1000000Ne_no_singleton_20hapS_1E_100G_1.5i" = c(1, 800000),
"ft_sim_10000Ne_no_singleton_80hapS_1E_100G_1.5i" = c(1, 20000),
"ft_sim_100000Ne_no_singleton_80hapS_1E_100G_1.5i" = c(1, 100000),
"ft_sim_1000000Ne_no_singleton_80hapS_1E_100G_1.5i" = c(1, 800000),
"ft_sim_10000Ne_no_singleton_200hapS_1E_100G_1.5i" = c(1, 20000),
"ft_sim_100000Ne_no_singleton_200hapS_1E_100G_1.5i" = c(1, 100000),
"ft_sim_1000000Ne_no_singleton_200hapS_1E_100G_1.5i" = c(1, 800000),
##
"ft_sim_100000Ne_no_singleton_80hapS_1E_100G_1.5i" = c(1, 100000),
"ft_sim_100000Ne_no_singleton_80hapS_1E_100G_05i" = c(1, 100000), 
"ft_sim_100000Ne_no_singleton_80hapS_1E_100G_2e_i_cons" = c(1, 200000),
"ft_sim_100000Ne_no_singleton_80hapS_1E_100G_2e_d_cons" = c(1, 200000)
)
...
combined_plot_3_75CI_no_singleton <- grid.arrange(
...
# Save to PDF
ggsave(filename = "./combined_plot_40S_100G_05i_2e_di_5_replicates_with_75CI_no_singleton.small_font.log_x.3.pdf",
       plot = combined_plot_3_75CI_no_singleton, width = 10, height = 6)



## final combine
all_plots <- list(
  combined_plot_1_75CI_no_singleton,
  combined_plot_2_75CI_no_singleton,
  combined_plot_3_75CI_no_singleton
)
...
# Save to PDF
ggsave(filename = "./combined_plot_main_figure_1_2_3_75CI_no_singleton.small_font.log_x.pdf",
