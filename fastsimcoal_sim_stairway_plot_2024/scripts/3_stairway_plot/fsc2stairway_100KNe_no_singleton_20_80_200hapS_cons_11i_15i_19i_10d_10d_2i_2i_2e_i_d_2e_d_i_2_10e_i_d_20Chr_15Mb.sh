...
#SBATCH --error=fsc2stairway_100KNe_no_singleton_20_80_200hapS_cons_1.1i_1.5i_1.9i_05i_10d_10d_2i_2i_2e_i_d_2e_d_i_2_10e_i_d.%A_%a.e
#SBATCH --output=fsc2stairway_100KNe_no_singleton_20_80_200hapS_cons_1.1i_1.5i_1.9i_05i_10d_10d_2i_2i_2e_i_d_2e_d_i_2_10e_i_d.%A_%a.o
#SBATCH --job-name=fsc2stairway_100KNe_no_singleton_20_80_200hapS_cons_1.1i_1.5i_1.9i_05i_10d_10d_2i_2i_2e_i_d_2e_d_i_2_10e_i_d
...
blueprint_plot_sh=$(ls -t $blueprint_dir/*.blueprint.sh | sort -V | head -645 | sed -n ${SLURM_ARRAY_TASK_ID}p)
