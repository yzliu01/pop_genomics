...
for (i in seq_along(events)) {
  ...
  p <- ggplot() +
    ...
    #scale_x_log10(limits = c(1, 200000),breaks = c(10, 100, 1000, 10000),labels = label_number(big.mark = "")) + ## issue with a start low value and then 40 years
    #scale_x_log10(limits = c(0, 100000), labels = label_number()) +
    scale_y_continuous(limits = c(10, 200000), labels = label_number(big.mark = "")) +
...
# Save to PDF
ggsave(filename = "./combined_plot_40S_50G_05d_1000G_09d_5_replicates_with_95CI_with_singleton.new.pdf",
