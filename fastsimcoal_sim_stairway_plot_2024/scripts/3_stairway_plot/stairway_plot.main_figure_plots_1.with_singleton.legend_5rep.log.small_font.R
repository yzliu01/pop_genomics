...
combined_plot_1_75CI_with_singleton <- wrap_plots(plot_list, nrow = 3)
...
# Save to PDF
ggsave(filename = "./combined_plot_40S_50_1000G_01_05_09d_5_replicates_with_75CI_with_singleton.log.1.pdf",
       plot = combined_plot_1_75CI_with_singleton, width = 10, height = 6)



# For final combine plots
library(gridExtra)
combined_plot_1_75CI_with_singleton <- do.call(grid.arrange, c(plot_list, nrow = 3, ncol = 4))
