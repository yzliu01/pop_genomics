...
y_limits_list <- list(
  ...
  "500G_1.5i"   = c(1, 12500),
  "500G_1.9i"   = c(1, 12500),
  "1000G_cons"   = c(1, 12500),
  "1000G_1.1i"   = c(1, 12500),
  "1000G_1.5i"   = c(1, 12500),
  "1000G_1.9i" = c(1, 12500)
)
...
for (i in seq_along(events)) {
  ...
  if (is.null(y_limits)) y_limits <- c(1, 12500)
...
p <- ggplot() +
    ...
    #scale_y_continuous(limits = c(10, 12500), labels = label_number()) +
    scale_y_continuous(trans = "log10",limits = y_limits, labels = label_number(big.mark = "")) +
...
combined_plot_5KNe_75CI_with_no_singleton <- wrap_plots(plot_list, nrow = 3)
print(combined_plot_5KNe_75CI_with_no_singleton)

#combined_plot_1_75CI_with_singleton <- plot_list[[events[1]]] | plot_list[[events[2]]]
#print(combined_plot_1_75CI_with_singleton)

# Save to PDF
ggsave(filename = "./combined_plot_5KNe_10_40_100S_50_100_500_1000G_cons_01_05_09d_5_replicates_with_75CI_with_no_singleton.log_xy.pdf",
       plot = combined_plot_5KNe_75CI_with_no_singleton, width = 10, height = 6)



# For final combine plots
library(gridExtra)
combined_plot_5KNe_75CI_with_no_singleton <- do.call(grid.arrange, c(plot_list, nrow = 3, ncol = 4))
...
combined_plot_5KNe_75CI_with_no_singleton <- grid.arrange(
