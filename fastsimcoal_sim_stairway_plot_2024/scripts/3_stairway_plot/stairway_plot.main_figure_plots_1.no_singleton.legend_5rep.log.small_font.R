...
y_limits_list <- list(
  ...
  "50G_1.5i"   = c(1, 200000),
  "50G_1.9i"   = c(1, 200000),
  "100G_1.1i"   = c(1, 200000),
  "100G_1.5i"   = c(1, 200000),
  "100G_1.9i"   = c(1, 200000),
  "500G_1.1i"   = c(1, 200000),
  "500G_1.5i"   = c(1, 200000),
  "500G_1.9i"   = c(1, 200000),
  "1000G_1.1i"   = c(1, 200000),
  "1000G_1.5i"   = c(1, 200000),
  "1000G_1.9i" = c(1, 200000)
)
...
combined_plot_1_75CI_no_singleton <- wrap_plots(plot_list, nrow = 3)
print(combined_plot_1_75CI_no_singleton)

#combined_plot_1_75CI_no_singleton <- plot_list[[events[1]]] | plot_list[[events[2]]]
#print(combined_plot_1_75CI_no_singleton)

# Save to PDF
ggsave(filename = "./combined_plot_40S_50_100_500_1000G_01_05_09d_5_replicates_with_75CI_no_singleton.log_x.1.pdf",
       plot = combined_plot_1_75CI_no_singleton, width = 10, height = 6)



# For final combine plots
library(gridExtra)
combined_plot_1_75CI_no_singleton <- do.call(grid.arrange, c(plot_list, nrow = 3, ncol = 4))
...
combined_plot_1_75CI_no_singleton <- grid.arrange(
