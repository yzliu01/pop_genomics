...
#SBATCH --error=fsc2stairway_100_replicates_20_80_200hapS_1E_05d_09d_20Chr_15Mb.%A_%a.e
#SBATCH --output=fsc2stairway_100_replicates_20_80_200hapS_1E_05d_09d_20Chr_15Mb.%A_%a.o
#SBATCH --job-name=fsc2stairway_100_replicates_20_80_200hapS_1E_05d_09d_20Chr_15Mb
...
blueprint_dir=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2/stairway_plot_blueprint/100_replicates
blueprint_plot_sh=$(ls -t $blueprint_dir/*_20Chr_15Mb*blueprint.sh | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
...
cd /home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2
blueprint_dir=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2/stairway_plot_blueprint/100_replicates
blueprint_file=`ls -t $blueprint_dir/*_20Chr_15Mb*blueprint | sort -V`
