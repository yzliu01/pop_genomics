...
pdf(paste0("combined.50000Ne_40S_5rep_cons_1_1i_1_5i_1_9i_non_pruned.test_issue_xy_log_0.pdf"),width = 12, height = 12)
...
for (generation in c("50G","1000G")){
    ...
    for (event in c("1.5i","1.9i")){
        ...
        if (plot_name %in% c("50000Ne_40S_1E_50G_cons_20Chr_15Mb", "50000Ne_40S_1E_100G_cons_20Chr_15Mb", "50000Ne_40S_1E_500G_cons_20Chr_15Mb")){
            plot(1,1, type="n", xlim=c(1,5e5), ylim=c(20000,1.0e5),log="x", cex.axis = 0.8, xlab="", ylab="Effective population size",xaxt='n',yaxt='n')
            #log="xy",xlab="Generations ago", ylab="Effective population size"
            title(line=2)
            ...
            plot(1,1, type="n", xlim=c(1,5e6), ylim=c(20000,1.0e5),log="x", cex.axis = 0.8, xlab="Generations ago", ylab="Effective population size",xaxt='n',yaxt='n')
            ...
            plot(1,1, type="n", xlim=c(1,5e6), ylim=c(20000,1.0e5),log="xy", cex.axis = 0.8, xlab="", ylab="",xaxt='n',yaxt='n')
            #xlab="Generations ago", ylab="Effective population size"
            title(line=2)
            #axis(side=2, at=c(50000,75000,100000),label=c(format(c(50000,75000,100000),scientific=FALSE)))
...
axis(1, at = axTicks(1), labels = format(axTicks(1), scientific = FALSE))
        ...
        ## two tests
            ...
            plot(1,1, type="n", xlim=c(1,5e6), ylim=c(20000,1.0e5),log="xy", cex.axis = 0.8, xlab="Generations ago", ylab="",xaxt='n',yaxt='n')
            #xlab="Generations ago", ylab="Effective population size"
            title(line=2)
            #axis(side=2, at=c(50000,75000,100000),label=c(format(c(50000,75000,100000),scientific=FALSE)))
axis(2, at = axTicks(2), labels = format(axTicks(2), scientific = FALSE))
