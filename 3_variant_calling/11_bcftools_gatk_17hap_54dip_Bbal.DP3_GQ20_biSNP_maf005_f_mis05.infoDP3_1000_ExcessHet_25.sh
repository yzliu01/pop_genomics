...
#SBATCH -n 1
#SBATCH -t 04:00:00
#SBATCH -J DP3_GQ20_biSNP_maf0.05_f_missing0.5.infoDP3_1000Excesshet_25
#SBATCH --mail-type=all
#SBATCH --mail-user=yuanzhen.liu@imbim.uu.se
#SBATCH --error=bcftools_DP3_GQ20_biSNP_maf0.05_f_missing0.5.infoDP3_1000Excesshet_25.dist.%A.e
#SBATCH --output=bcftools_DP3_GQ20_biSNP_maf0.05_f_missing0.5.infoDP3_1000Excesshet_25.dist.%A.o
...
OUTPUT_FILE=gatk_17haploid_54diploid_B_bal.SNP_hard_filtered.DP3_GQ20_biSNP_maf005_f_missing05.infoDP3_1000Excesshet_25.vcf.gz
...
bcftools view -e 'INFO/DP > 1000 | INFO/ExcessHet > 25' $INPUT_FILE -Oz -o $OUTPUT_FILE
