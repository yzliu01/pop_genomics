...
#SBATCH --error=1_samtools_stats_68dro_mel_mark_rm_Dup.%A.e.txt
#SBATCH --output=1_samtools_stats_68dro_mel_mark_rm_Dup.%A.o.txt
#SBATCH --job-name=1_samtools_stats_68dro_mel_mark_rm_Dup
...
SATS_OUT_DIR=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/cleanfastq_sortbam_markduplicate/stats/samtools_stats
## stats
