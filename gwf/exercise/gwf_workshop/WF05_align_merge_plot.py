...
#############################
### Index the reference
### and align the trimmed reads
### to merge them at the end
#############################


gwf.target( f"BWA_index", #name of the target
           cores=1,
           memory='8gb',
           walltime='00:10:00',	
           inputs= ['fasta/ecoli_rel606.fasta'], 
           outputs=[ 'fasta/ecoli_rel606.fasta.'+ extension for extension in ['amb','ann','bwt','pac','sa'] ]) << """
    bwa index fasta/ecoli_rel606.fasta
    """
