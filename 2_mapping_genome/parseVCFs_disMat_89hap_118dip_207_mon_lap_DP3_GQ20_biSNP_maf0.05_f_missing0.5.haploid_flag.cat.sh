...
#SBATCH -n 18
#SBATCH -t 2-10:30:00
#SBATCH -J geno_dist.gatk_89haploid_118diploid_B_syl.DP3_GQ20_biSNP_maf0.05_f_missing0.5.ploidy_flag
#SBATCH --mail-type=all
#SBATCH --mail-user=yuanzhen.liu@imbim.uu.se
#SBATCH --error=geno_dist.gatk_89haploid_118diploid_B_syl.DP3_GQ20_biSNP_maf0.05_f_missing0.5.ploidy_flag.%A.e
#SBATCH --output=geno_dist.gatk_89haploid_118diploid_B_syl.DP3_GQ20_biSNP_maf0.05_f_missing0.5.ploidy_flag.%A.o
...
cd $INPUT_FILE
HAP_DIP=gatk_89haploid_118diploid_B_syl.SNP_hard_filtered.DP3_GQ20_biSNP_maf0.05_f_missing0.5.vcf.gz

#time bcftools index $HAP_DIP
GENO=gatk_89haploid_118diploid_B_syl.SNP_hard_filtered.DP3_GQ20_biSNP_maf0.05_f_missing0.5.geno.gz
...
DIST=gatk_89haploid_118diploid_B_syl.SNP_hard_filtered.DP3_GQ20_biSNP_maf0.05_f_missing0.5.ploidy_flag.geno.cat_dist
