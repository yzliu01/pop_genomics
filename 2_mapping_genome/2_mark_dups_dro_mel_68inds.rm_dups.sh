...
#SBATCH --error=2_RG_mark_rm_dups_index_dro_mel_68inds.%A_%a.e.txt
#SBATCH --output=2_RG_mark_rm_dups_index_dro_mel_68inds.%A_%a.o.txt
#SBATCH --job-name=2_RG_mark_rm_dups_index_dro_mel_68inds
...
## stats
printf "\n######  bamtools stats: $MARKED_BAM ######" >> ./stats/bamtools_stats/bamtools_stats_marked_dups_68samples.txt
bamtools stats -in $MARKED_BAM >> ./stats/bamtools_stats/bamtools_stats_marked_dups_68samples.txt
