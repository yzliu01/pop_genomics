...
#SBATCH --error=3_fb_variant_calling_4_bee_pools.BomPas_REF_BomPas.array_per_contig_18.10kb_g600.%A.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.BomPas_REF_BomPas.array_per_contig_18.10kb_g600.%A.o
...
freebayes-parallel $contig_region 12 --fasta-reference $REF \
    ...
    --bam $BAM_DIR/$SAMPLE -g 600 --strict-vcf --gvcf > $VCF_OUT_DIR/fb_per_contig_BomPas_REF_BomPas/"$BAM2VCF_NAME"_"$contig_name".g.vcf
