...
#SBATCH --error=1_gatk_REF1_2_3_bee_pools_markDup_index.new.%A_%a.e.txt
#SBATCH --output=1_gatk_REF1_2_3_bee_pools_markDup_index.new.%A_%a.o.txt
#SBATCH --job-name=1_gatk_REF1_2_3_bee_pools_markDup_index
