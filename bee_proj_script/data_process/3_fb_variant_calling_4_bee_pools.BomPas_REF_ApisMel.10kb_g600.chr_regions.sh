...
#SBATCH --error=3_fb_variant_calling_4_bee_pools.BomPas_REF_ApisMel.10kb_g600.chr_regions.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.BomPas_REF_ApisMel.10kb_g600.chr_regions.%A_%a.o
...
freebayes-parallel $contig_regions --fasta-reference $REF \
    ...
    vcffilter -f "QUAL > 20" > $VCF_OUT_DIR/fb_per_contig_BomPas_REF_ApisMel/"$BAM2VCF_NAME"_"$contig_regions_order".qual_20.g.vcf
