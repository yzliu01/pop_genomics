...
#SBATCH --error=1_New_REF1_AndMar_mapping_sort_markDup_stats_bee_4_pools.%A_%a.e.txt
#SBATCH --output=1_New_REF1_AndMar_mapping_sort_markDup_stats_bee_4_pools.%A_%a.o.txt
#SBATCH --job-name=1_New_REF1_AndMar_mapping_sort_markDup_stats_bee_4_pools
