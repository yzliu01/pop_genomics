...
#SBATCH --error=1_bwa_samtools_alt_REF_BomMus_2step_sambamba_markDup_stats.%A_%a.e
#SBATCH --output=1_bwa_samtools_alt_REF_BomMus_2step_sambamba_markDup_stats.%A_%a.o
#SBATCH --job-name=1_bwa_samtools_alt_REF_BomMus_2step_sambamba_markDup_stats
