...
REF1=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/ref_genome/$REF_list1

## modify output file names
#File1=${seq1/.fastq.clean.gz/.bam}				 ### SRR13647737_1.bam
#File2=${File1/.bam/_sort.bam}				 ### SRR13647737_1_sort.bam
File1=${seq1/fastq1.fq.clean.gz/.sort.bam}
...
echo -e "aligning: $seq1 $seq2\n" >> $script_path/bee_aligning_sorting.log
bwa mem -t 6 -R $ReadGroup $REF1 $SEQDIR/$seq1 $SEQDIR/$seq1 | samtools sort -@ 6 -m 40G -o $OUT_BAM/$File1
#bwa mem -t 6 -R $ReadGroup $REF $SEQDIR/$seq1 $SEQDIR/$seq1 | samtools view -b -@ 6 -o $File1
#samtools sort -@ 6 -m 40G -o $File2 $File1

## indexing sorted
echo -e "\nindexing: $File1\n" >> $script_path/bee_sort_marked_bam_index.log
