...
#SBATCH --error=1_gatk_REF1_2_3_bee_pools_mark_rm_Dup_index.new_pasVet.%A_%a.e.txt
#SBATCH --output=1_gatk_REF1_2_3_bee_pools_mark_rm_Dup_index.new_pasVet.%A_%a.o.txt
#SBATCH --job-name=pasVet_mark_rm_Dup_index
