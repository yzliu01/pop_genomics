...
#SBATCH --error=1_gatk_REF1_2_3_bee_pools_markDup_index.new_pas1.%A_%a.e.txt
#SBATCH --output=1_gatk_REF1_2_3_bee_pools_markDup_index.new_pas1.%A_%a.o.txt
#SBATCH --job-name=pas1_markDup_index
...
SORTED_BAM=$(ls Bompas.REF_BomPas.sort.bam | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p) # forward sequence
