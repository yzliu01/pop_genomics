...
#SBATCH --error=1_bwa_samtools_REF23_BomCon_2step_sambamba_markDup_stats.%A_%a.e
#SBATCH --output=1_bwa_samtools_REF23_BomCon_2step_sambamba_markDup_stats.%A_%a.o
#SBATCH --job-name=1_bwa_samtools_REF23_BomCon_2step_sambamba_markDup_stats
