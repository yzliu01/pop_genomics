...
#SBATCH --mem 800g
##SBATCH --mem 1100g
#SBATCH --array=1-143%20
##SBATCH --array=1-91%10
#SBATCH --time=03:10:00
##SBATCH --time=10:30:00
##SBATCH --time=3-04:04:00
#SBATCH --error=3_fb_variant_calling_4_bee_pools.BomPas_New_REF_BomPas.2Mb_region_1500x.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.BomPas_New_REF_BomPas.2Mb_region_1500x.%A_%a.o
#SBATCH --job-name=3_fb_VC_4_bee_pools.BomPas_New_REF_BomPas
...
freebayes --fasta-reference /home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/ref_genome/iyBomPasc1_1.md_chr.fa --ploidy 68 --pooled-discrete \
    --region chr1:10000-20000 --genotype-qualities --report-monomorphic --use-best-n-alleles 4 \
    --bam /home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/bam/Bompas.REF_BomPas.sort.marked_dups.new.bam -g 1500 --strict-vcf --gvcf > Bompas.REF_BomPas.1500x_region_chr1:10000-20000.g.vcf
