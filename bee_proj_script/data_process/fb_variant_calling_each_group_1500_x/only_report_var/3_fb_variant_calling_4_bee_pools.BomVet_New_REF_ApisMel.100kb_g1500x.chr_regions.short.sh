...
#SBATCH --error=3_fb_variant_calling_4_bee_pools.BomVet_New_REF_ApisMel.100kb_g1500x.chr_regions.short.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.BomVet_New_REF_ApisMel.100kb_g1500x.chr_regions.short.%A_%a.o
#SBATCH --job-name=3_fb_variant_calling_4_bee_pools.BomVet_New_REF_ApisMel.short
...
mkdir $VCF_OUT_DIR/fb_per_region_BomVet_New_REF_ApisMel
#cd $VCF_OUT_DIR/fb_per_contig_BomPas_REF_ApisMel
cd $VCF_OUT_DIR/fb_per_region_BomVet_New_REF_ApisMel
...
SAMPLE=Bomvet.New_REF_ApisMel.sort.marked_dups.bam
...
freebayes --region $Each_Region_Ref --fasta-reference $REF \
    ...
    > $VCF_OUT_DIR/fb_per_region_BomVet_New_REF_ApisMel/"Bomvet.New_REF_ApisMel.100kb_1500x_region_"${SLURM_ARRAY_TASK_ID}.g.vcf
#    vcfintersect -v -b $Ref_Masked_Bed > $VCF_OUT_DIR/$fb_per_region_BomVet_New_REF_ApisMel/"Bompas.New_REF_ApisMel.2Mb_g1500_region_"${SLURM_ARRAY_TASK_ID}.g.vcf
#    vcffilter -f "QUAL > 20"
