...
#SBATCH --mem 350g
#SBATCH --array=1-4235%40
##SBATCH --array=4236-4363%40
#SBATCH --time=10:00:00
##SBATCH --time=3-04:04:00
#SBATCH --error=3_fb_variant_calling_4_bee_pools.AndHae_New_REF_AndHat.100kb_g1500x.chr_regions.short.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.AndHae_New_REF_AndHat.100kb_g1500x.chr_regions.short.%A_%a.o
#SBATCH --job-name=3_fb_variant_calling_4_bee_pools.AndHae_New_REF_AndHat.short
...
freebayes --region $Each_Region_Ref --fasta-reference $REF \
    ...
    > $VCF_OUT_DIR/fb_per_region_AndHae_New_REF_AndHat/"Andhae.New_REF_AndHat.100kb_1500x_region_"${SLURM_ARRAY_TASK_ID}.g.vcf
#    vcfintersect -v -b $Ref_Masked_Bed > $VCF_OUT_DIR/$fb_per_region_AndHae_New_REF_AndHat/"Bompas.New_REF_BomPas.2Mb_g1500_region_"${SLURM_ARRAY_TASK_ID}.g.vcf
#    vcffilter -f "QUAL > 20"
