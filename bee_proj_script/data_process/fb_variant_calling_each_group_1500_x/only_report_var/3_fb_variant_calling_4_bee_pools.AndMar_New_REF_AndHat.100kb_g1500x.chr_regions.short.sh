...
#SBATCH --error=3_fb_variant_calling_4_bee_pools.AndMar_New_REF_AndHat.100kb_g1500x.chr_regions.short.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.AndMar_New_REF_AndHat.100kb_g1500x.chr_regions.short.%A_%a.o
#SBATCH --job-name=3_fb_variant_calling_4_bee_pools.AndMar_New_REF_AndHat.short
...
freebayes --region $Each_Region_Ref --fasta-reference $REF \
    ...
    > $VCF_OUT_DIR/fb_per_region_AndMar_New_REF_AndHat/"Andmar.New_REF_AndHat.100kb_1500x_region_"${SLURM_ARRAY_TASK_ID}.g.vcf
