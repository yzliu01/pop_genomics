...
#SBATCH --mem 250g
#SBATCH --array=144,585,1171,1221,1835,1873-1874,2302-2309,2813,2829,2835,2838,2914,2926-2929,2932-2933,2946,2952-2953,2962%30
##SBATCH --array=2966-3116%40
#SBATCH --time=10:00:00
##SBATCH --time=3-04:04:00
#SBATCH --error=3_fb_variant_calling_4_bee_pools.BomVet_New_REF_BomPas.100kb_g1500x.chr_regions.short.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.BomVet_New_REF_BomPas.100kb_g1500x.chr_regions.short.%A_%a.o
#SBATCH --job-name=3_fb_variant_calling_4_bee_pools.BomVet_New_REF_BomPas.short
...
mkdir $VCF_OUT_DIR/fb_per_region_BomVet_New_REF_BomPas
#cd $VCF_OUT_DIR/fb_per_contig_BomPas_REF_BomPas
cd $VCF_OUT_DIR/fb_per_region_BomVet_New_REF_BomPas
...
SAMPLE=Bomvet.New_REF_BomPas.sort.marked_dups.bam
...
freebayes --region $Each_Region_Ref --fasta-reference $REF \
    ...
    > $VCF_OUT_DIR/fb_per_region_BomVet_New_REF_BomPas/"Bomvet.New_REF_BomPas.100kb_1500x_region_"${SLURM_ARRAY_TASK_ID}.g.vcf
#    vcfintersect -v -b $Ref_Masked_Bed > $VCF_OUT_DIR/$fb_per_region_BomVet_New_REF_BomPas/"Bompas.New_REF_BomPas.2Mb_g1500_region_"${SLURM_ARRAY_TASK_ID}.g.vcf
#    vcffilter -f "QUAL > 20"
