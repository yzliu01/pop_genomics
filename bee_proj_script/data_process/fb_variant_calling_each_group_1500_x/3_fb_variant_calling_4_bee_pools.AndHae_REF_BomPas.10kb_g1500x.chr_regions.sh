...
#SBATCH --error=3_fb_variant_calling_4_bee_pools.AndHae_REF_BomPas.10kb_g1500x.chr_regions.%A.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.AndHae_REF_BomPas.10kb_g1500x.chr_regions.%A.o
...
SAMPLE=Andhae.REF_BomPas.sort.marked_dups.new.bam
