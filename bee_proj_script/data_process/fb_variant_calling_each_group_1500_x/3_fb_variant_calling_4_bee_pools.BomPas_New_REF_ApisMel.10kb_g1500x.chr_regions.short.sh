...
#SBATCH --error=3_fb_variant_calling_4_bee_pools.BomPas_New_REF_ApisMel.10kb_g1500x.chr_regions.short.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.BomPas_New_REF_ApisMel.10kb_g1500x.chr_regions.short.%A_%a.o
...
freebayes --region $Each_Region_Ref --fasta-reference $REF \
    ...
    > $VCF_OUT_DIR/fb_per_region_BomPas_New_REF_ApisMel/"Bompas.New_REF_ApisMel.mono_1500x_region_"${SLURM_ARRAY_TASK_ID}.g.vcf
