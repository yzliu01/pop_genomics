...
#SBATCH --error=3_fb_variant_calling_4_bee_pools.AndHae_New_REF_AndHae.10kb_g1500x.chr_regions.short_left149.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.AndHae_New_REF_AndHae.10kb_g1500x.chr_regions.short_left149.%A_%a.o
#SBATCH --job-name=3_fb_variant_calling_4_bee_pools.AndHae_New_REF_AndHae.short_left149
...
freebayes --region $Each_Region_Ref --fasta-reference $REF \
    ...
    > $VCF_OUT_DIR/fb_per_region_AndHae_New_REF_AndHae/"Andhae.New_REF_AndHae.mono_1500x_region_"${SLURM_ARRAY_TASK_ID}.g.vcf
