...
#SBATCH --error=3_fb_variant_calling_4_bee_pools.AndMar_REF_AndHae.10kb_g1500x.chr_regions.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.AndMar_REF_AndHae.10kb_g1500x.chr_regions.%A_%a.o
...
SAMPLE=Andmar.REF_AndHae.sort.marked_dups.new.bam
...
freebayes-parallel $contig_regions 20 --fasta-reference $REF \
    ...
    vcffilter -f "QUAL > 20" > $VCF_OUT_DIR/fb_per_contig_AndMar_REF_AndHae/"$BAM2VCF_NAME""$contig_regions_order".qual_20.g.vcf
