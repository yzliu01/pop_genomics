...
#SBATCH --array=149-151%3
##SBATCH --time=03:10:00
#SBATCH --time=22:00:00
##SBATCH --time=3-04:04:00
#SBATCH --error=3_fb_variant_calling_4_bee_pools.AndMar_New_REF_AndHae.2Mb_g1500x.chr_regions.short.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.AndMar_New_REF_AndHae.2Mb_g1500x.chr_regions.short.%A_%a.o
...
freebayes --region $Each_Region_Ref --fasta-reference $REF \
    ...
    > $VCF_OUT_DIR/fb_per_region_AndMar_New_REF_AndHae/"Andmar.New_REF_AndHae.1500x_region_"${SLURM_ARRAY_TASK_ID}.g.vcf
