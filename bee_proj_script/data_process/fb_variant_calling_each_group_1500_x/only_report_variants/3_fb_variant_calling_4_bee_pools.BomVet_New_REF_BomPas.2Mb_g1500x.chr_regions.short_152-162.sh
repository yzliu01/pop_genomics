...
#SBATCH --array=152-153,158-159,161-162%6
##SBATCH --time=03:10:00
#SBATCH --time=24:00:00
##SBATCH --time=3-04:04:00
#SBATCH --error=3_fb_variant_calling_4_bee_pools.BomVet_New_REF_BomPas.2Mb_g1500x.chr_regions.short_152-162.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.BomVet_New_REF_BomPas.2Mb_g1500x.chr_regions.short_152-162.%A_%a.o
#SBATCH --job-name=3_fb_variant_calling_4_bee_pools.BomVet_New_REF_BomPas.short_152-162
...
freebayes --region $Each_Region_Ref --fasta-reference $REF \
    ...
    > $VCF_OUT_DIR/fb_per_region_BomVet_New_REF_BomPas/"Bomvet.New_REF_BomPas.1500x_region_"${SLURM_ARRAY_TASK_ID}.g.vcf
