...
#SBATCH --error=3_fb_variant_calling_4_bee_pools.BomVet_New_REF_BomPas.2Mb_g1500x.chr_regions.long.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.BomVet_New_REF_BomPas.2Mb_g1500x.chr_regions.long.%A_%a.o
#SBATCH --output=3_fb_variant_calling_4_bee_pools.BomVet_New_REF_BomPas.2Mb_g1500x.chr_regions.long.%A_%a.o
