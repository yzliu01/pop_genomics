...
#SBATCH --mem 250g
##SBATCH --array=1-2%2
#SBATCH --array=1-2,31-33,40-46,51-60%22
##SBATCH --array=152-210%20
##SBATCH --time=03:10:00
#SBATCH --time=22:00:00
##SBATCH --time=3-04:04:00
#SBATCH --error=3_fb_variant_calling_4_bee_pools.BomPas_New_REF_BomPas.2Mb_g1500x.chr_regions.long.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.BomPas_New_REF_BomPas.2Mb_g1500x.chr_regions.long.%A_%a.o
#SBATCH --job-name=3_fb_variant_calling_4_bee_pools.BomPas_New_REF_BomPas.long
...
freebayes --region $Each_Region_Ref --fasta-reference $REF \
    ...
    > $VCF_OUT_DIR/fb_per_region_BomPas_New_REF_BomPas/"Bompas.New_REF_BomPas.1500x_region_"${SLURM_ARRAY_TASK_ID}.g.vcf
