...
##SBATCH --array=2287-2386%40
#SBATCH --time=03:00:00
##SBATCH --time=3-04:04:00
#SBATCH --error=3_fb_variant_calling_4_bee_pools.BomPas_New_REF_ApisMel.100kb_g1500x.chr_regions.short.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.BomPas_New_REF_ApisMel.100kb_g1500x.chr_regions.short.%A_%a.o
