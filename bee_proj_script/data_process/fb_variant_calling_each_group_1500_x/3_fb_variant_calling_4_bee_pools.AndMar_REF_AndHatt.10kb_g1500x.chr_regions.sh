...
#SBATCH --error=3_fb_variant_calling_4_bee_pools.AndMar_REF_AndHatt.10kb_g1500x.chr_regions.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.AndMar_REF_AndHatt.10kb_g1500x.chr_regions.%A_%a.o
