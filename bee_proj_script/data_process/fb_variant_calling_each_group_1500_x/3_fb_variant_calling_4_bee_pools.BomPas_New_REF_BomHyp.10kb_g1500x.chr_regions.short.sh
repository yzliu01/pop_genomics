...
#SBATCH --error=3_fb_variant_calling_4_bee_pools.BomPas_New_REF_BomHyp.10kb_g1500x.chr_regions.short.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.BomPas_New_REF_BomHyp.10kb_g1500x.chr_regions.short.%A_%a.o
#SBATCH --job-name=3_fb_variant_calling_4_bee_pools.BomPas_New_REF_BomHyp.short
...
freebayes --region $Each_Region_Ref --fasta-reference $REF \
    ...
    > $VCF_OUT_DIR/fb_per_region_BomPas_New_REF_BomHyp/"Bompas.New_REF_BomHyp.mono_1500x_region_"${SLURM_ARRAY_TASK_ID}.g.vcf
