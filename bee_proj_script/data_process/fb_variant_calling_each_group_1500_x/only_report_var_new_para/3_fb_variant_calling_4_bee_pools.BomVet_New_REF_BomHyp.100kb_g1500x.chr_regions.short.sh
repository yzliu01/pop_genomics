...
#SBATCH --array=1-3005%200
#SBATCH --time=10:00:00
##SBATCH --time=3-04:04:00
#SBATCH --error=3_fb_variant_calling_4_bee_pools.BomVet_New_REF_BomHyp.100kb_g1500x.chr_regions.short.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.BomVet_New_REF_BomHyp.100kb_g1500x.chr_regions.short.%A_%a.o
