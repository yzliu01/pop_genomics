...
#SBATCH --mem 25g
#SBATCH --array=1-3282%600
#SBATCH --time=24:00:00
##SBATCH --time=3-04:04:00
#SBATCH --error=3_fb_variant_calling_4_bee_pools.BomPas_New_alt_REF_BomMus.100kb_g1500x.chr_regions.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.BomPas_New_alt_REF_BomMus.100kb_g1500x.chr_regions.%A_%a.o
#SBATCH --job-name=3196_3_fb_variant_calling_4_bee_pools.BomPas_New_alt_REF_BomMus
