...
#SBATCH --error=3_fb_variant_calling_4_bee_pools.AndMar_New_REF_AndHat.100kb_g1500x.chr_regions.short_left3779.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.AndMar_New_REF_AndHat.100kb_g1500x.chr_regions.short_left3779.%A_%a.o
#SBATCH --job-name=left3779_3_fb_variant_calling_4_bee_pools.AndMar_New_REF_AndHat.short
