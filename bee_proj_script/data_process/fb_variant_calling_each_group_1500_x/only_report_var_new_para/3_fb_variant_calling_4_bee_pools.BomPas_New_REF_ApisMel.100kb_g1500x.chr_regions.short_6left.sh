...
#SBATCH --mem 50g
##SBATCH --array=1-2286%40
#SBATCH --array=148,847,1045,1513,1524,1728%6
#SBATCH --time=03:00:00
##SBATCH --time=3-04:04:00
#SBATCH --error=3_fb_variant_calling_4_bee_pools.BomPas_New_REF_ApisMel.100kb_g1500x.chr_regions.short_6left.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.BomPas_New_REF_ApisMel.100kb_g1500x.chr_regions.short_6left.%A_%a.o
#SBATCH --job-name=3_fb_variant_calling_4_bee_pools.BomPas_New_REF_ApisMel.short
...
## mkdir $VCF_OUT_DIR/fb_per_contig_BomPas_REF_ApisMel
mkdir $VCF_OUT_DIR/fb_per_region_BomPas_New_REF_ApisMel
#cd $VCF_OUT_DIR/fb_per_contig_BomPas_REF_ApisMel
cd $VCF_OUT_DIR/fb_per_region_BomPas_New_REF_ApisMel

## path to your ref genome
REF_DIR=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/ref_genome
REF=$REF_DIR/Apis_mellifera_HAv-GCF_003254395.2-softmasked.fa
...
SAMPLE=Bompas.New_REF_ApisMel.sort.marked_dups.bam
...
Ref_Region=Apis_mellifera_HAv-GCF_003254395.2-softmasked.fb_100kb.regions
...
freebayes --region $Each_Region_Ref --fasta-reference $REF \
    ...
    > $VCF_OUT_DIR/fb_per_region_BomPas_New_REF_ApisMel/"Bompas.New_REF_ApisMel.100kb_1500x_region_"${SLURM_ARRAY_TASK_ID}.g.vcf
#    vcfintersect -v -b $Ref_Masked_Bed > $VCF_OUT_DIR/$fb_per_region_BomPas_New_REF_ApisMel/"Bompas.New_REF_ApisMel.2Mb_g1500_region_"${SLURM_ARRAY_TASK_ID}.g.vcf
#    vcffilter -f "QUAL > 20"
