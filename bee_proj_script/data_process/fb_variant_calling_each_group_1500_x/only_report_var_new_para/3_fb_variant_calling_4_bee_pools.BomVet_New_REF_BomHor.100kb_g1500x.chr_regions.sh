...
#SBATCH --error=3_fb_variant_calling_4_bee_pools.BomVet_New_REF_BomHor.100kb_g1500x.chr_regions.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.BomVet_New_REF_BomHor.100kb_g1500x.chr_regions.%A_%a.o
#SBATCH --job-name=2984_3_fb_variant_calling_4_bee_pools.BomVet_New_REF_BomHor
...
mkdir $VCF_OUT_DIR/fb_per_region_BomVet_New_REF_BomHor
cd $VCF_OUT_DIR/fb_per_region_BomVet_New_REF_BomHor
...
## for pooled data
SAMPLE=Bomvet.New_REF_BomHor-.sort.marked_dups.bam
...
freebayes --region $Each_Region_Ref --fasta-reference $REF \
    ...
    > ./"Bomvet.New_REF_BomHor.100kb_1500x_region_"${SLURM_ARRAY_TASK_ID}.g.vcf
