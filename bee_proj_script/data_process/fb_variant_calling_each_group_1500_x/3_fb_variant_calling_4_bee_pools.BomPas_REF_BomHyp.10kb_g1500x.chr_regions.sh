...
#SBATCH --error=3_fb_variant_calling_4_bee_pools.BomPas_REF_BomHyp.10kb_g1500x.chr_regions.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.BomPas_REF_BomHyp.10kb_g1500x.chr_regions.%A_%a.o
#SBATCH --job-name=3_fb_variant_calling_4_bee_pools.BomPas_REF_BomHyp.chr_regions
...
freebayes-parallel $contig_regions 20 --fasta-reference $REF \
    ...
    vcffilter -f "QUAL > 20" > $VCF_OUT_DIR/fb_per_contig_BomPas_REF_BomHyp/"$BAM2VCF_NAME""$contig_regions_order".qual_20.g.vcf
