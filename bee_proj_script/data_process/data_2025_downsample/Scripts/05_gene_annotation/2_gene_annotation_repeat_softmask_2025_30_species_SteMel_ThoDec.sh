...
#SBATCH --time=1-25:00:00 # Ste & Tho
#SBATCH --array=3,8%2
##SBATCH --array=0-9%10
#SBATCH --error=2_gene_annotation_repeat_softmask_2025_30_SteMel_ThoDec.%A_%a.e
#SBATCH --output=2_gene_annotation_repeat_softmask_2025_30_SteMel_ThoDec.%A_%a.o
#SBATCH --job-name=2_gene_annotation_repeat_softmask_2025_30_SteMel_ThoDec
