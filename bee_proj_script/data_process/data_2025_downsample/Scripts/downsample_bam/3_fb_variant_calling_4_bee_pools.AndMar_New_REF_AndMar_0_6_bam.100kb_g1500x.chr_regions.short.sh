...
#SBATCH --error=3_fb_variant_calling_4_bee_pools.AndMar_New_REF_AndMar_0_6_bam.100kb_g1500x.chr_regions.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.AndMar_New_REF_AndMar_0_6_bam.100kb_g1500x.chr_regions.%A_%a.o
#SBATCH --job-name=3_fb_variant_calling_4_bee_pools.AndMar_New_REF_AndMar_0_6_bam
...
mkdir $VCF_OUT_DIR/fb_per_region_AndMar_New_REF_AndMar_0_6_bam
#cd $VCF_OUT_DIR/fb_per_contig_BomPas_REF_BomPas
cd $VCF_OUT_DIR/fb_per_region_AndMar_New_REF_AndMar_0_6_bam
...
SAMPLE=Andmar.New_REF_AndMar.sort.marked_dups.0_6.bam
