...
#SBATCH --error=1_1_downsample_samtools_AndHae_AndMar_bam_clean_index.%A_%a.e
#SBATCH --output=1_1_downsample_samtools_AndHae_AndMar_bam_clean_index.%A_%a.o
#SBATCH --job-name=1_1_downsample_samtools_AndHae_AndMar_bam_clean_index
