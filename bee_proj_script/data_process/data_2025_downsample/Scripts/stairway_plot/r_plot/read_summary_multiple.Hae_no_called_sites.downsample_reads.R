...
[1] "./AndHae_REF_AndHae.010P_reads.DP_1x/AndHae_REF_AndHae.010P_reads.DP_1x.final.summary"  
 [2] "./AndHae_REF_AndHae.01P_reads.DP_1x/AndHae_REF_AndHae.01P_reads.DP_1x.final.summary"    
 [3] "./AndHae_REF_AndHae.010P_reads.DP_3x/AndHae_REF_AndHae.010P_reads.DP_3x.final.summary"  
 [4] "./AndHae_REF_AndHae.01P_reads.DP_3x/AndHae_REF_AndHae.01P_reads.DP_3x.final.summary"    
 [5] "./AndHae_REF_AndHae.010P_reads.DP_5x/AndHae_REF_AndHae.010P_reads.DP_5x.final.summary"  
 [6] "./AndHae_REF_AndHae.01P_reads.DP_5x/AndHae_REF_AndHae.01P_reads.DP_5x.final.summary"    
 [7] "./AndHae_REF_AndHae.010P_reads.DP_7x/AndHae_REF_AndHae.010P_reads.DP_7x.final.summary"  
 [8] "./AndHae_REF_AndHae.01P_reads.DP_7x/AndHae_REF_AndHae.01P_reads.DP_7x.final.summary"    
 [9] "./AndHae_REF_AndHae.010P_reads.DP_10x/AndHae_REF_AndHae.010P_reads.DP_10x.final.summary"
[10] "./AndHae_REF_AndHae.01P_reads.DP_10x/AndHae_REF_AndHae.01P_reads.DP_10x.final.summary"  

#setwd("/home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2/bee_pools_plot_new")
setwd("/home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2/bee_pools_plot_new/pool_downsample_reads")
...
site_file <- "/home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2/stairway_plot_blueprint/pool_downsample_reads/templates/Hae_39_number_called_sites_downsample_reads_across_genome.txt"
no_called_sites <- read.table(site_file, header = FALSE)
snp_file <- "/home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2/stairway_plot_blueprint/pool_downsample_reads/templates/AndHae_snp_number.P_reads_01_02_03_04_05_06_07_08_09_10.DP_1_3_5_7_10x.1st_col.txt"
...
summary_files <- list.files(path = ".", pattern = "AndHae_REF.*DP_.*x.*final\\.summary$", recursive = TRUE, full.names = TRUE)

# Extract P value (digits after "AndHae." and before "P")
p_values <- as.numeric(str_extract(summary_files, "(?<=AndHae\\.)\\d+(?=P)"))
...
#sorted_files <- mixedsort(summary_files,decreasing=T)
...
read_summary <- function(file, index) {
  ...
  data$file <- stri_replace_all_regex(
    ...
    #replacement=c("","P.DP",""),
    pattern=c("AndHae_REF_AndHae",".final.summary"),
    replacement=c("AndHae",""),
    vectorize=F
  )
...
plot_summary_legend <- function(data) {
  ggplot(data, aes(x = year)) +  # Adjust column names
    ...
    theme(
      ...
      labs(x = "Years", y = expression(paste(italic("N")["e"])))
...
pdf("AndHae_downsample_reads_stairway_plot.called_sites_snps.pdf", width = 30, height = 15)
