...
#SBATCH --mem 600g # genome size ChoBru 14Gb
#SBATCH --time=08:15:00
#SBATCH --array=1-4%4
#SBATCH --error=busco_orthodb_ChoBru_assembly.%A_%a.e
#SBATCH --output=busco_orthodb_ChoBru_assembly.%A_%a.o
#SBATCH --job-name=busco_orthodb_ChoBru_assembly
...
## run busco
# fasta files
assembly_fa_stats=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/hifi/Chorthippus_brunneus/filtered/assembly_fa_stats
## make array jobs
fa_list=$(ls $assembly_fa_stats/Chorthippus_brunneus.pl*asm.bp.p_ctg.gfa.fa | tr ' ' '\n' | sed -n ${SLURM_ARRAY_TASK_ID}p)
#fa_list=$(ls $assembly_fa_stats/Chorthippus_brunneus.pl_3.asm.bp.p_ctg.gfa.fa | tr ' ' '\n' | sed -n ${SLURM_ARRAY_TASK_ID}p)
...
## Chorthippus_brunneus.pl_0.asm.bp.p_ctg.gfa.fa
## Chorthippus_brunneus.pl_0.with_fail.asm.bp.p_ctg.gfa.fa
...
stats for Chorthippus_brunneus.pl_2.asm.bp.p_ctg.gfa.fa
...
# Summarized benchmarking in BUSCO notation for file /home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/hifi/Chorthippus_brunneus/filtered/assembly_fa_stats/Chorthippus_brunneus.pl_2.with_fail.asm.bp.p_ctg.gfa.fa
