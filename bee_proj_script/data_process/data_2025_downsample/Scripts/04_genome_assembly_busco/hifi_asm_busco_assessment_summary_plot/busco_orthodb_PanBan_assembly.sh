...
#SBATCH --mem 160g # genome size 300-400 Mb PanBan 480Mb
#SBATCH --time=02:15:00
#SBATCH --array=1-4%4
#SBATCH --error=busco_orthodb_PanBan_assembly.%A_%a.e
#SBATCH --output=busco_orthodb_PanBan_assembly.%A_%a.o
#SBATCH --job-name=busco_orthodb_PanBan_assembly
...
## run busco
# fasta files
assembly_fa_stats=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/hifi/Panurgus_banksianus/filtered/assembly_fa_stats
## make array jobs
fa_list=$(ls $assembly_fa_stats/Panurgus_banksianus.pl*asm.bp.p_ctg.gfa.fa | tr ' ' '\n' | sed -n ${SLURM_ARRAY_TASK_ID}p)
#fa_list=$(ls $assembly_fa_stats/Panurgus_banksianus.pl_3.asm.bp.p_ctg.gfa.fa | tr ' ' '\n' | sed -n ${SLURM_ARRAY_TASK_ID}p)
...
## Panurgus_banksianus.pl_0.asm.bp.p_ctg.gfa.fa
## Panurgus_banksianus.pl_0.with_fail.asm.bp.p_ctg.gfa.fa
...
stats for Panurgus_banksianus.pl_2.asm.bp.p_ctg.gfa.fa
...
# Summarized benchmarking in BUSCO notation for file /home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/hifi/Panurgus_banksianus/filtered/assembly_fa_stats/Panurgus_banksianus.pl_2.with_fail.asm.bp.p_ctg.gfa.fa
