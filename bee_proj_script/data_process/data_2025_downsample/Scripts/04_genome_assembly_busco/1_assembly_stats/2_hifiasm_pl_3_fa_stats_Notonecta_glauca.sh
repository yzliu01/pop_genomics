...
#SBATCH --mem 100g
##SBATCH --array=1-2%2
#SBATCH --job-name=hifiasm_purging_3_Not_gla
#SBATCH --error=hifiasm_purging_3_Not_gla.%A_%a.e
#SBATCH --output=hifiasm_purging_3_Not_gla.%A_%a.o
...
sed 's/\(>ptg.*\)/\1 \[Bombus veteranus\]/' Bombus_veteranus.pl_2.asm.bp.p_ctg.gfa.fa | less -S
