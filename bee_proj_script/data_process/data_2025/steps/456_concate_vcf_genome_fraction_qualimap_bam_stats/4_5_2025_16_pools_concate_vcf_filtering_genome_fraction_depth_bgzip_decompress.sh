...
#SBATCH --error=concate_vcf_16_species.%A_%a.e
#SBATCH --output=concate_vcf_16_species.%A_%a.o
#SBATCH --job-name=concate_vcf_16_species
...
## 21 rest pools
#_ ls ./fb_per_region_AelAcu_REF_AelAcu/AelAcu_REF_AelAcu.100kb_1500x_region_*.g.vcf | sort -V > AelAcu_REF_AelAcu.100kb_1500x_region_vcf_file.list
#_ ls ./fb_per_region_AgeAln_REF_AgeAln/AgeAln_REF_AgeAln.100kb_1500x_region_*.g.vcf | sort -V > AgeAln_REF_AgeAln.100kb_1500x_region_vcf_file.list
#_ ls ./fb_per_region_AmpSol_REF_AmpSol/AmpSol_REF_AmpSol.100kb_1500x_region_*.g.vcf | sort -V > AmpSol_REF_AmpSol.100kb_1500x_region_vcf_file.list
...
#_ ls ./fb_per_region_EriInt_REF_EriInt/EriInt_REF_EriInt.100kb_1500x_region_*.g.vcf | sort -V > EriInt_REF_EriInt.100kb_1500x_region_vcf_file.list
#_ ls ./fb_per_region_EriPer_REF_EriPer/EriPer_REF_EriPer.100kb_1500x_region_*.g.vcf | sort -V > EriPer_REF_EriPer.100kb_1500x_region_vcf_file.list
#_ ls ./fb_per_region_GerLac_REF_GerLac/GerLac_REF_GerLac.100kb_1500x_region_*.g.vcf | sort -V > GerLac_REF_GerLac.100kb_1500x_region_vcf_file.list
#_ ls ./fb_per_region_LasMor_REF_LasMor/LasMor_REF_LasMor.100kb_1500x_region_*.g.vcf | sort -V > LasMor_REF_LasMor.100kb_1500x_region_vcf_file.list
#_ ls ./fb_per_region_LepDol_REF_LepDol/LepDol_REF_LepDol.100kb_1500x_region_*.g.vcf | sort -V > LepDol_REF_LepDol.100kb_1500x_region_vcf_file.list
#_ ls ./fb_per_region_MalBip_REF_MalBip/MalBip_REF_MalBip.100kb_1500x_region_*.g.vcf | sort -V > MalBip_REF_MalBip.100kb_1500x_region_vcf_file.list
#_ ls ./fb_per_region_MysLon_REF_MysLon/MysLon_REF_MysLon.100kb_1500x_region_*.g.vcf | sort -V > MysLon_REF_MysLon.100kb_1500x_region_vcf_file.list
...
#_ ls ./fb_per_region_PhoAtr_REF_PhoAtr/PhoAtr_REF_PhoAtr.100kb_1500x_region_*.g.vcf | sort -V > PhoAtr_REF_PhoAtr.100kb_1500x_region_vcf_file.list
#_ ls ./fb_per_region_PorSca_REF_PorSca/PorSca_REF_PorSca.100kb_1500x_region_*.g.vcf | sort -V > PorSca_REF_PorSca.100kb_1500x_region_vcf_file.list
...
#_ ls ./fb_per_region_RhaFul_REF_RhaFul/RhaFul_REF_RhaFul.100kb_1500x_region_*.g.vcf | sort -V > RhaFul_REF_RhaFul.100kb_1500x_region_vcf_file.list
#_ ls ./fb_per_region_TacFer_REF_TacFer/TacFer_REF_TacFer.100kb_1500x_region_*.g.vcf | sort -V > TacFer_REF_TacFer.100kb_1500x_region_vcf_file.list
#_ ls ./fb_per_region_ThoDec_REF_ThoDec/ThoDec_REF_ThoDec.100kb_1500x_region_*.g.vcf | sort -V > ThoDec_REF_ThoDec.100kb_1500x_region_vcf_file.list
#_ ls ./fb_per_region_XesC-n_REF_XesC-n/XesC-n_REF_XesC-n.100kb_1500x_region_*.g.vcf | sort -V > XesC-n_REF_XesC-n.100kb_1500x_region_vcf_file.list
...
##PhrFul_REF_PhrFul.100kb_1500x_region_vcf_file.list
PorSca_REF_PorSca.100kb_1500x_region_vcf_file_10kb.list
...
XesC-n_REF_XesC-n.100kb_1500x_region_vcf_file.list
)
...
output_vcf=${vcf_list/_vcf_file_10kb.list/.10kb.vcf.gz}
...
sbatch --dependency=afterok:62144956 /home/yzliu/eDNA/faststorage/yzliu/DK_proj/population_genomics/bee_proj_script/data_process/data_2025/steps/456_concate_vcf_genome_fraction_qualimap_bam_stats/6_2025_16_pools_get_vcf_ind.DP_1x_1.5x.filtering_fun_sort_files_by_names_sizes.sh
Submitted batch job 62144972
...
## check the mean coverage depth according to revised time
ls -dt ./* | head -17 | find . -name genome_results.txt | sort | xargs grep 'mean coverageData =' | sed -e 's/\.sort\.marked_dups\.bam\/genome_results\.txt:     mean coverageData =//' -e 's/\.\///' | awk '{print $1 "\t" $NF}'
#1x
for COV in $(ls -dt ./* | head -18 | sort -V); do
  cov_hist_file=$(find "$COV" -maxdepth 3 -name 'coverage_histogram.txt' )
  sed '1d' $cov_hist_file | awk -F " " 'NR > 100 && NR < 1500 {sum+=$2}END{print sum}' | tr -d '\n'
  printf "\tDP_1x_1500x\t$COV \n"
done
...
for COV in $(ls -dt ./* | head -18 | sort -V); do
  cov_hist_file=$(find "$COV" -maxdepth 3 -name 'coverage_histogram.txt' )
  #1.5x
  sed '1d' $cov_hist_file | awk -F " " 'NR > 150 && NR < 1500 {sum+=$2}END{print sum}' | tr -d '\n'
  printf "\tDP_1.5x_1500x\t$COV \n"
done
...
./AelAcu.REF_AelAcu.sort.marked_dups.bam
./AgeAln.REF_AgeAln.sort.marked_dups.bam
./AmpSol.REF_AmpSol.sort.marked_dups.bam
./EriInt.REF_EriInt.sort.marked_dups.bam
./EriPer.REF_EriPer.sort.marked_dups.bam
./GerLac.REF_GerLac.sort.marked_dups.bam
./LasMor.REF_LasMor.sort.marked_dups.bam
./LepDol.REF_LepDol.sort.marked_dups.bam
./MalBip.REF_MalBip.sort.marked_dups.bam
./MysLon.REF_MysLon.sort.marked_dups.bam
./PhoAtr.REF_PhoAtr.sort.marked_dups.bam
./PorSca.REF_PorSca.sort.marked_dups.bam
./PorSca.REF_PorSca.sort.marked_dups.bam.10kb
./PorSca.region_10kb.fixed.bam.10kb
./RhaFul.REF_RhaFul.sort.marked_dups.bam
./TacFer.REF_TacFer.sort.marked_dups.bam
./ThoDec.REF_ThoDec.sort.marked_dups.bam
./XesC-n.REF_XesC-n.sort.marked_dups.bam
