...
#SBATCH --job-name=2_gene_annotation_repeat_softmask_2025_30_grasshoppers_cho_bru
...
#echo $split_id
species="Chorthippus_brunneus_$split_id"
## name of split ref genome
# Chorthippus_parallelus.hifi_asm_pl3.part_009.fa
species_ref="Chorthippus_brunneus.hifi_asm_pl3.part_"$split_id".fa"
