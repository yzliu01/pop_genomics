...
#SBATCH --array=7%1
##SBATCH --array=0-9%10
#SBATCH --error=2_gene_annotation_repeat_softmask_2025_30_PorSca.%A_%a.e
#SBATCH --output=2_gene_annotation_repeat_softmask_2025_30_PorSca.%A_%a.o
#SBATCH --job-name=2_gene_annotation_repeat_softmask_2025_30_PorSca
...
ref_list=(
    ...
    "Notonecta_glauca.hifi_asm_pl2.fa" # >ptg000001l
...
braker.pl --genome="$ref_dir/$species_ref".simple_header.fa --prot_seq="$Insecta_gene_AA" \
    --workingdir=$braker_output_dir_for_protseq --species="$species" --useexisting --threads=1 \
