...
#SBATCH --array=4-5%2
##SBATCH --array=0-9%10
#SBATCH --error=2_gene_annotation_repeat_softmask_2025_30_grasshoppers_masked.%A_%a.e
#SBATCH --output=2_gene_annotation_repeat_softmask_2025_30_grasshoppers_masked.%A_%a.o
#SBATCH --job-name=2_gene_annotation_repeat_softmask_2025_30_grasshoppers_masked
