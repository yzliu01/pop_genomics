...
#SBATCH --error=2_gene_annotation_repeat_softmask_2025_30_grasshoppers_cho_par.%A_%a.e
#SBATCH --output=2_gene_annotation_repeat_softmask_2025_30_grasshoppers_cho_par.%A_%a.o
#SBATCH --job-name=2_gene_annotation_repeat_softmask_2025_30_grasshoppers_cho_par
...
ref_list=(
    ...
    "Porcellio_scaber-GCA_034700385.1.fa.masked" # >ENA|JAQIXM010000001|JAQIXM010000001.1 Porcellio scaber isolate Gr-Myr-00683 scaffold3_size17937, whole genome shotgun sequence.
...
## Pad task ID to 3 digits: the %03d format ensures the part number has 3 digits with leading zeros (001 instead of 1)
split_id=$(printf %03d $SLURM_ARRAY_TASK_ID)
#echo $split_id
species="Chorthippus_parallelus_$split_id"
## name of split ref genome
# Chorthippus_parallelus.hifi_asm_pl3.part_009.fa
species_ref="Chorthippus_parallelus.hifi_asm_pl3.part_"$split_id".fa"
...
## name of split ref genome
rm -r braker_softmask_"$species"_split_0"$SLURM_ARRAY_TASK_ID"_results_for_protseq
mkdir braker_softmask_"$species"_split_0"$SLURM_ARRAY_TASK_ID"_results_for_protseq
braker_output_dir_for_protseq=braker_softmask_"$species"_split_0"$SLURM_ARRAY_TASK_ID"_results_for_protseq
