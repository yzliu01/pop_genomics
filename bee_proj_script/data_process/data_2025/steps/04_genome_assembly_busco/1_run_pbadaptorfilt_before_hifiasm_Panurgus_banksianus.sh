...
#SBATCH --mem 100g
##SBATCH --array=1-4%4
#SBATCH --job-name=pbadaptorfilt_Panurgus_banksianus
#SBATCH --error=pbadaptorfilt_Panurgus_banksianus.%A_%a.e
#SBATCH --output=pbadaptorfilt_Panurgus_banksianus.%A_%a.o
...
mkdir filtered
$pbadaptorfilt_sh -p ERR12370431 -o ./filtered
#76-91
