...
#SBATCH --mem 160g # genome size 300-400 Mb NotGla 1.3Gb
#SBATCH --time=02:15:00
#SBATCH --array=1-4%4
#SBATCH --error=busco_orthodb_NotGla_assembly.%A_%a.e
#SBATCH --output=busco_orthodb_NotGla_assembly.%A_%a.o
#SBATCH --job-name=busco_orthodb_NotGla_assembly
...
## run busco
# fasta files
assembly_fa_stats=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/hifi/Notonecta_glauca/filtered/assembly_fa_stats
## make array jobs
fa_list=$(ls $assembly_fa_stats/Notonecta_glauca.pl*asm.bp.p_ctg.gfa.fa | tr ' ' '\n' | sed -n ${SLURM_ARRAY_TASK_ID}p)
#fa_list=$(ls $assembly_fa_stats/Notonecta_glauca.pl_3.asm.bp.p_ctg.gfa.fa | tr ' ' '\n' | sed -n ${SLURM_ARRAY_TASK_ID}p)
...
busco -i $fa_list -m genome -c 20 --lineage_dataset hemiptera_odb10 --restart --out_path $hifiasm_busco_out
## Notonecta_glauca.pl_0.asm.bp.p_ctg.gfa.fa
## Notonecta_glauca.pl_0.with_fail.asm.bp.p_ctg.gfa.fa
...
stats for Notonecta_glauca.pl_2.asm.bp.p_ctg.gfa.fa
...
# Summarized benchmarking in BUSCO notation for file /home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/hifi/Notonecta_glauca/filtered/assembly_fa_stats/Notonecta_glauca.pl_2.with_fail.asm.bp.p_ctg.gfa.fa
