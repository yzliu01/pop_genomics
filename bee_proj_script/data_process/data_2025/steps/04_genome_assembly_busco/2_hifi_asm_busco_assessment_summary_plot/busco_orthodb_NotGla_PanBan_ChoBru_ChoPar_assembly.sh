...
#SBATCH --mem 60g # genome size 300-400 Mb
#SBATCH --time=00:15:00
#SBATCH --array=1-6%6
#SBATCH --error=busco_orthodb_NotGla_PanBan_ChoBru_ChoPar_assembly.%A_%a.e
#SBATCH --output=busco_orthodb_NotGla_PanBan_ChoBru_ChoPar_assembly.%A_%a.o
#SBATCH --job-name=busco_orthodb_NotGla_PanBan_ChoBru_ChoPar_assembly
