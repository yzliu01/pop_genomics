...
#summary_files <- list.files(path = ".", pattern = "BomVet.*_0_[2-6]\\.no_singleton.*final\\.summary$", recursive = TRUE, full.names = TRUE)

## linear
#site_file <- "/home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2/stairway_plot_blueprint/pool_downsample_genome/templates/Vet_29_number_called_sites_across_genome.txt"
#no_called_sites <- read.table(site_file, header = FALSE)
#snp_file <- "/home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2/stairway_plot_blueprint/pool_downsample_genome/templates/BomVet_snp_number.P_genome_01_02_03_04_05_06_07_08_09_10.DP_1_3_5_7_10x.txt"
#snp_number <- read.table(snp_file, header = FALSE)

## shuf
setwd("/home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2/bee_pools_plot_new/pool_shuf_downsample_genome")
site_file <- "/home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2/stairway_plot_blueprint/pool_shuf_downsample_genome/templates/Vet_29_number_called_sites_shuf_across_genome.txt"
no_called_sites <- read.table(site_file, header = FALSE)
snp_file <- "/home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2/stairway_plot_blueprint/pool_shuf_downsample_genome/templates/BomVet_snp_number.P_genome_01_02_03_04_05_06_07_08_09_10.DP_1_3_5_7_10x.txt"
snp_number <- read.table(snp_file, header = FALSE)
...
summary_files <- list.files(path = ".", pattern = "BomVet_REF_BomVet.DP_.*x.P_.*final\\.summary$", recursive = TRUE, full.names = TRUE)

#summary_files <- list.files(path = ".", pattern = "BomVet.*_0_[2]\\.no_singleton.*final\\.summary$", recursive = TRUE, full.names = TRUE)
...
read_summary <- function(file, index) {
  ...
  data$file <- stri_replace_all_regex(
    data$file,
    #pattern=c("BomVet_New_REF_",".no_singleton_sfs","_sm_genic.final.summary"),
    #replacement=c("","P.DP",""),
    pattern=c(".final.summary"),
    replacement=c(""),
    vectorize=F
  )
  # "BomVet_New_REF_BomVet_0_2.no_singleton_sfs_117_1500x_sm_genic.final.summary"
  return(data)
}
...
## linear
#pdf("BomVet_shuf_downsample_stairway_plot.called_sites_snps.pdf", width = 30, height = 15)
## shuf
pdf("BomVet_shuf_downsample_stairway_plot.called_sites_snps.pdf", width = 30, height = 15)
...
input_pdfs <- c(
    "AndHae_shuf_downsample_stairway_plot.called_sites_snps.pdf", 
    "AndMar_shuf_downsample_stairway_plot.called_sites_snps.pdf",
    "BomPas_shuf_downsample_stairway_plot.called_sites_snps.pdf",
    "BomVet_shuf_downsample_stairway_plot.called_sites_snps.pdf"
    )  

# Output merged PDF filename
output_pdf <- "combined_genome_downsample_plot.pdf"
