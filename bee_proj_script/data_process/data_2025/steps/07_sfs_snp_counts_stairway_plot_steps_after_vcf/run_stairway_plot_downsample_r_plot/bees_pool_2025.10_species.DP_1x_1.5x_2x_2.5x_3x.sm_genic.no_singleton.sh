...
##SBATCH --time=4:00:00
#SBATCH --error=bees_pool_2025.10_species.DP_1_1.5_2_2.5_3x.sm_genic.no_singleton.%A_%a.e
#SBATCH --output=bees_pool_2025.10_species.DP_1_1.5_2_2.5_3x.sm_genic.no_singleton.%A_%a.o
#SBATCH --job-name=bees_pool.10_species.DP_1_1.5_2_2.5_3x.sm_genic.no_singleton
...
blueprint_file=`ls -t $blueprint_file_dir/*blueprint | head -50 | sort -V`
...
run_blueprint_plot_sh=$(ls -t $blueprint_file_dir/*blueprint.sh | head -50 | sort -V | sed -n ${SLURM_ARRAY_TASK_ID}p)
