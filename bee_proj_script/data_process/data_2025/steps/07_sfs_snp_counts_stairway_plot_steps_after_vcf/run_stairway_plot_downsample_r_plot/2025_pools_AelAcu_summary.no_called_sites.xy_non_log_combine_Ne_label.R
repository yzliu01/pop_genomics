...
## 10 pools
pdf("AelAcu_stairway_plot.called_sites_snps.final.x_log.label.pdf", width = 20, height = 4)
grid.arrange(grobs = plot_list11, nrow = 1)
dev.off()
...
***************************************************
pdf_file <- file.path(result_path,"all_16_pools_combined_1_1.5x.x_log.pdf")
