...
site_file <- "/home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2/stairway_plot_blueprint/pool_shuf_downsample_genome/templates/Hae_39_number_called_sites_shuf_across_genome.txt"
no_called_sites <- read.table(site_file, header = FALSE)
snp_file <- "/home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2/stairway_plot_blueprint/pool_shuf_downsample_genome/templates/AndHae_snp_number.P_genome_01_02_03_04_05_06_07_08_09_10.DP_1_3_5_7_10x.txt"
snp_number <- read.table(snp_file, header = FALSE)
...
summary_files <- list.files(path = ".", pattern = "AndHae_REF_AndHae.DP_.*x.P_.*final\\.summary$", recursive = TRUE, full.names = TRUE)
#example_file="./AndHae_REF_AndHae.DP_10x.P_10/AndHae_REF_AndHae.DP_10x.P_10.final.summary"
...
## shuf
pdf("AndHae_shuf_downsample_stairway_plot.called_sites_snps.pdf", width = 30, height = 15)
