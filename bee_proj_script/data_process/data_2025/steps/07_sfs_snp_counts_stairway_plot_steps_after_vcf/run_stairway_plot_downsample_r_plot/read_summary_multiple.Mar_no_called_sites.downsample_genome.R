...
#site_file <- "/home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2/stairway_plot_blueprint/pool_downsample_genome/templates/Mar_40_number_called_sites_across_genome.txt"
#no_called_sites <- read.table(site_file, header = FALSE)
#snp_file <- "/home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2/stairway_plot_blueprint/pool_downsample_genome/templates/AndMar_snp_number.P_genome_01_02_03_04_05_06_07_08_09_10.DP_1_3_5_7_10x.txt"
...
site_file <- "/home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2/stairway_plot_blueprint/pool_shuf_downsample_genome/templates/Mar_40_number_called_sites_shuf_across_genome.txt"
no_called_sites <- read.table(site_file, header = FALSE)
snp_file <- "/home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/stairway_plot_v2/stairway_plot_v2.1.2/stairway_plot_blueprint/pool_shuf_downsample_genome/templates/AndMar_snp_number.P_genome_01_02_03_04_05_06_07_08_09_10.DP_1_3_5_7_10x.txt"
snp_number <- read.table(snp_file, header = FALSE)
...
summary_files <- list.files(path = ".", pattern = "AndMar_REF_AndMar.DP_.*x.P_.*final\\.summary$", recursive = TRUE, full.names = TRUE)
...
plot_summary_legend <- function(data) {
  ggplot(data, aes(x = year)) +  # Adjust column names
    ...
    annotate("text", x = 98000, y = 125000, label = paste("Site No: ", unique(data$no_called_sites)),
    size = 2.7, hjust = 0, fontface = "plain", color = "black") +
    annotate("text", x = 98000, y = 100000, label = paste("SNP No: ", unique(data$snp_number)),
    size = 2.7, hjust = 0, fontface = "plain", color = "black") +
...
## linear
#pdf("AndMar_shuf_downsample_stairway_plot.called_sites_snps.pdf", width = 30, height = 15)
## shuf
pdf("AndMar_shuf_downsample_stairway_plot.called_sites_snps.pdf", width = 30, height = 15)
