...
## for pooled data
SAMPLE=Notgla.REF_NotGla.sort.marked_dups.bam

## output vcf
VCF_OUT_DIR=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/vcf

mkdir $VCF_OUT_DIR/fb_per_region_NotGla_REF_NotGla
cd $VCF_OUT_DIR/fb_per_region_NotGla_REF_NotGla
...
freebayes --region $Each_Region_Ref --fasta-reference $REF \
    ...
    > ./"NotGla_REF_NotGla.100kb_1500x_region_"${SLURM_ARRAY_TASK_ID}.g.vcf
