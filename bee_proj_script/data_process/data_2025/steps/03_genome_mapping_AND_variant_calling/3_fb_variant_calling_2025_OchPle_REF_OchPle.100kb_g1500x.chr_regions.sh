...
#SBATCH --array=1-6458%600
#SBATCH --time=28:00:00
#SBATCH --error=3_fb_variant_calling_2025_OchPle_REF_OchPle.100kb_g1500x.chr_regions.%A_%a.e
#SBATCH --output=3_fb_variant_calling_2025_OchPle_REF_OchPle.100kb_g1500x.chr_regions.%A_%a.o
#SBATCH --job-name=6458_3_fb_variant_calling_2025_OchPle_REF_OchPle.100kb_g1500x.chr_regions
...
mkdir $VCF_OUT_DIR/fb_per_region_OchPle_REF_OchPle
cd $VCF_OUT_DIR/fb_per_region_OchPle_REF_OchPle

## path to your ref genome
REF_DIR=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/ref_genome
REF=$REF_DIR/Ochropleura_plecta-GCA_905475445.1-softmasked.fa

Each_Region_Dir=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/ref_genome/fasta_generate_regions/chr_regions
Ref_Region=Ochropleura_plecta-GCA_905475445.1-softmasked.fb_100kb.regions
...
freebayes --region $Each_Region_Ref --fasta-reference $REF \
    ...
    > ./"OchPle_REF_OchPle.100kb_1500x_region_"${SLURM_ARRAY_TASK_ID}.g.vcf
