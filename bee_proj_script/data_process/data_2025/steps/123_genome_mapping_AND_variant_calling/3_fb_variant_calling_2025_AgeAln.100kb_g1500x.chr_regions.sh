...
#SBATCH --array=1-7005%600
#SBATCH --time=28:00:00
#SBATCH --error=3_fb_variant_calling_2025_AgeAln_REF_AgeAln.100kb_g1500x.chr_regions.%A_%a.e
#SBATCH --output=3_fb_variant_calling_2025_AgeAln_REF_AgeAln.100kb_g1500x.chr_regions.%A_%a.o
#SBATCH --job-name=7005_3_fb_variant_calling_2025_AgeAln_REF_AgeAln.100kb_g1500x.chr_regions
...
## for pooled data
SAMPLE=AgeAln.REF_AgeAln.sort.marked_dups.bam

## output vcf
VCF_OUT_DIR=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/vcf

mkdir $VCF_OUT_DIR/fb_per_region_AgeAln_REF_AgeAln
cd $VCF_OUT_DIR/fb_per_region_AgeAln_REF_AgeAln

## path to your ref genome
REF_DIR=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/ref_genome
REF=$REF_DIR/Agelastica_alni-GCA_950111635.2.fa.masked

Each_Region_Dir=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/ref_genome/fasta_generate_regions/chr_regions
Ref_Region=Agelastica_alni-GCA_950111635.2.fb_100kb.regions.masked
...
freebayes --region $Each_Region_Ref --fasta-reference $REF \
    ...
    > ./"AgeAln_REF_AgeAln.100kb_1500x_region_"${SLURM_ARRAY_TASK_ID}.g.vcf
