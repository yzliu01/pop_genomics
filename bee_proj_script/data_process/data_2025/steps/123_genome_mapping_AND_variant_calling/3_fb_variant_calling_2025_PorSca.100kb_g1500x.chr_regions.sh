...
#SBATCH --error=3_fb_variant_calling_2025_PorSca_REF_PorSca.100kb_g1500x.chr_regions.%A_%a.e
#SBATCH --output=3_fb_variant_calling_2025_PorSca_REF_PorSca.100kb_g1500x.chr_regions.%A_%a.o
#SBATCH --job-name=455076_3_fb_variant_calling_2025_PorSca_REF_PorSca.100kb_g1500x.chr_regions
...
freebayes --region $Each_Region_Ref --fasta-reference $REF \
    ...
    > ./"PorSca_REF_PorSca.100kb_1500x_region_"${SLURM_ARRAY_TASK_ID}.g.vcf
