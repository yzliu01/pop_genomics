...
#SBATCH --array=1-10107%600
#SBATCH --time=28:00:00
#SBATCH --error=3_fb_variant_calling_2025_LepDol_REF_LepDol.100kb_g1500x.chr_regions.%A_%a.e
#SBATCH --output=3_fb_variant_calling_2025_LepDol_REF_LepDol.100kb_g1500x.chr_regions.%A_%a.o
#SBATCH --job-name=10107_3_fb_variant_calling_2025_LepDol_REF_LepDol.100kb_g1500x.chr_regions
...
## for pooled data
SAMPLE=LepDol.REF_LepDol.sort.marked_dups.bam

## output vcf
VCF_OUT_DIR=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/vcf

mkdir $VCF_OUT_DIR/fb_per_region_LepDol_REF_LepDol
cd $VCF_OUT_DIR/fb_per_region_LepDol_REF_LepDol

## path to your ref genome
REF_DIR=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/ref_genome
REF=$REF_DIR/Leptopterna_dolobrata-GCA_954871275.1.fa.masked

Each_Region_Dir=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/ref_genome/fasta_generate_regions/chr_regions
Ref_Region=Leptopterna_dolobrata-GCA_954871275.1.fb_100kb.regions.masked
...
freebayes --region $Each_Region_Ref --fasta-reference $REF \
    ...
    > ./"LepDol_REF_LepDol.100kb_1500x_region_"${SLURM_ARRAY_TASK_ID}.g.vcf
