...
##SBATCH --array=1-140000%1000
#SBATCH --array=20%1
#SBATCH --time=00:10:00
#SBATCH --error=3_fb_variant_calling_2025_PorSca_REF_PorSca.100kb_g1500x.chr_regions.1.%A_%a.e
#SBATCH --output=3_fb_variant_calling_2025_PorSca_REF_PorSca.100kb_g1500x.chr_regions.1.%A_%a.o
#SBATCH --job-name=149999_3_fb_variant_calling_2025_PorSca_REF_PorSca.100kb_g1500x.chr_regions.1
...
# MaxArraySize            = 150000 (not less than 150000, max 149999)
...
NEW_SLURM_ARRAY_TASK_ID=$((SLURM_ARRAY_TASK_ID + 0))
...
freebayes --region $Each_Region_Ref --fasta-reference $REF \
    ...
    > ./"PorSca_REF_PorSca.100kb_1500x_region_"${NEW_SLURM_ARRAY_TASK_ID}.new_1.g.vcf
