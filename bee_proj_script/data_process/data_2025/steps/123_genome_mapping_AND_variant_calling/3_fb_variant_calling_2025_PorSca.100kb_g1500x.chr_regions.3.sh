...
#SBATCH --error=3_fb_variant_calling_2025_PorSca_REF_PorSca.100kb_g1500x.chr_regions.3.%A_%a.e
#SBATCH --output=3_fb_variant_calling_2025_PorSca_REF_PorSca.100kb_g1500x.chr_regions.3.%A_%a.o
#SBATCH --job-name=420000_3_fb_variant_calling_2025_PorSca_REF_PorSca.100kb_g1500x.chr_regions.3
...
NEW_SLURM_ARRAY_TASK_ID=$((SLURM_ARRAY_TASK_ID + 280000))
