...
#SBATCH --array=1-12353%600
#SBATCH --time=28:00:00
#SBATCH --error=3_fb_variant_calling_2025_PhoAtr_REF_PhoAtr.100kb_g1500x.chr_regions.%A_%a.e
#SBATCH --output=3_fb_variant_calling_2025_PhoAtr_REF_PhoAtr.100kb_g1500x.chr_regions.%A_%a.o
#SBATCH --job-name=12353_3_fb_variant_calling_2025_PhoAtr_REF_PhoAtr.100kb_g1500x.chr_regions
...
## for pooled data
SAMPLE=PhoAtr.REF_PhoAtr.sort.marked_dups.bam

## output vcf
VCF_OUT_DIR=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/vcf

mkdir $VCF_OUT_DIR/fb_per_region_PhoAtr_REF_PhoAtr
cd $VCF_OUT_DIR/fb_per_region_PhoAtr_REF_PhoAtr

## path to your ref genome
REF_DIR=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/ref_genome
REF=$REF_DIR/Phosphuga_atrata-GCA_944588485.1-softmasked.fa

Each_Region_Dir=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/ref_genome/fasta_generate_regions/chr_regions
Ref_Region=Phosphuga_atrata-GCA_944588485.1-softmasked.fb_100kb.regions
...
freebayes --region $Each_Region_Ref --fasta-reference $REF \
    ...
    > ./"PhoAtr_REF_PhoAtr.100kb_1500x_region_"${SLURM_ARRAY_TASK_ID}.g.vcf
