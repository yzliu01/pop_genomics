...
#SBATCH --array=1-6673%600
#SBATCH --time=28:00:00
#SBATCH --error=3_fb_variant_calling_2025_MysLon_REF_MysLon.100kb_g1500x.chr_regions.%A_%a.e
#SBATCH --output=3_fb_variant_calling_2025_MysLon_REF_MysLon.100kb_g1500x.chr_regions.%A_%a.o
#SBATCH --job-name=6673_3_fb_variant_calling_2025_MysLon_REF_MysLon.100kb_g1500x.chr_regions
...
## for pooled data
SAMPLE=MysLon.REF_MysLon.sort.marked_dups.bam

## output vcf
VCF_OUT_DIR=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/vcf

mkdir $VCF_OUT_DIR/fb_per_region_MysLon_REF_MysLon
cd $VCF_OUT_DIR/fb_per_region_MysLon_REF_MysLon

## path to your ref genome
REF_DIR=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/ref_genome
REF=$REF_DIR/Mystacides_longicornis-GCA_963576905.1.fa.masked

Each_Region_Dir=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/ref_genome/fasta_generate_regions/chr_regions
Ref_Region=Mystacides_longicornis-GCA_963576905.1.fb_100kb.regions.masked
...
freebayes --region $Each_Region_Ref --fasta-reference $REF \
    ...
    > ./"MysLon_REF_MysLon.100kb_1500x_region_"${SLURM_ARRAY_TASK_ID}.g.vcf
