...
#SBATCH --array=13923%1
#SBATCH --time=48:00:00
#SBATCH --error=3_fb_variant_calling_2025_SteMel_REF_SteMel.100kb_g1500x.chr_regions_13923.%A_%a.e
#SBATCH --output=3_fb_variant_calling_2025_SteMel_REF_SteMel.100kb_g1500x.chr_regions_13923.%A_%a.o
#SBATCH --job-name=16283_3_fb_variant_calling_2025_SteMel_REF_SteMel.100kb_g1500x.chr_regions_13923
