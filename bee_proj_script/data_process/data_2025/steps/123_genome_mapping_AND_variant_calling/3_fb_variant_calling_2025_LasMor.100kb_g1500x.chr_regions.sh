...
#SBATCH --array=1-6135%600
#SBATCH --time=28:00:00
#SBATCH --error=3_fb_variant_calling_2025_LasMor_REF_LasMor.100kb_g1500x.chr_regions.%A_%a.e
#SBATCH --output=3_fb_variant_calling_2025_LasMor_REF_LasMor.100kb_g1500x.chr_regions.%A_%a.o
#SBATCH --job-name=6135_3_fb_variant_calling_2025_LasMor_REF_LasMor.100kb_g1500x.chr_regions
...
## for pooled data
SAMPLE=LasMor.REF_LasMor.sort.marked_dups.bam

## output vcf
VCF_OUT_DIR=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/vcf

mkdir $VCF_OUT_DIR/fb_per_region_LasMor_REF_LasMor
cd $VCF_OUT_DIR/fb_per_region_LasMor_REF_LasMor

## path to your ref genome
REF_DIR=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/ref_genome
REF=$REF_DIR/Lasioglossum_morio-GCA_916610235.2-softmasked.fa

Each_Region_Dir=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/ref_genome/fasta_generate_regions/chr_regions
Ref_Region=Lasioglossum_morio-GCA_916610235.2-softmasked.fb_100kb.regions
...
freebayes --region $Each_Region_Ref --fasta-reference $REF \
    ...
    > ./"LasMor_REF_LasMor.100kb_1500x_region_"${SLURM_ARRAY_TASK_ID}.g.vcf
