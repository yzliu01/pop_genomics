...
#SBATCH --error=fastqc_fastp_fastqc_concated_10_bee_proj.%A_%a.e
#SBATCH --output=fastqc_fastp_fastqc_concated_10_bee_proj.%A_%a.o
#SBATCH --job-name=fastqc_fastp_fastqc_concated_10_bee_proj
...
# fastq sequence dir
SEQDIR=/home/yzliu/eDNA/faststorage/yzliu/BACKUP/pool_raw_data/pool_01_04_2025
cd $SEQDIR
