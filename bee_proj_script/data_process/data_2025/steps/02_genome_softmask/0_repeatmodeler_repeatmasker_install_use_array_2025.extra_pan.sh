...
#SBATCH --array=0%1
#SBATCH --error=0_RepeatMasker_detect_2025_Ref_softmask_pan.%A_%a.e
#SBATCH --output=0_RepeatMasker_detect_2025_Ref_softmask_pan.%A_%a.o
...
species_list=(
    ...
    "Panurgus_banksianus_pl3"  # self_annotated
...
ref_list=(
    ...
    "Panurgus_banksianus.hifi_asm_pl3.fa" # assembling 434Mb
...
consensi_fa=(
    #"RM_4145600.WedMar192315022025" #Pan pl2
    "RM_3405159.TueApr221628252025"
...
out_fa=(
    ...
    #"Chorthippus_parallelus.hifi_asm_pl2.fa" # assembling: 14Gb
    #"Panurgus_banksianus.hifi_asm_pl2.fa" # assembling
    "Panurgus_banksianus.hifi_asm_pl3.fa"
