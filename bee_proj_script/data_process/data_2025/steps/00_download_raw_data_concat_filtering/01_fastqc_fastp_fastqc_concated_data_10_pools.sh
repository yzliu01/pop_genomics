...
#SBATCH --error=fastqc_fastp_fastqc_concated_10_pools.%A_%a.e
#SBATCH --output=fastqc_fastp_fastqc_concated_10_pools.%A_%a.o
#SBATCH --job-name=fastqc_fastp_fastqc_concated_10_pools
