...
#SBATCH --error=qualimap_bee_10_pool.marked_dups_1_RutMac.%A_%a.e
#SBATCH --output=qualimap_bee_10_pool.marked_dups_1_RutMac.%A_%a.o
#SBATCH --job-name=qualimap_bee_10_pool.marked_dups_1_RutMac
