...
#SBATCH --error=concate_vcf_Hae_Mar_downreads_P_01_02_03_04_05_06_07_08_09_DP_1x_3x_5x_7x_10x.%A_%a.e
#SBATCH --output=concate_vcf_Hae_Mar_downreads_P_01_02_03_04_05_06_07_08_09_DP_1x_3x_5x_7x_10x.%A_%a.o
#SBATCH --job-name=concate_vcf_Hae_Mar_downreads_P_01_02_03_04_05_06_07_08_09_DP_1x_3x_5x_7x_10x
...
## new method
## file list with relative directory
# Hae
#create_AndHae_vcf_file_list(){
#for p in 1 7 8 9
#do ls ./fb_per_region_AndHae_New_REF_AndHae_0_"$p"_bam/Andhae.New_REF_AndHae.100kb_1500x_region_*.g.vcf | sort -V > Andhae.New_REF_AndHae_0_"$p".100kb_1500x_region_vcf_file.list
#done
#}
# Mar
#create_AndMar_vcf_file_list(){
#for p in 1 7 8 9
#do ls ./fb_per_region_AndMar_New_REF_AndMar_0_"$p"_bam/Andmar.New_REF_AndMar.100kb_1500x_region_*.g.vcf | sort -V > Andmar.New_REF_AndMar_0_"$p".100kb_1500x_region_vcf_file.list
#done
#}
...
vcf_list_file=(
"Andhae.New_REF_AndHae_0_1.100kb_1500x_region_vcf_file.list"
"Andhae.New_REF_AndHae_0_2.100kb_1500x_region_vcf_file.list"
"Andhae.New_REF_AndHae_0_3.100kb_1500x_region_vcf_file.list"
"Andhae.New_REF_AndHae_0_4.100kb_1500x_region_vcf_file.list"
"Andhae.New_REF_AndHae_0_5.100kb_1500x_region_vcf_file.list"
"Andhae.New_REF_AndHae_0_6.100kb_1500x_region_vcf_file.list"
"Andhae.New_REF_AndHae_0_7.100kb_1500x_region_vcf_file.list"
"Andhae.New_REF_AndHae_0_8.100kb_1500x_region_vcf_file.list"
"Andhae.New_REF_AndHae_0_9.100kb_1500x_region_vcf_file.list"
"Andmar.New_REF_AndMar_0_1.100kb_1500x_region_vcf_file.list"
"Andmar.New_REF_AndMar_0_2.100kb_1500x_region_vcf_file.list"
"Andmar.New_REF_AndMar_0_3.100kb_1500x_region_vcf_file.list"
"Andmar.New_REF_AndMar_0_4.100kb_1500x_region_vcf_file.list"
"Andmar.New_REF_AndMar_0_5.100kb_1500x_region_vcf_file.list"
"Andmar.New_REF_AndMar_0_6.100kb_1500x_region_vcf_file.list"
"Andmar.New_REF_AndMar_0_7.100kb_1500x_region_vcf_file.list"
"Andmar.New_REF_AndMar_0_8.100kb_1500x_region_vcf_file.list"
"Andmar.New_REF_AndMar_0_9.100kb_1500x_region_vcf_file.list"
)

## the first item in the array starts with 0
## e.g., /home/yzliu/eDNA/faststorage/yzliu/DK_proj/population_genomics/bee_proj_script/data_process/data_2025_downsample/Scripts/05_gene_annotation/2_gene_annotation_repeat_softmask_2025_30_species.sh
## vcf_list=${vcf_list_file[$SLURM_ARRAY_TASK_ID]}
...
***********************************systematic downsampling reads
***********************************
cd /home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/bam/bam_stats/qualimap/New_REF

## downsample read 10% - 90% - 100%
## 39 ind
## 1x per sample
## grep 'Andhae.New_REF'
for COV in `find -maxdepth 3 -print | grep 'Andhae.New_REF' | grep '\.0_[1-9]' | grep 'coverage_histogram.txt' | sort -V`
    do
...
for COV in `find -maxdepth 3 -print | grep 'Andhae.New_REF' | grep '\.0_[1-9]' | grep 'coverage_histogram.txt' | sort -V`
    do
    #sed '1d' $COV | awk -F " " 'NR > 234 && NR < 1500 {total_DP+=$1*$2;sum_loc+=$2} END {if (sum_loc > 0) print "mean_DP: "total_DP/sum_loc "\t"}' | tr -d '\n'
...
## 1x per sample
## grep 'Andmar.New_REF'
for COV in `find -maxdepth 3 -print | grep 'Andmar.New_REF' | grep '\.0_[1-9]' | grep 'coverage_histogram.txt' | sort -V`
    do
...
for COV in `find -maxdepth 3 -print | grep 'Andmar.New_REF' | grep '\.0_[1-9]' | grep 'coverage_histogram.txt' | sort -V`
    do
    #sed '1d' $COV | awk -F " " 'NR > 240 && NR < 1500 {total_DP+=$1*$2;sum_loc+=$2} END {if (sum_loc > 0) print "mean_DP: "total_DP/sum_loc "\t"}' | tr -d '\n'
...
***********************************systematic downsampling genomes
***********************************
## specific directory
...
# Andrena_haemorrhoa-GCA_910592295.1-softmasked.fa.fai.whole_win.subset_01.bed
for COV in `find -maxdepth 3 -print | grep 'Andrena_haemorrhoa-GCA' | grep '[0-1][0-9]' | grep 'coverage_histogram.txt' | sort -V`
    do
    sed '1d' $COV | awk -F " " 'NR > 78 && NR < 1500 {sum+=$2}END{print sum}' | tr -d '\n'
    printf "\tDP78_1500x\t$COV \n"
done
...
## 1x per sample
## grep 'Andmar.New_REF'
for COV in `find -maxdepth 3 -print | grep 'Andrena_marginata_GCA' | grep '[0-1][0-9]' | grep 'coverage_histogram.txt' | sort -V`
    do
    sed '1d' $COV | awk -F " " 'NR > 80 && NR < 1500 {sum+=$2}END{print sum}' | tr -d '\n'
    printf "\tDP80_1500x\t$COV \n"
done
