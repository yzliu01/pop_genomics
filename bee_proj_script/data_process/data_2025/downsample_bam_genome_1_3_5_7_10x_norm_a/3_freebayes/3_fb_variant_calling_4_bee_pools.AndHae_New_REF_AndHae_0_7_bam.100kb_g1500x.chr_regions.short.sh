...
#SBATCH --error=3_fb_variant_calling_4_bee_pools.AndHae_New_REF_AndHae_0_7_bam.100kb_g1500x.chr_regions.short.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.AndHae_New_REF_AndHae_0_7_bam.100kb_g1500x.chr_regions.short.%A_%a.o
#SBATCH --job-name=3_fb_variant_calling_4_bee_pools.AndHae_New_REF_AndHae_0_7_bam
...
mkdir $VCF_OUT_DIR/fb_per_region_AndHae_New_REF_AndHae_0_7_bam
#cd $VCF_OUT_DIR/fb_per_contig_BomPas_REF_BomPas
cd $VCF_OUT_DIR/fb_per_region_AndHae_New_REF_AndHae_0_7_bam
...
SAMPLE=Andhae.New_REF_AndHae.sort.marked_dups.0_7.bam
