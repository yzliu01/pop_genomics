...
#SBATCH --error=downsample_qualimap_bee_pool.shuf_REF_marked_dups.%A_%a.e
#SBATCH --output=downsample_qualimap_bee_pool.shuf_REF_marked_dups.%A_%a.o
#SBATCH --job-name=downsample_qualimap_bee_pool.shuf_REF_marked_dups
