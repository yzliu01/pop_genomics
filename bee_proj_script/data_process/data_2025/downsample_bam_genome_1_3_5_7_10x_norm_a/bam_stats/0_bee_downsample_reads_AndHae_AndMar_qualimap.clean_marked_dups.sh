...
ls -t *sort.marked_dups.0_*.bam | head -8 | sort > bee_downsampled_AndHae_AndMar_01_07_08_09.sort.marked_dups.bam.list
...
bam_list=$(cat bee_downsampled_AndHae_AndMar_01_07_08_09.sort.marked_dups.bam.list | sed -n ${SLURM_ARRAY_TASK_ID}p)
