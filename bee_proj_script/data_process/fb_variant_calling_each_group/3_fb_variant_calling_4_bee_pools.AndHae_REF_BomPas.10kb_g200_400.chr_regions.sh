...
#SBATCH --error=3_fb_variant_calling_4_bee_pools.AndHae_REF_BomPas.10kb_g200_400.%A.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.AndHae_REF_BomPas.10kb_g200_400.%A.o
