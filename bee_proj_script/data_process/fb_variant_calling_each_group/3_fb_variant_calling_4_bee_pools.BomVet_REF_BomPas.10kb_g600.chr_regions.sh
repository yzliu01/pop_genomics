...
#SBATCH --error=3_fb_variant_calling_4_bee_pools.BomVet_REF_BomPas.10kb_g600.chr_regions.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.BomVet_REF_BomPas.10kb_g600.chr_regions.%A_%a.o
