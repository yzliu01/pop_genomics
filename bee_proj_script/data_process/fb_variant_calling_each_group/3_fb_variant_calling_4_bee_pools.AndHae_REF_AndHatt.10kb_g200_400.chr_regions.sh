...
#SBATCH --error=3_fb_variant_calling_4_bee_pools.AndHae_REF_AndHatt.10kb_g200_400.chr_regions.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.AndHae_REF_AndHatt.10kb_g200_400.chr_regions.%A_%a.o
...
SAMPLE=Andhae.REF_AndHatt.sort.marked_dups.new.bam
...
freebayes-parallel $contig_regions 20 --fasta-reference $REF \
    ...
    vcffilter -f "QUAL > 20" > $VCF_OUT_DIR/fb_per_contig_AndHae_REF_AndHatt/"$BAM2VCF_NAME_200""$contig_regions_order".qual_20.g.vcf
## forgot BAM2VCF_NAME
