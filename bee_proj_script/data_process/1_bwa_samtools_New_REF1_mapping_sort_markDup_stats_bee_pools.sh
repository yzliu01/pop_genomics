...
#SBATCH --error=1_New_REF1_mapping_sort_markDup_stats_bee_4_pools.%A_%a.e.txt
#SBATCH --output=1_New_REF1_mapping_sort_markDup_stats_bee_4_pools.%A_%a.o.txt
#SBATCH --job-name=1_New_REF1_mapping_sort_markDup_stats_bee_4_pools
...
OUT_NAME_list=("New_REF_AndHae" "New_REF_AndHae" "New_REF_BomPas" "New_REF_BomPas")
...
bwa mem -t 10 -R $ReadGroup $REF_DIR/$REF1 $FASTQ_CLEAN/$seq1 $FASTQ_CLEAN/$seq2 | samtools sort  -@ 8 -m 100G -o $OUT_BAM/$File1.$OUT_NAME".sort.bam"
