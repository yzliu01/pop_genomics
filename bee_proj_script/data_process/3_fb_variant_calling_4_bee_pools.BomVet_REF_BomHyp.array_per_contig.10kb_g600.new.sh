...
#SBATCH --mem 700g
#SBATCH --array=41,42,45-50,52%10
##SBATCH --time=00:05:00
#SBATCH --time=3-10:30:00
##SBATCH --time=3-14:04:00
#SBATCH --error=3_fb_variant_calling_4_bee_pools.BomVet_REF_BomHyp.array_per_contig_53.10kb_g600.new.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.BomVet_REF_BomHyp.array_per_contig_53.10kb_g600.new.%A_%a.o
...
freebayes-parallel $contig_region 20 --fasta-reference $REF \
