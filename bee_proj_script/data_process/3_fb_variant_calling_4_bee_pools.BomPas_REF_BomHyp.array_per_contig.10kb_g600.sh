...
#SBATCH --error=3_fb_variant_calling_4_bee_pools.BomPas_REF_BomHyp.array_per_contig_53.10kb_g600.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.BomPas_REF_BomHyp.array_per_contig_53.10kb_g600.%A_%a.o
