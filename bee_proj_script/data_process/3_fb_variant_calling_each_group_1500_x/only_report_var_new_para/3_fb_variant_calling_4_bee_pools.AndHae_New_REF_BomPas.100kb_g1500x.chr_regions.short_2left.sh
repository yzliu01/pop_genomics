...
#SBATCH --array=1589,1936%2
#SBATCH --time=06:00:00
##SBATCH --time=3-04:04:00
#SBATCH --error=3_fb_variant_calling_4_bee_pools.AndHae_New_REF_BomPas.100kb_g1500x.chr_regions.short_2left.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.AndHae_New_REF_BomPas.100kb_g1500x.chr_regions.short_2left.%A_%a.o
