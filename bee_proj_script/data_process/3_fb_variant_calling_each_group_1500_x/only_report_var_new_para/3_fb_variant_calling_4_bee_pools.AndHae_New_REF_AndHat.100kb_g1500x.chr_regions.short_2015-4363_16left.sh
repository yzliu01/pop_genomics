...
#SBATCH --mem 25g
#SBATCH --array=2592,2595,2597,2617,2639,2859,2863,3007,3044,3396-3397,3472,3474,3497,3880,4154%16
#SBATCH --time=24:00:00
##SBATCH --time=3-04:04:00
#SBATCH --error=3_fb_variant_calling_4_bee_pools.AndHae_New_REF_AndHat.100kb_g1500x.chr_regions.short2015-4363_16left.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.AndHae_New_REF_AndHat.100kb_g1500x.chr_regions.short2015-4363_16left.%A_%a.o
#SBATCH --job-name=2015-4363_3_fb_variant_calling_4_bee_pools.AndHae_New_REF_AndHat.short
...
mkdir $VCF_OUT_DIR/fb_per_region_AndHae_New_REF_AndHat
#cd $VCF_OUT_DIR/fb_per_contig_BomPas_REF_BomPas
cd $VCF_OUT_DIR/fb_per_region_AndHae_New_REF_AndHat
...
SAMPLE=Andhae.New_REF_AndHat.sort.marked_dups.bam
...
Ref_Region=Andrena_hattorfiana-GCA_944738655.1-softmasked.fb_100kb.regions
...
freebayes --region $Each_Region_Ref --fasta-reference $REF \
    ...
    > ./"Andhae.New_REF_AndHat.100kb_1500x_region_"${SLURM_ARRAY_TASK_ID}.g.vcf
#    vcfintersect -v -b $Ref_Masked_Bed > $VCF_OUT_DIR/$fb_per_region_AndHae_New_REF_AndHat/"Andhae.New_REF_AndHat.2Mb_g1500_region_"${SLURM_ARRAY_TASK_ID}.g.vcf
#    vcffilter -f "QUAL > 20"
