...
#SBATCH --error=3_fb_variant_calling_4_bee_pools.BomVet_New_REF_BomCon.100kb_g1500x.chr_regions.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.BomVet_New_REF_BomCon.100kb_g1500x.chr_regions.%A_%a.o
#SBATCH --job-name=6848_3_fb_variant_calling_4_bee_pools.BomVet_New_REF_BomCon
...
mkdir $VCF_OUT_DIR/fb_per_region_BomVet_New_REF_BomCon
cd $VCF_OUT_DIR/fb_per_region_BomVet_New_REF_BomCon
...
## for pooled data
SAMPLE=Bomvet.New_REF_BomCon.sort.marked_dups.bam
...
freebayes --region $Each_Region_Ref --fasta-reference $REF \
    ...
    > ./"Bomvet.New_REF_BomCon.100kb_1500x_region_"${SLURM_ARRAY_TASK_ID}.g.vcf
