...
#SBATCH --mem 25g
#SBATCH --array=1-3114%600
#SBATCH --time=24:00:00
##SBATCH --time=3-04:04:00
#SBATCH --error=3_fb_variant_calling_4_bee_pools.BomVet_New_REF_BomSyl.100kb_g1500x.chr_regions.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.BomVet_New_REF_BomSyl.100kb_g1500x.chr_regions.%A_%a.o
#SBATCH --job-name=2984_3_fb_variant_calling_4_bee_pools.BomVet_New_REF_BomSyl
...
mkdir $VCF_OUT_DIR/fb_per_region_BomVet_New_REF_BomSyl
cd $VCF_OUT_DIR/fb_per_region_BomVet_New_REF_BomSyl

## path to your ref genome
REF_DIR=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/ref_genome
REF=$REF_DIR/Bombus_sylvestris-GCA_911622165.2-softmasked.fa

## for pooled data
SAMPLE=Bomvet.New_REF_BomSyl.sort.marked_dups.bam

Each_Region_Dir=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/ref_genome/fasta_generate_regions/chr_regions
Ref_Region=Bombus_sylvestris-GCA_911622165.2-softmasked.fb_100kb.regions
...
freebayes --region $Each_Region_Ref --fasta-reference $REF \
    ...
    > ./"Bomvet.New_REF_BomSyl.100kb_1500x_region_"${SLURM_ARRAY_TASK_ID}.g.vcf
