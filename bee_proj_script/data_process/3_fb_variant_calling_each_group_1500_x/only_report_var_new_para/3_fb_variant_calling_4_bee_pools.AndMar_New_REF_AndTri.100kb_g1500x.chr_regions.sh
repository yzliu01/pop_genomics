...
#SBATCH --mem 25g
#SBATCH --array=1-4108%600
#SBATCH --time=24:00:00
##SBATCH --time=3-04:04:00
#SBATCH --error=3_fb_variant_calling_4_bee_pools.AndMar_New_REF_AndTri.100kb_g1500x.chr_regions.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.AndMar_New_REF_AndTri.100kb_g1500x.chr_regions.%A_%a.o
#SBATCH --job-name=4108_3_fb_variant_calling_4_bee_pools.AndMar_New_REF_AndTri
...
mkdir $VCF_OUT_DIR/fb_per_region_AndMar_New_REF_AndTri
cd $VCF_OUT_DIR/fb_per_region_AndMar_New_REF_AndTri

## path to your ref genome
REF_DIR=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/ref_genome
REF=$REF_DIR/Andrena_trimmerana-GCA_951215215.1-softmasked.fa

## for pooled data
SAMPLE=Andmar.New_REF_AndTri.sort.marked_dups.bam

Each_Region_Dir=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/ref_genome/fasta_generate_regions/chr_regions
Ref_Region=Andrena_trimmerana-GCA_951215215.1-softmasked.fb_100kb.regions
...
freebayes --region $Each_Region_Ref --fasta-reference $REF \
    ...
    > ./"Andmar.New_REF_AndTri.100kb_1500x_region_"${SLURM_ARRAY_TASK_ID}.g.vcf
