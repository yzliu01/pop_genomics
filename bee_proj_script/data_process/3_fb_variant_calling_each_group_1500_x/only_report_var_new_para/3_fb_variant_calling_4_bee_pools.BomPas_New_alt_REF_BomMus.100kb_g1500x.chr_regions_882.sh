...
#SBATCH --error=3_fb_variant_calling_4_bee_pools.BomPas_New_alt_REF_BomMus.100kb_g1500x.chr_regions_882.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.BomPas_New_alt_REF_BomMus.100kb_g1500x.chr_regions_882.%A_%a.o
#SBATCH --job-name=3196_3_fb_variant_calling_4_bee_pools.BomPas_New_alt_REF_BomMus_882
