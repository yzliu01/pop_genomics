...
#SBATCH --error=3_fb_variant_calling_4_bee_pools.BomPas_New_REF_BomSyl.100kb_g1500x.chr_regions.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.BomPas_New_REF_BomSyl.100kb_g1500x.chr_regions.%A_%a.o
#SBATCH --job-name=2984_3_fb_variant_calling_4_bee_pools.BomPas_New_REF_BomSyl
...
mkdir $VCF_OUT_DIR/fb_per_region_BomPas_New_REF_BomSyl
cd $VCF_OUT_DIR/fb_per_region_BomPas_New_REF_BomSyl
...
## for pooled data
SAMPLE=Bompas.New_REF_BomSyl.sort.marked_dups.bam
...
freebayes --region $Each_Region_Ref --fasta-reference $REF \
    ...
    > ./"Bompas.New_REF_BomSyl.100kb_1500x_region_"${SLURM_ARRAY_TASK_ID}.g.vcf
