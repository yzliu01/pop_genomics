...
#SBATCH --mem 25g
#SBATCH --array=1-3196%600
#SBATCH --time=24:00:00
##SBATCH --time=3-04:04:00
#SBATCH --error=3_fb_variant_calling_4_bee_pools.BomPas_New_REF_BomMus.100kb_g1500x.chr_regions.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.BomPas_New_REF_BomMus.100kb_g1500x.chr_regions.%A_%a.o
#SBATCH --job-name=3196_3_fb_variant_calling_4_bee_pools.BomPas_New_REF_BomMus
...
mkdir $VCF_OUT_DIR/fb_per_region_BomPas_New_REF_BomMus
cd $VCF_OUT_DIR/fb_per_region_BomPas_New_REF_BomMus

## path to your ref genome
REF_DIR=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/ref_genome
REF=$REF_DIR/Bombus_muscorum-GCA_963971185.1.fa

## for pooled data
SAMPLE=Bompas.New_REF_BomMus.sort.marked_dups.bam

Each_Region_Dir=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/ref_genome/fasta_generate_regions/chr_regions
Ref_Region=Bombus_muscorum-GCA_963971185.1.fb_100kb.regions
...
freebayes --region $Each_Region_Ref --fasta-reference $REF \
    ...
    > ./"Bompas.New_REF_BomMus.100kb_1500x_region_"${SLURM_ARRAY_TASK_ID}.g.vcf
