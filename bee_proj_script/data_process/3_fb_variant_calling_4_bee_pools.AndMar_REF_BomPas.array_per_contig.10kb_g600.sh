...
#SBATCH --error=3_fb_variant_calling_4_bee_pools.AndMar_REF_BomPas.array_per_contig_18.10kb_g600.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.AndMar_REF_BomPas.array_per_contig_18.10kb_g600.%A_%a.o
