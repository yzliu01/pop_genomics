...
#SBATCH --error=3_fb_variant_calling_4_bee_pools.BomVet_REF_BomPas.array_per_contig_18.10kb_g600.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.BomVet_REF_BomPas.array_per_contig_18.10kb_g600.%A_%a.o
...
freebayes-parallel $contig_region 12 --fasta-reference $REF \
    ...
    vcffilter -f "QUAL > 20" > $VCF_OUT_DIR/fb_per_contig_BomVet_REF_BomPas/"$BAM2VCF_NAME"_"$contig_name".qual_20.g.vcf
