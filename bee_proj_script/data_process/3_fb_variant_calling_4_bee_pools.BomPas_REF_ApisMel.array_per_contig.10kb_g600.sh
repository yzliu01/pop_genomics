...
#SBATCH --error=3_fb_variant_calling_4_bee_pools.BomPas_REF_ApisMel.array_per_contig_177.10kb_g600.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.BomPas_REF_ApisMel.array_per_contig_177.10kb_g600.%A_%a.o
...
freebayes-parallel $contig_region --fasta-reference $REF \
    ...
    vcffilter -f "QUAL > 20" > $VCF_OUT_DIR/fb_per_contig_BomPas_REF_ApisMel/"$BAM2VCF_NAME"_"$contig_name".qual_20.g.vcf
