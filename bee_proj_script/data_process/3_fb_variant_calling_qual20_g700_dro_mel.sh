...
#SBATCH --error=fb_dro_mel_variant_fb_calling_qual20_g700.%A.e.txt
#SBATCH --output=fb_dro_mel_variant_fb_calling_qual20_g700.%A.o.txt
#SBATCH --job-name=fb_dro_mel_variant_fb_calling_qual20_g700
...
GVCF_MQ=empirical_dro_mel_68samples.fb_qual20_dp700.g.vcf
