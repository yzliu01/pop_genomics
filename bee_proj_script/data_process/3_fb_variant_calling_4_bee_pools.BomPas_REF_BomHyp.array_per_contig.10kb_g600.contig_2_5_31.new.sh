...
#SBATCH --mem 1500g
#SBATCH --array=2,5,31%3
##SBATCH --time=00:05:00
#SBATCH --time=2-10:30:00
##SBATCH --time=3-04:04:00
#SBATCH --error=3_fb_variant_calling_4_bee_pools.BomPas_REF_BomHyp.array_per_contig_53.10kb_g600.contig_2_5_31.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.BomPas_REF_BomHyp.array_per_contig_53.10kb_g600.contig_2_5_31.%A_%a.o
#SBATCH --job-name=3_fb_variant_calling_4_bee_pools.BomPas_REF_BomHyp.contig_2_5_31
