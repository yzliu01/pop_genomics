...
#SBATCH --error=1_bwa_samtools_REF23_AndTri_AndFul_BomHor_2step_markDup_stats.new.%A_%a.e
#SBATCH --output=1_bwa_samtools_REF23_AndTri_AndFul_BomHor_2step_markDup_stats.new.%A_%a.o
#SBATCH --job-name=new_1_bwa_samtools_REF23_AndTri_AndFul_BomHor_2step_markDup_stats
...
picard MarkDuplicates \
    ...
    MAX_RECORDS_IN_RAM=25000 \
    M=$MARKED_BAM".metrics.csv" >& $MARKED_BAM.log

#MarkDuplicates
#-I Andhae.New_REF_AndFul.sort.bam 
#-O Andhae.New_REF_AndFul.sort.marked_dups.bam 
#-MAX_FILE_HANDLES_FOR_READ_ENDS_MAP 1000 
#-M Andhae.New_REF_AndFul.sort.marked_dups.bam.metrics.csv

#   SORTING_COLLECTION_SIZE_RATIO=0.001 \
