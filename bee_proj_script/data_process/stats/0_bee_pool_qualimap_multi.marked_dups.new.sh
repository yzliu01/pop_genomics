...
#SBATCH --error=multi_qualimap_bee_pool.marked_dups.new.%A_%a.e.txt
#SBATCH --output=multi_qualimap_bee_pool.marked_dups.new.%A_%a.o.txt
#SBATCH --job-name=multi_qualimap_marked_dups.new
...
bam_list_path_group=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/population_genomics/bee_proj_script/data_process/stats/multi_bamqc_describing_pool_samples.bam_marked_dups.new.list
