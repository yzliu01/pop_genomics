...
#SBATCH --error=0_BomVet_hifi_qualimaps.%A.e
#SBATCH --output=0_BomVet_hifi_qualimap.%A.o
#SBATCH --job-name=0_BomVet_hifi_qualimap
...
## bam files
BAM_DIR=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/hifi/bombus_veteranus
...
#bam_list=$(cat bee_4_pools.New_REF_bam_marked_dups.list | sed -n ${SLURM_ARRAY_TASK_ID}p)
bam_list=$(ls HMW_Bom_*.hifi_reads.bc2055.bam | sed -n ${SLURM_ARRAY_TASK_ID}p)
