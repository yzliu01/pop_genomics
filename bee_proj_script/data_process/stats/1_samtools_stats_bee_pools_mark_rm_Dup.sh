...
#SBATCH --error=1_samtools_stats_bee_pools_mark_rm_Dup.%A.e.txt
#SBATCH --output=1_samtools_stats_bee_pools_mark_rm_Dup.%A.o.txt
...
SATS_OUT_DIR=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/bam_qualimap_stats
## stats
