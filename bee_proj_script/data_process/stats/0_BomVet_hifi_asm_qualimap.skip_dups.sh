...
#SBATCH --error=0_BomVet_hifi_asm_qualimap.skip_dups.%A.e
#SBATCH --output=0_BomVet_hifi_asm_qualimap.skip_dups.%A.o
#SBATCH --job-name=0_BomVet_hifi_asm_qualimap.skip_dups
...
bam_list=$(ls BomVet_hifi_asm.aligned.bam | sed -n ${SLURM_ARRAY_TASK_ID}p)
bam_list=$(ls BomVet_hifi_asm.aligned.bam)
