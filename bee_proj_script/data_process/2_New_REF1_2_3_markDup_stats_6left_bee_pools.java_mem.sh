...
#SBATCH --mem 300g
##SBATCH --cpus-per-task 20 #exceed mem
##SBATCH --mem 1000g #exceed mem
#SBATCH --array=1-4%4
##SBATCH --time=00:15:00
#SBATCH --time=15:30:00
##SBATCH --time=3-04:04:00
#SBATCH --error=2_New_REF1_2_3_markDup_stats_6left_bee_pools.java_mem.%A_%a.e.txt
#SBATCH --output=2_New_REF1_2_3_markDup_stats_6left_bee_pools.java_mem.%A_%a.o.txt
#SBATCH --job-name=2_New_REF1_2_3_markDup_stats_6left_bee_pools.java_mem
...
BAM_list_left=(
            "Andhae.New_REF_AndHat.sort.bam" 
            #"Andmar.New_REF_AndHae.sort.bam" 
            "Andmar.New_REF_AndHat.sort.bam"
            #"Bompas.New_REF_BomHyp.sort.bam"
            "Bomvet.New_REF_ApisMel.sort.bam"
            "Bomvet.New_REF_BomHyp.sort.bam"
            )
