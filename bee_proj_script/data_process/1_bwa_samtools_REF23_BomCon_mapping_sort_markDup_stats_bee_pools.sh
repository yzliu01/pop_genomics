...
#SBATCH --time=4-20:30:00
##SBATCH --time=3-04:04:00
#SBATCH --error=1_bwa_samtools_REF23_BomCon_mapping_sort_markDup_stats_bee_pools.%A_%a.e
#SBATCH --output=1_bwa_samtools_REF23_BomCon_mapping_sort_markDup_stats_bee_pools.%A_%a.o
#SBATCH --job-name=1_bwa_samtools_REF23_BomCon_mapping_sort_markDup_stats_bee_pools
...
#Bompas_fastq1.fq.clean.gz  
#Bomvet_fastq1.fq.clean.gz
seq1=$(ls Bom*fastq1.fq.clean.gz | sed -n ${SLURM_ARRAY_TASK_ID}p) # forward sequence
seq2=$(ls Bom*fastq2.fq.clean.gz | sed -n ${SLURM_ARRAY_TASK_ID}p) # reverse sequence
