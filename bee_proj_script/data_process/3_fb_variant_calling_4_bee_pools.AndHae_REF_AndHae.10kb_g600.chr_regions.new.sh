...
#SBATCH --error=3_fb_variant_calling_4_bee_pools.AndHae_REF_AndHae.10kb_g600.chr_regions.new.%A_%a.e
#SBATCH --output=3_fb_variant_calling_4_bee_pools.AndHae_REF_AndHae.10kb_g600.chr_regions.new.%A_%a.o
