...
vcf_mar2mar=concated.AndMar_New_REF_AndMar.100kb_g1500x_regions.all_chr.sorted.GQ_issue_solved.SNP_softmask_genic_bi_FMT_DP240_1500x_noMS.vcf.gz
vcf_hae2hae=concated.AndHae_New_REF_AndHae.100kb_g1500x_regions.all_chr.sorted.GQ_issue_solved.SNP_softmask_genic_bi_FMT_DP234_1500x_noMS.vcf.gz
vcf_pas2pas=concated.BomPas_New_REF_BomPas.100kb_g1500x_regions.all_chr.sorted.GQ_issue_solved.SNP_softmask_genic_bi_FMT_DP204_1500x_noMS.vcf.gz
vcf_vet2pas=concated.BomVet_New_REF_BomPas.100kb_g1500x_regions.all_chr.sorted.GQ_issue_solved.SNP_softmask_genic_bi_FMT_DP174_1500x_noMS.vcf.gz
out_dir=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/gone/plink_files

cd $out_dir

plink_out_vcf_mar2mar=${vcf_mar2mar/vcf.gz/plink}

plink --vcf $vcf_dir/$vcf_mar2mar --recode --allow-extra-chr --out $out_dir/$plink_out_vcf_mar2mar
...
*******************************************
## extract chr and pos
bcftools query -f '%CHROM\t%POS\n' $vcf_hae2hae | less -S > $out_dir/vcf_hae2hae.chr_pos
bcftools query -f '%CHROM\t%POS\n' $vcf_mar2mar | less -S > $out_dir/vcf_mar2mar.chr_pos
bcftools query -f '%CHROM\t%POS\n' $vcf_pas2pas | less -S > $out_dir/vcf_pas2pas.chr_pos
bcftools query -f '%CHROM\t%POS\n' $vcf_vet2pas | less -S > $out_dir/vcf_vet2pas.chr_pos
...
[1] 0.0721875
# vcf_mar2mar
no. of called site with filtering
284858344
...
awk 'BEGIN{FS=OFS="\t"}{print $0,1-$5^2-$6^2}' vcf_hae2hae.allele.freq > vcf_hae2hae.allele.freq.pi
awk 'BEGIN{FS=OFS="\t"}{print $0,1-$5^2-$6^2}' vcf_pas2pas.allele.freq > vcf_pas2pas.allele.freq.pi
awk 'BEGIN{FS=OFS="\t"}{print $0,1-$5^2-$6^2}' vcf_vet2pas.allele.freq > vcf_vet2pas.allele.freq.pi
