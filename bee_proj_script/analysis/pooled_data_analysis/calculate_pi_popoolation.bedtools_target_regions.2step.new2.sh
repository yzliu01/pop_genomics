...
#SBATCH --error=popoolation_pi.vet_hae_mar.new2.%A_%a.e
#SBATCH --output=popoolation_pi.vet_hae_mar.new2.%A_%a.o
...
time \
perl $Variance_sliding_pl --measure pi --input $OUT_DIR/$IN_BAM.mpileup --output $OUT_DIR/$IN_BAM.mpileup.50kb20kb_step.pi \
    --min-count 2 --min-coverage 200 --max-coverage 1500 --window-size 50000 --step-size 20000 \
