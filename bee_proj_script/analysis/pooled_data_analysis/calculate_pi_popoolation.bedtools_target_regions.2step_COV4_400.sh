...
#SBATCH --error=popoolation_pi.vet_hae_mar.COV4_400.%A_%a.e
#SBATCH --output=popoolation_pi.vet_hae_mar.COV4_400.%A_%a.o
...
time \
perl $Variance_sliding_pl --measure pi --input $OUT_DIR/$IN_BAM.mpileup --output $OUT_DIR/$IN_BAM.mpileup.COV4_400.pi \
    --min-count 2 --min-coverage 4 --max-coverage 400 --window-size 10000 --step-size 10000 \
