...
#SBATCH --mem 10g
#SBATCH --array=2-4,6%4
#SBATCH --time=2-00:00:00
#SBATCH --error=popoolation_pi.vet_hae_mar.%A_%a.e
#SBATCH --output=popoolation_pi.vet_hae_mar.%A_%a.o
...
time \
perl $Variance_sliding_pl --measure pi --input $OUT_DIR/$IN_BAM.mpileup --output $OUT_DIR/$IN_BAM.mpileup.pi \
