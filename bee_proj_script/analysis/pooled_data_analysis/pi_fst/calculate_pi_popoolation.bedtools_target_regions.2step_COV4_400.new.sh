...
#SBATCH --error=popoolation_pi.vet_hae_mar.COV4_400.new.%A_%a.e
#SBATCH --output=popoolation_pi.vet_hae_mar.COV4_400.new.%A_%a.o
...
time \
perl $Variance_sliding_pl --measure pi --input $OUT_DIR/$IN_BAM.mpileup --output $OUT_DIR/$IN_BAM.mpileup.COV4_400_50kb.pi \
    --min-count 2 --min-coverage 4 --max-coverage 400 --window-size 50000 --step-size 50000 \
...
## https://sourceforge.net/p/popoolation/wiki/PoPOOLationWalkthrough/
Visualise_output=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/sofwtare/popoolation_1.2.2/Visualise-output.pl
out_dir=/home/yzliu/eDNA/faststorage/yzliu/DK_proj/data/bee_proj_data/bam/bam_stats/samtools_mpileup
