...
bee_site <- read.table("/home/yzliu/eDNA/faststorage/yzliu/DK_proj/population_genomics/bee_proj_script/organized_bee_lat_lon.tsv",sep = "\t",header = T,na.strings = "NA")
head(bee_site)
...
ggsave(high_scale_map, filename = "sampling_map.new.pdf", width=5, height=6)
